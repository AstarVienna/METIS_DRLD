...
\begin{figure}[!ht]
  ...
  \caption{Achievable contrast for the $L=3.5$ target in 1 hour integration time as a function of angular separation. Note, this contrast is dependent on the assumption made here in this simplified study and may not be representative of a more realistic scenario.}
  %\label{fig:metis_l}
\end{figure}
