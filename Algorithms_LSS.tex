...
\begin{figure}[ht!]
  ...
  \caption{Sketch of the used \ac{NGS} offsets ($\Delta x=\Delta y=1"$ with respect to the science target and the slits}
  \label{fig:ngsoffsets}
\end{figure}

\begin{figure}[ht!]
  \centering
  \includegraphics[width=0.9\linewidth]{figures/LSS_CrtAlg_files/SCAOPSF_L-band_4.20mum_slits_ABC_0x0_shift.pdf}
...
\begin{figure}[ht!]
  \centering
  \includegraphics[width=0.9\linewidth]{figures/LSS_CrtAlg_files/METIS_slitlosses.pdf}
