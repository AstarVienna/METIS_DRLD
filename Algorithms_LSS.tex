...
Fig.~\ref{fig:scaopsfslits} shows as example the \ac{PSF} for the EsoMedian turbulence profile at $4.20\mu$m for an \ac{NGS}-distance of 0\arcsec (i.e. the best case when the science target star can be used as guide star). In Panel (a) the \ac{PSF} is shown tih the three slits as overlay.

\begin{figure}[ht!]
  \centering
  \includegraphics[width=0.9\linewidth]{figures/LSS_CrtAlg_files/ngs_offsets.pdf}
