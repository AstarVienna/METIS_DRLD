...
\begin{itemize}
    \item We use \ac{SCAO}-\ac{PSF} simulation tools like \texttt{Anisocado} / \texttt{Toptip} to calculate appropriate Point Spread Functions by means of available meteorological data for the time of observation.
