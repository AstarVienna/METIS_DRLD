...
Band & $\lambda_\textrm{min}$ & $\lambda_\textrm{cent}$ & $\lambda_\textrm{max}$ & pixel          & Slit & Slit        & &\\
     & [$\mu$m]               & [$\mu$m]                & [$\mu$m]               & scale [mas/px] & name & width [mas] & & \\
\hline
L & 2.9 & 3.55 & 4.2  & 5.47 & A & 19.0 &  & \\
L & 2.9 & 3.55 & 4.2  &      & B & 28.5 &  & \\
L & 2.9 & 3.55 & 4.2  &      & C & 38.1 &  & \\
\hdashline
M & 4.5 & 4.85 & 5.2  & 5.47 & A & 19.0 &  & \\
M & 4.5 & 4.85 & 5.2  &      & B & 28.5 &  & \\
M & 4.5 & 4.85 & 5.2  &      & C & 38.1 &  & \\
\hline
N & 7.5 & 10.5 & 13.5 & 6.665 & D & 57.1  &  &  \\
N & 7.5 & 10.5 & 13.5 &       & E & 114.2 &  &  \\
\end{tabular}
\caption{Overview of the slits in all three bands (data taken from Tabs. 4-2 and 4-3 in \cite{METIS-system_analysis}). All slits have length 8000\,mas.}
\end{center}
\end{table}
