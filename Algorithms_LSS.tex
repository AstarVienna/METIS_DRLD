...
\begin{itemize}
    ...
    \item For the final calibration atmospheric lines are used in the recipes \NEWREC{metis_LM_lss_sci} and \NEWREC{metis_N_lss_sci}, which are used in the \texttt{pyreduce} package as reference frame.
