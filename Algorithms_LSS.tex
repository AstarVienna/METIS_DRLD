...
\begin{itemize}
    ...
    \item For the final calibration atmospheric lines are used in the recipes \hyperref[rec:metis_lm_lss_sci]{\REC{metis_LM_lss_wave}} and \hyperref[rec:metis_n_lss_sci]{\REC{metis_N_lss_sci}}, which are used in the \texttt{pyreduce} package as reference frame.
