...
\end{figure}
\end{landscape}
As there is no \ac{PSF} reconstruction foreseen, we assume the following approaches to compensate the slitlosses:
\begin{itemize}
    \item In case of a point sources as science target: We try to estimate the shape of the \ac{PSF} by measuring the flux distribution along the slit (wi 
\end{itemize}
