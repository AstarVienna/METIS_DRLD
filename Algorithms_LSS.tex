...
\begin{table}
\begin{center}
\begin{tabular}{c|ccc|c|c|c[dashed]cc}
     & $\lambda_\textrm{min}$ & $\lambda_\textrm{cent}$ & $\lambda_\textrm{max}$ & pixel scale & Field-of-       & Slit & Slit        &\\
Band & [$\mu$m]               & [$\mu$m]                & [$\mu$m]               & [mas/px] & view$^a$ [$\arcsec$] & & width$^b$ [mas] & \\
\hline
...
\newline $^a$there are 64 / 28 masked pixels each side of the H2RG/Geosnap detectors.
