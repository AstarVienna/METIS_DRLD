...
%  \renewcommand{\arraystretch}{1.15}
  ...
  \begin{tabular}{|P{0.12\textwidth}|c|c|P{0.12\textwidth}|c|c|c|l|}
    ...
    \cline{4-8}  &                                                        &                       & \parbox[c][4ex]{\hsize}{\centering \textcolor{black!35}{N/A}}                   & CLC                       & $\bullet$ &            & IMG\_LM\_CLC \\
    \cline{2-8}  & \multirow{2}{*}{IMG}                                   & N                & \parbox[c][4ex]{\hsize}{\centering \textcolor{black!35}{N/A}}                   & CVC                       & $\bullet$ &            & IMG\_N\_CVC \\
    \cline{3-8} &                                                        & N                     & \parbox[c][4ex]{\hsize}{\centering \textcolor{black!35}{N/A}}                   & CLC                       & $\bullet$ &            & IMG\_N\_CLC \\
    \hline\hline
    ...
    \hline\hline
    %%%%%% IFU + HCI
    \multirow{6}{\hsize}{\parbox[c]{\hsize}{\centering\textbf{IFU + HCI spectroscopy}}}  & \multirow{3}{*}{IFU}                                   & \multirow{3}{*}{L, M} & \multirow{3}{\hsize}{full IFU field}                                            & APP                       & $\bullet$ &            & IFU\_nominal\_APP \\
    \cline{5-8} &                                                        &                       &                                                                                 & RAVC/CVC                  & $\bullet$ &            & IFU\_nominal\_(RA/C)VC \\
    \cline{5-8}  &                                                        &                       &                                                                                 & CLC                       & $\bullet$ &            & IFU\_nominal\_CLC\\
    \cline{2-8}  & \multirow{3}{*}{IFU}                                   & \multirow{3}{*}{L, M} & \multirow{3}{\hsize}{\centering extended $\Delta\lambda = 300\,\mathrm{nm}$}    & APP                       & $\bullet$ &            & IFU\_extended\_APP \\
