...
%                        & \PROD{LM_SCI_COADD_CONTRIB} (contribution map)             \\
  ...
  QC1 parameters:      & \QC{QC LM SCI NEXPOSURE}                                   \\
                       &  \QC{QC LM SCI POSTPROCESS GRIDRANGE}     \\
                       &  \QC{QC LM SCI POSTPROCESS MEDIANMEAN}     \\
                       &  \QC{QC LM SCI POSTPROCESS MEDIANRMS}     \\
                       &  \QC{QC LM SCI POSTPROCESS MEDIANMEDIAN}     \\
                       & \QC{QC LM SCI POSTPROCESS DELTAC}            \\
\end{recipedef}
