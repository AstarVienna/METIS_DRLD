...
\begin{recipedef}
  ...
  Input data:          & \hyperref[dataitem:lm_flat_raw]{\RAW{LM_FLAT_RAW}} (Flat field images taken with lamp or sky.) \\
...
%                     & \TPL{METIS_img_lm_*_obs_*}       \\
  ...
  Input data:       & \hyperref[dataitem:lm_image_raw]{\RAW{LM_IMAGE_RAW}} (Dithered images (standard, science) \\
...
%
% \begin{recipedef}
%   Name:                & \hyperref[rec:metis_lm_img_astrometry_process]{\REC{metis_lm_img_astrometry_process}}                                               \\
