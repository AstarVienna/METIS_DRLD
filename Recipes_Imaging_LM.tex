...
%------------------------------------------------------------------------------------------------------------------
\subsubsection{\REC{metis_lm_img_flat}: LM-band imaging flatfield}
...
%------------------------------------------------------------------------------------------------------------------
\clearpage
\subsubsection{\REC{metis_lm_img_basic_reduce}: LM-band imaging basic reduction}
\label{lm_img_basic}
...
%------------------------------------------------------------------------------------------------------------------
\clearpage
\subsubsection{\REC{metis_lm_img_background}: LM-band imaging background subtraction}
...
\subsubsection{\REC{metis_lm_img_std_process}: LM-band imaging photometric standard analysis}
...
%------------------------------------------------------------------------------------------------------------------
\clearpage
\subsubsection{\REC{metis_lm_img_calibrate}: LM-band imaging calibration}
...
%------------------------------------------------------------------------------------------------------------------
\clearpage
\subsubsection{\REC{metis_lm_img_sci_postprocess}: LM-band imaging post-processing}
...
%------------------------------------------------------------------------------------------------------------------
\clearpage
\subsubsection{\REC{metis_lm_img_distortion}: LM-band imaging distortion calibration}
