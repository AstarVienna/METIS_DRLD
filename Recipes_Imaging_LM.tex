...
values are in units of photons per second. The header of each file
receives keyword \FITS{BUNIT} with value %
\CODE{'photon.s**(-1)'}.

\TODO{Other units may be possible, although additional information is
  needed. For instance,\\ \CODE{'photon.s**(-1).arcsec**(-2)'} makes
