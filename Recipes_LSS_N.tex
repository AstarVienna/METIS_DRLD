...
QC1 parameters: & \hyperref[qc:nlsstracelpolydeg]{\QC{QC N LSS TRACE LPOLYDEG}}: Degree of the polynomial fit of the left order edge\\
                & \hyperref[qc:nlsstracelcoeffi]{\QC{QC N LSS TRACE LCOEFF<i>}}: $i$-th coefficient of the polynomial of the left order edge\\
                & \hyperref[qc:nlsstracerpolydeg]{\QC{QC N LSS TRACE RPOLYDEG}}: Degree of the polynomial fit of the right order edge\\
                & \hyperref[qc:nlsstracercoeffi]{\QC{QC N LSS TRACE RCOEFF<i>}}: $i$-th coefficient of the polynomial of the right order edge\\
                & \hyperref[qc:nlsstraceintrordrlevel]{\QC{QC N LSS TRACE INTORDR LEVEL}}: Flux level of the interorder background\\
                & \QC{TBD}: TBD\\
\end{recipedef}
