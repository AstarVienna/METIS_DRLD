...
Output data:	&  \hyperref[dataitem:lssnrsrfmaster]{\PROD{MASTER_N_LSS_RSRF}} (\FITS{PRO.CATG=MASTER_N_LSS_TRSRF}): \\
...
Output data:	& \hyperref[dataitem:nlssstdobjmap]{\PROD{N_LSS_STD_OBJ_MAP}}: Pixel map of object pixels\\
                ...
                & \hyperref[dataitem:lsslmresp]{\PROD{MASTER_N_RESPONSE}}: response function (TBD)\\
...
Output data:	& \hyperref[dataitem:mfbestfittab]{\PROD{MF_BEST_FIT_TAB}}\\
Expected accuracies: & (TBD)\\
