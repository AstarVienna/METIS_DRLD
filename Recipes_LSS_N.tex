...
Output data:	&  \PROD{MASTER_N_LSS_RSRF} (\FITS{PRO.CATG=MASTER_N_LSS_TRSRF}): master flatfield/\ac{RSRF} \\
...
Output data:	& \PROD{N_LSS_SCI_OBJ_MAP}: Pixel map of object pixels (\ac{QC})\\
                ...
                & (\FITS{PRO.CATG}: \FITS{N_LSS_2d_coadd_wavecal}) \\
                & \PROD{N_LSS_SCI_1D}: coadded, wavelength calibrated 1D spectrum\\
                & (\FITS{PRO.CATG}: \FITS{N_LSS_1d_coadd_wavecal}) \\
