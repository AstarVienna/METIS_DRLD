...
QC1 parameters: & \QC{QC N LSS STD BACKGD MEAN}: Mean value of background\\
                ...
                & \QC{QC N LSS STD SNR}: Signal-to-noise ratio of flux standard star spectrum\\
...
QC1 parameters: & \QC{QC N LSS SCI SNR}: Signal-to-noise ratio of science spectrum\\
                & \QC{QC N LSS SCI NOISELEV}: Noise level of science spectrum\\
                & \QC{QC N LSS SCI FLUX SNR}: Signal-to-noise ratio of flux calibrated science spectrum\\
