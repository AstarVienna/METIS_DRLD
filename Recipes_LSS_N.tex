...
%------------------------------------------------------------------------------------------------------------------
\subsubsection{\REC{metis_N_lss_rsrf}: N-LSS Flatfielding}\label{rec:metis_n_lss_rsrf}
...
%------------------------------------------------------------------------------------------------------------------
\clearpage
\subsubsection{\REC{metis_N_lss_trace}: N-LSS Order detection}\label{rec:metis_n_lss_trace}
...
%------------------------------------------------------------------------------------------------------------------
\subsubsection{\REC{metis_N_lss_std}: N-LSS standard star}\label{rec:metis_n_lss_std}
...
\subsubsection{\REC{metis_N_lss_sci}: N-LSS science reduction}\label{rec:metis_n_lss_sci}
...
\subsubsection{\REC{metis_N_lss_mf_model}: N-LSS telluric correction}\label{rec:metis_n_lss_mf_model}
...
\subsubsection{\REC{metis_N_lss_mf_calctrans}: N-LSS telluric correction}\label{rec:metis_n_lss_mf_calctrans}
\begin{figure}[ht]
  \centering
...
\subsubsection{\REC{metis_N_lss_mf_correct}: N-LSS telluric correction}\label{rec:metis_n_lss_mf_correct}
\begin{figure}[ht]
  \centering
