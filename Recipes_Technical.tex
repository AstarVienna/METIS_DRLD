...
the relative coordinates between the WFS Pyramid focal plane, and the science focal planes is established.
...
%------------------------------------------------------------------------------------------------------------------
\subsubsection{Slit loss determination recipes \REC{metis_lm/n_adc_slitloss}}\label{sssec:adc_slitlosses}
