...
LSF itentical + In case the model spectrum also contains absolute flux values, this star could also be appropriate for the absolute flux calibration.
\subsubsubsection{Modelling approach}: 
...
models available: SPEX \ac{IRTF} Spectral library\footnote{\url{http://irtfweb.ifa.hawaii.edu/~spex/IRTF_Spectral_Library/}}\\
Phoenix code\footnote{\url{https://phoenix.astro.physik.uni-goettingen.de/}}\cite{phoenix}\\
Cohen \cite{coh99}\\
