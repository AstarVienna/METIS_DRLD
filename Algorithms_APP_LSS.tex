...
Band & $\lambda_\textrm{min}$ & $\lambda_\textrm{cent}$ & $\lambda_\textrm{max}$ & $\lambda_\textrm{min}$ y-Pos & $\lambda_\textrm{min}$ y-Pos & $\Delta\dlam & Dispersion \\
 & [$\mu$m] & [$\mu$m] & [$\mu$m] & & on chip [mm] & on chip [$\mu$m] & [$\mu$m/pixel]\\
\hline
L & 2.9 & 3.55 & 4.2 & 17.856 & -16.704 & 1.300 & 6.771e-04 \\
M & 4.5 & 4.85 & 5.2 & 17.856 & -16.704 & 0.700 & 3.646e-04 \\
N & 7.5 & 10.5 & 13.5 & -18.801 & 16.911 & 6.000 & 3.024e-03 \\
\end{tabular}
\end{center}
\end{table}
