...
Band & $\lambda_\textrm{min}$ & $\lambda_\textrm{cent}$ & $\lambda_\textrm{max}$ & $\lambda_\textrm{min}$ y-Pos & $\lambda_\textrm{min}$ y-Pos & $\Delta\lambda$ & Dispersion \\
 & [$\mu$m] & [$\mu$m] & [$\mu$m] & on chip [mm] & on chip [mm] & on chip [$\mu$m] & [$\mu$m/pixel]\\
\hline
L & 2.9 & 3.55 & 4.2 & 17.856 & -16.704 & 1.300 & 6.77e-04 \\
M & 4.5 & 4.85 & 5.2 & 17.856 & -16.704 & 0.700 & 3.65e-04 \\
N & 7.5 & 10.5 & 13.5 & -18.801 & 16.911 & 6.000 & 3.02e-03 \\
\end{tabular}
...
Slit & Width & Length & dlam L & dlam M & dlam N & $L$-band & $M$-band & $N$-band \\
ID & [mas] & [mas] & & & & Resolution\footnote{at $\lambda_textrm{cent}$} & Resolution & Resolution \\
\hline
...
\end{tabular}
\caption{Spectral resolving power of the Long-slit spectrograph in all three bands incorporating the different slits\label{tab:bands_specres2}}
\end{center}
\end{table}
