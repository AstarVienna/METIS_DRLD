...
Band & $\lambda_\textrm{min}$ & $\lambda_\textrm{cent}$ & $\lambda_\textrm{max}$ & $\lambda_\textrm{min}$ y-Pos & $\lambda_\textrm{min}$ y-Pos & $\Delta\lambda$ & Dispersion \\
 & [$\mu$m] & [$\mu$m] & [$\mu$m] & & on chip [mm] & on chip [$\mu$m] & [$\mu$m/pixel]\\
\hline
...
\end{tabular}
\caption{Dispersion of the Long-slit spectrograph in all three bands\label{tab:bands_res}}
\end{center}
\end{table}
...
ID & [mas] & [mas] & & & & Resolution & Resolution & Resolution \\
\hline
