...
We first estimate the spectral resolving power of the \ac{LSS} mode for the different slits incorporated in the spectrograph. \ref{METIS-system_analysis}
\begin{table}
\begin{center}
...
Slit & Width$^a$ & Length$^a$ & $\Delta\lambda$ $L$-band & $\Delta\lambda$ $M$-band & $\Delta\lambda$ $N$-band & $L$-band & $M$-band & $N$-band \\
ID & [mas] & [mas] & & & & Resolution$^b$ & Resolution$^b$ & Resolution$^b$ \\
\hline
