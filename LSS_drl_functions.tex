...
Name: & \hyperref[drl:normtss]{\DRL{norm_tss}} \\
Purpose: & Creates normalised spectra from \ac{TSS} spectra \\
Used in recipes: & \hyperref[rec:lsslmstd]{\REC{metis_LM_lss_std}} \\
...
Mathematical description: &  Polynomial fit on regions known to contain continuum only; these regions will be defined in Table \hyperref[dataitem:tss_cont_tab]{\STATCALIB{TSS_CONT_TAB}}\\
Quality assessment: & Through QC parameters \\
Error conditions: & See \cite{DRLVT}. \\
Unit tests: & See \cite{DRLVT}. \\
\end{recipedef}
