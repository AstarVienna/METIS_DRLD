...
\end{recipedef}
%---------------------------------------------------------------------
\subsubsection{Remove sky background}\label{drl:removeskybackground}
\begin{recipedef}\label{rec:removeskybackground}
Name: & \hyperref[drl:removeskybackground]{\DRL{remove_sky_background}} \\
...
%---------------------------------------------------------------------
\subsubsection{Order trace detection}\label{drl:detectordertrace}
\begin{recipedef}\label{rec:detectordertrace}
Name: & \hyperref[drl:detectordertrace]{\DRL{detect_order_trace}} \\
Purpose: & Determines the order traces on the detectors\\
Used in recipes: & \hyperref[rec:metis_lm_lss_wave]{\REC{metis_LM_lss_wave}} \\
& \hyperref[rec:metis_lm_lss_std]{\REC{metis_LM_lss_sci}} \\
& \hyperref[rec:metis_lm_lss_sci]{\REC{metis_LM_lss_sci}}\\
& \hyperref[rec:metis_n_lss_std]{\REC{metis_N_lss_sci}} \\
& \hyperref[rec:metis_n_lss_sci]{\REC{metis_N_lss_sci}}\\
%Working remarks: & None \\
%Function Parameters: & None \\
Input: & \texttt{const hdrl\_image * input} \\
...
%---------------------------------------------------------------------
\subsubsection{Apply wavelength calibration}\label{drl:applywavecal}
\begin{recipedef}
Name: & \hyperref[drl:applywavecal]{\DRL{apply_wavecal}}\\
