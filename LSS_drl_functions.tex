...
Purpose: & applies \hyperref[dataitem:lm_synth_trans]{\STATCALIB{LM_SYNTH_TRANS}} and \hyperref[dataitem:n_synth_trans]{\STATCALIB{N_SYNTH_TRANS}} to corresponding standard star spectrum\\
Used in recipes: & \hyperref[rec:metis_lm_lss_sci]{\REC{metis_LM_lss_sci}} \newline
                 \hyperref[rec:metis_n_lss_sci]{\REC{metis_N_lss_sci}} \\
%Working remarks: & None \\
%Function Parameters: & None \\
