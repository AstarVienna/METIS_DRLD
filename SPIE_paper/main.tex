...
Given the expected performance of the ELT's adaptive optics correction, METIS will be probing a regions of the sky previously unaccessible to astronomers.
In support of both the METIS integration and verification efforts as well as the astronomical community at large, the METIS pipeline team is begun work on the METIS data reduction pipeline.
...
In order to ensure that the required pipeline functionality is available when it is needed, the development of recipes and workflows has been broken down into four levels of functionality: skeleton, functional, performance, and science-grade. 
This b
