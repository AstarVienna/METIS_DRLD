...
In addition to the use of the python ecosystem, we are taking advantage of the tool chain provided by Github. These tools significantly aid in the development and management of software projects beyond the core version control capabilities of Git. GitHub Issues and Projects are essential for tracking and managing tasks, bugs, and feature requests. Issues can be categorized with labels, assigned to team members, and linked to specific parts of the project, providing a clear and organized way to manage and trace work. The Projects feature allows teams to create Kanban-style boards to visualize and manage workflow, making it easier to see the status of tasks at a glance and ensure that projects stay on track.
