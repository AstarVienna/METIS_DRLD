...
Together with a separate python module that scraps the project management software Polarion for the list of AIV system tests, the DRL-D digital twin also provided the basis for automating the creation of the development schedule (See section . 
