...
\begin{itemize}
    \item the association matrices : section these describe the reduction steps and input files required to process raw observation frames (FITS files) into scientifically relevant data products. See Figure \ref{fig:assoc_mat_example} for an example.
