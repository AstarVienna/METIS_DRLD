...
This automation enhances code quality and speeds up the development cycle but ensuring the test suite is run every time a pull request is made. 
...
By doing so we aim to maintain a high standard of code quality despite very few chances for physical interactions and discussions in person
