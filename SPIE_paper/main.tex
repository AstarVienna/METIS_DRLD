...
From the outset adaptive optics were built into the operational concept, with deformable and tipt-tilt mirrors part of the 5 mirror design.
At mid-infrared wavelengths this will allow for high-strehl observations at diffraction limited observations
It was concieved to offer its instruments the ability to correct for atmospheric distortion through the use o
