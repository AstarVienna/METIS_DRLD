...
\begin{figure}
    ...
    \caption{The graphical representation of the \verb|metis_ifu_adi_cgrph| recipe, detailed in the DRL-Design document\cite{DRLD}. The METIS pipeline contains 44 such recipes. These figures and the corresponding text are used to define the critical aspects of each recipe, including expected input and output data ty}
    \label{fig:enter-label}
\end{figure}
