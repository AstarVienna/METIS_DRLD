...
Table \ref{fig:metis_modes} gives an overview of all the observing modes available with METIS and Brandl et al 2022 \cite{brandl} provides a more in-depth description of the current status of the instrument. 
