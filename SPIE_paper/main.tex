...
\begin{figure}
    ...
    \caption{An example of an }
    \label{fig:assoc_mat_example}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{SPIE_paper/figures/metis_ifu_adi_cgrph_recipe.png}
...
The association matrices (Cahpter 4 of the DRL-D) describe the reduction steps and input files required to process raw observation frames (FITS files) into scientifically relevant data products. See Figure \ref{fig:assoc_mat_example} for an example. 
