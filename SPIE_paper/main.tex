...
We, the METIS pipeline team, would like to use this public forum to advocate for an increased usage of case specfic terminology when refering to such additions to the FITS header. 
The terms ``instrument health monitoring keywords''
