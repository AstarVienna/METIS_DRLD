...
- the association matrices : these describe the reduction steps and required input  needed to process raw observation frames (FITS files) into scientifically relevant data products.See Figure \ref{fig:assoc_mat_example} 
