...
\begin{itemize}
    \item AIV-010, PIP workstation setup : At the beginning of the AIV activites the pipeline workstation will be installed in the AIV Hall in Leiden. A workin
    \item  AIV-250, Dress-rehearsal of data flow chain : Testing the 
\end{itemize}
