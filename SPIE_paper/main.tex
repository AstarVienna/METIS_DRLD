...
There are many and varied outside factors which influence both the instrument design as well as the development of the  pipeline, from the physical characteristics of the instrument to the external interfaces and frameworks within which the pipeline must operate.
