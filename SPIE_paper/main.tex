...
There are many and varied outside factors which influence both the instrument design as wel the development of the METIS pipeline, from the physical characteristics of the instrument to the external interfaces and frameworks within which the pipeline must operate.
