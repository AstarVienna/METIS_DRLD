...
\paragraph{\hyperref[dataitem:lm_off_axis_psf_raw]{\PROD{LM_OFF_AXIS_PSF_RAW}}}\label{dataitem:lm_off_axis_psf_raw}
\begin{recipedef}
...
\hyperref[fits:pro.catg]{\FITS{PRO.CATG}}: & \FITS{LM_OFF_AXIS_PSF_RAW}\\
...
\paragraph{\hyperref[dataitem:n_off_axis_psf_raw]{\PROD{N_OFF_AXIS_PSF_RAW}}}\label{dataitem:n_off_axis_psf_raw}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
...
\paragraph{\hyperref[dataitem:ifu_off_axis_psf_raw]{\PROD{IFU_OFF_AXIS_PSF_RAW}}}\label{dataitem:ifu_off_axis_psf_raw}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
