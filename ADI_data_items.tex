...
\paragraph{\hyperref[dataitem:lm_app_sci_calibrated]{\RAW{LM_APP_SCI_CALIBRATED}}}\label{dataitem:lm_app_sci_calibrated}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
...
\paragraph{\hyperref[dataitem:lm_app_sci_centred]{\RAW{LM_APP_SCI_CENTRED}}}\label{dataitem:lm_app_sci_centred}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
...
\paragraph{\hyperref[dataitem:lm_app_sci_speckle]{\RAW{LM_APP_SCI_SPECKLE}}}\label{dataitem:lm_app_sci_speckle}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
...
\paragraph{\hyperref[dataitem:lm_app_sci_derotated_psfsub]{\RAW{LM_APP_SCI_DEROTATED_PSFSUB}}}\label{dataitem:lm_app_sci_derotated_psfsub}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
...
\paragraph{\hyperref[dataitem:lm_app_sci_derotated]{\RAW{LM_APP_SCI_DEROTATED}}}\label{dataitem:lm_app_sci_derotated}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
...
\paragraph{\hyperref[dataitem:lm_app_sci_coverage]{\RAW{LM_APP_SCI_COVERAGE}}}\label{dataitem:lm_app_sci_coverage}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
...
\paragraph{\hyperref[dataitem:lm_app_sci_snr]{\RAW{LM_APP_SCI_SNR}}}\label{dataitem:lm_app_sci_snr}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
...
\paragraph{\hyperref[dataitem:lm_app_sci_contrast_raw]{\RAW{LM_APP_SCI_CONTRAST_RAW}}}\label{dataitem:lm_app_sci_contrast_raw}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
...
\paragraph{\hyperref[dataitem:lm_app_sci_contrast_adi]{\RAW{LM_APP_SCI_CONTRAST_ADI}}}\label{dataitem:lm_app_sci_contrast_adi}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
...
\paragraph{\hyperref[dataitem:lm_app_sci_throughput]{\RAW{LM_APP_SCI_THROUGHPUT}}}\label{dataitem:lm_app_sci_throughput}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
...
\paragraph{\hyperref[dataitem:lm_app_centroid_tab]{\RAW{LM_APP_CENTROID_TAB}}}\label{dataitem:lm_app_centroid_tab}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
...
Created by recipe: & \hyperref[rec:metis_det_adi_cgrph]{\REC{metis_det_adi_cgrph}}\\
