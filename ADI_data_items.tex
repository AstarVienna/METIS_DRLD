...
\paragraph{\NEWRAW{LM_OFF_AXIS_PSF_RAW}}\label{dataitem:lm_off_axis_psf_raw}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWRAW{LM_OFF_AXIS_PSF_RAW}\\[0.3cm]
...
Input for:    & \NEWREC{metis_img_adi_cgrph} \\
...
\paragraph{\NEWRAW{N_OFF_AXIS_PSF_RAW}}\label{dataitem:n_off_axis_psf_raw}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWRAW{N_OFF_AXIS_PSF_RAW}\\[0.3cm]
Description: & Raw off axis PSF image \\[0.3cm]
\hyperref[fits:dpr.catg]{\FITS{DPR.CATG}}: & \FITS{CALIB}\\
...
Input for recipe: & \NEWREC{metis_img_adi_cgrph}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
\begin{datastructdef}
...
\paragraph{\NEWRAW{IFU_OFF_AXIS_PSF_RAW}}\label{dataitem:ifu_off_axis_psf_raw}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWRAW{IFU_OFF_AXIS_PSF_RAW}\\[0.3cm]
Description: & Raw off axis PSF image \\[0.3cm]
\hyperref[fits:dpr.catg]{\FITS{DPR.CATG}}: & \FITS{CALIB}\\
...
Input for recipe: & \NEWREC{metis_ifu_adi_cgrph}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
\begin{datastructdef}
...
\paragraph{\NEWPROD{LM_cgrph_SCI_THROUGHPUT}}\label{dataitem:lm_cgrph_sci_throughput}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWPROD{LM_cgrph_SCI_THROUGHPUT}\\[0.3cm]
...
Created by recipe: & \NEWREC{metis_img_adi_cgrph}\\
Input for:    & \NEWREC{metis_img_adi_cgrph} \\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
...
\paragraph{\NEWPROD{N_cgrph_SCI_THROUGHPUT}}\label{dataitem:n_cgrph_sci_throughput}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWPROD{N_cgrph_SCI_THROUGHPUT}\\[0.3cm]
Description: & ADI throughput curve \\[0.3cm]
...
\paragraph{\NEWPROD{IFU_cgrph_SCI_THROUGHPUT}}\label{dataitem:ifu_cgrph_sci_throughput}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWPROD{IFU_cgrph_SCI_THROUGHPUT}\\[0.3cm]
Description: & ADI throughput curve \\[0.3cm]
...
Created by: & \NEWREC{metis_ifu_adi_cgrph}\\
...
\paragraph{\NEWPROD{IFU_DISTORTION_TABLE}}\label{dataitem:ifu_distortion_table}
\begin{recipedef}
\textbf{\ac{FITS} structure:}\\
Name: & \NEWPROD{IFU_DISTORTION_TABLE}\\[0.3cm]
...
\paragraph{\NEWPROD{LM_APP_SCI_CALIBRATED}}\label{dataitem:lm_app_sci_calibrated}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWPROD{LM_APP_SCI_CALIBRATED}\\[0.3cm]
...
Created by: & \NEWREC{metis_lm_adi_app}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
\begin{datastructdef}
...
\paragraph{\NEWPROD{LM_APP_SCI_CENTRED}}\label{dataitem:lm_app_sci_centred}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWPROD{LM_APP_SCI_CENTRED}\\[0.3cm]
...
\paragraph{\NEWPROD{LM_APP_SCI_SPECKLE}}\label{dataitem:lm_app_sci_speckle}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWPROD{LM_APP_SCI_SPECKLE}\\[0.3cm]
...
\paragraph{\NEWPROD{LM_APP_SCI_DEROTATED_PSFSUB}}\label{dataitem:lm_app_sci_derotated_psfsub}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWPROD{LM_APP_SCI_DEROTATED_PSFSUB}\\[0.3cm]
...
\paragraph{\NEWPROD{LM_APP_SCI_DEROTATED}}\label{dataitem:lm_app_sci_derotated}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWPROD{LM_APP_SCI_DEROTATED}\\[0.3cm]
...
\paragraph{\NEWPROD{LM_APP_SCI_COVERAGE}}\label{dataitem:lm_app_sci_coverage}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWPROD{LM_APP_SCI_COVERAGE}\\[0.3cm]
...
\paragraph{\NEWPROD{LM_APP_SCI_SNR}}\label{dataitem:lm_app_sci_snr}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWPROD{LM_APP_SCI_SNR}\\[0.3cm]
...
\paragraph{\NEWPROD{LM_APP_SCI_CONTRAST_RADPROF}}\label{dataitem:lm_app_sci_contrast_radprof}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWPROD{LM_APP_SCI_CONTRAST_RADPROF}\\[0.3cm]
...
\paragraph{\NEWPROD{LM_APP_SCI_CONTRAST_ADI}}\label{dataitem:lm_app_sci_contrast_adi}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWPROD{LM_APP_SCI_CONTRAST_ADI}\\[0.3cm]
...
\paragraph{\NEWPROD{LM_APP_SCI_THROUGHPUT}}\label{dataitem:lm_app_sci_throughput}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWPROD{LM_APP_SCI_THROUGHPUT}\\[0.3cm]
Description: & ADI throughput curve \\[0.3cm]
...
\paragraph{\NEWPROD{LM_APP_CENTROID_TAB}}\label{dataitem:lm_app_centroid_tab}
\begin{recipedef}
\textbf{\ac{FITS} structure:}\\
Name: & \NEWPROD{LM_APP_CENTROID_TAB}\\[0.3cm]
...
%OCA keywords: & \hyperref[fits:dpr.catg]{\FITS{DPR.CATG}},  \hyperref[fits:dpr.tech]{\FITS{DPR.TECH}},  \hyperref[fits:dpr.type]{\FITS{DPR.TYPE}} \\
%\FITS{DO.CATG}: & \FITS{LM_APP_SCI_CALIBRATED}\\[0.3cm]
%%Input for recipe: & \NEWREC{metis_lm_adi_app}\\
%Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
%\end{recipedef}
%\begin{datastructdef}
...
\paragraph{\NEWPROD{det_cgrph_SCI_CENTRED}}\label{dataitem:det_cgrph_sci_centred}
\label{dataitem:lm_cgrph_sci_centred}\label{dataitem:n_cgrph_sci_centred}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWPROD{det_cgrph_SCI_CENTRED}\\[0.3cm]
Description: & Coronagraphic image after centering on the PSF and subpixel realignment \\[0.3cm]
...
\paragraph{\NEWPROD{det_cgrph_SCI_SPECKLE}}\label{dataitem:det_cgrph_sci_speckle}
\label{dataitem:lm_cgrph_sci_speckle}\label{dataitem:n_cgrph_sci_speckle}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWPROD{det_cgrph_SCI_SPECKLE}\\[0.3cm]
Description: & PSFZZZSpeckle image from coronagraphic data \\[0.3cm]
...
\paragraph{\NEWPROD{det_cgrph_SCI_DEROTATED_PSFSUB}}\label{dataitem:det_cgrph_sci_derotated_psfsub}
\label{dataitem:lm_cgrph_sci_derotated_psfsub}\label{dataitem:n_cgrph_sci_derotated_psfsub}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWPROD{det_cgrph_SCI_DEROTATED_PSFSUB}\\[0.3cm]
Description: & Coronagraphic image after PSF subtraction, derotation and coaddition  \\[0.3cm]
...
\paragraph{\NEWPROD{det_cgrph_SCI_DEROTATED}}\label{dataitem:det_cgrph_sci_derotated}
\label{dataitem:lm_cgrph_sci_derotated}\label{dataitem:n_cgrph_sci_derotated}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWPROD{det_cgrph_SCI_DEROTATED}\\[0.3cm]
Description: & Coronagraphic image after derotation and coaddition \\[0.3cm]
...
\paragraph{\NEWPROD{det_cgrph_SCI_COVERAGE}}\label{dataitem:det_cgrph_sci_coverage}
\label{dataitem:lm_cgrph_sci_coverage}\label{dataitem:n_cgrph_sci_coverage}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWPROD{det_cgrph_SCI_COVERAGE}\\[0.3cm]
Description: & Map of effective number of frames contributing to the final coronographic image \\[0.3cm]
...
\paragraph{\NEWPROD{det_cgrph_SCI_SNR}}\label{dataitem:det_cgrph_sci_snr}
\label{dataitem:lm_cgrph_sci_snr}\label{dataitem:n_cgrph_sci_snr}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWPROD{det_cgrph_SCI_SNR}\\[0.3cm]
Description: & ADI SNR Map \\[0.3cm]
...
\paragraph{\NEWPROD{det_cgrph_SCI_CONTRAST_RADPROF}}\label{dataitem:det_cgrph_sci_contrast_radprof}\label{dataitem:lm_cgrph_sci_contrast_radprof}\label{dataitem:n_cgrph_sci_contrast_radprof}
\label{dataitem:lm_cgrph_sci_contrast_raw}\label{dataitem:n_cgrph_sci_contrast_raw}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWPROD{det_cgrph_SCI_CONTRAST_RADPROF}\\[0.3cm]
Description: & Raw contrast curve for ADI observations; a radial light intensity profile normalized to the brightness of the star if it were not obscured by the coronagraph. \\[0.3cm]
...
\paragraph{\NEWPROD{det_cgrph_SCI_CONTRAST_ADI}}\label{dataitem:det_cgrph_sci_contrast_adi}
\label{dataitem:lm_cgrph_sci_contrast_adi}\label{dataitem:n_cgrph_sci_contrast_adi}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWPROD{det_cgrph_SCI_CONTRAST_ADI}\\[0.3cm]
Description: & Post-ADI contrast curve for ADI observations  \\[0.3cm]
...
\paragraph{\NEWPROD{det_cgrph_CENTROID_TAB}}\label{dataitem:det_cgrph_centroid_tab}
\label{dataitem:n_cgrph_centroid_tab}\label{dataitem:lm_cgrph_centroid_tab}
\begin{recipedef}
\textbf{\ac{FITS} structure:}\\
Name: & \NEWPROD{det_cgrph_CENTROID_TAB}\\[0.3cm]
Description: & Table of source centroid positions for a sequence of ADI images \\[0.3cm]
...
\paragraph{\NEWPROD{IFU_cgrph_SCI_CALIBRATED}}\label{dataitem:ifu_cgrph_sci_calibrated}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWPROD{IFU_cgrph_SCI_CALIBRATED}\\[0.3cm]
Description: & Coronagraphic image after distortion correction \\[0.3cm]
...
\paragraph{\NEWPROD{IFU_cgrph_SCI_CENTRED}}\label{dataitem:ifu_cgrph_sci_centred}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWPROD{IFU_cgrph_SCI_CENTRED}\\[0.3cm]
Description: & Coronagraphic image after centering on the PSF and subpixel realignment \\[0.3cm]
...
\paragraph{\NEWPROD{IFU_cgrph_SCI_SPECKLE}}\label{dataitem:ifu_cgrph_sci_speckle}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWPROD{IFU_cgrph_SCI_SPECKLE}\\[0.3cm]
Description: & PSFZZZSpeckle image from coronagraphic data \\[0.3cm]
...
\paragraph{\NEWPROD{IFU_cgrph_SCI_DEROTATED_PSFSUB}}\label{dataitem:ifu_cgrph_sci_derotated_psfsub}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWPROD{IFU_cgrph_SCI_DEROTATED_PSFSUB}\\[0.3cm]
Description: & Coronagraphic image after PSF subtraction, derotation and coaddition  \\[0.3cm]
...
\paragraph{\NEWPROD{IFU_cgrph_SCI_DEROTATED}}\label{dataitem:ifu_cgrph_sci_derotated}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWPROD{IFU_cgrph_SCI_DEROTATED}\\[0.3cm]
Description: & Coronagraphic image after derotation and coaddition \\[0.3cm]
...
\paragraph{\NEWPROD{IFU_cgrph_SCI_COVERAGE}}\label{dataitem:ifu_cgrph_sci_coverage}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWPROD{IFU_cgrph_SCI_COVERAGE}\\[0.3cm]
Description: & Map of effective number of frames contributing to the final coronographic image \\[0.3cm]
...
\paragraph{\NEWPROD{IFU_cgrph_SCI_SNR}}\label{dataitem:ifu_cgrph_sci_snr}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWPROD{IFU_cgrph_SCI_SNR}\\[0.3cm]
Description: & ADI SNR Map \\[0.3cm]
...
\paragraph{\NEWPROD{IFU_cgrph_SCI_CONTRAST_RADPROF}}\label{dataitem:ifu_cgrph_sci_contrast_radprof}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWPROD{IFU_cgrph_SCI_CONTRAST_RADPROF}\\[0.3cm]
Description: & Raw contrast curve for ADI observations; a radial light intensity profile normalized to the brightness of the star if it were not obscured by the coronagraph. \\[0.3cm]
...
\paragraph{\NEWPROD{IFU_cgrph_SCI_CONTRAST_ADI}}\label{dataitem:ifu_cgrph_sci_contrast_adi}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWPROD{IFU_cgrph_SCI_CONTRAST_ADI}\\[0.3cm]
Description: & Post-ADI contrast curve for ADI observations  \\[0.3cm]
...
% \paragraph{\NEWPROD{IFU_cgrph_SCI_REDUCED}}\label{dataitem:ifu_cgrph_sci_reduced}
% \begin{recipedef}
% \textbf{\ac{FITS} image structure:}\\
% Name: & \NEWPROD{IFU_cgrph_SCI_REDUCED}\\[0.3cm]
...
\paragraph{\NEWPROD{IFU_cgrph_CENTROID_TAB}}\label{dataitem:ifu_cgrph_centroid_tab}
\begin{recipedef}
\textbf{\ac{FITS} structure:}\\
Name: & \NEWPROD{IFU_cgrph_CENTROID_TAB}\\[0.3cm]
...
\paragraph{\NEWPROD{det_cgrph_PSF_MEDIAN}}\label{dataitem:det_cgrph_psf_median}
\label{dataitem:lm_cgrph_psf_median}\label{dataitem:n_cgrph_psf_median}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWPROD{det_cgrph_PSF_MEDIAN}\\[0.3cm]
...
\paragraph{\NEWPROD{LM_APP_PSF_MEDIAN}}\label{dataitem:lm_app_psf_median}
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \NEWPROD{LM_APP_PSF_MEDIAN}\\[0.3cm]
Description: & Median PSF \\[0.3cm]
\hyperref[fits:pro.catg]{\FITS{PRO.CATG}}: & \FITS{LM_APP_PSF_MEDIAN}\\
OCA keywords: & \hyperref[fits:pro.catg]{\FITS{PRO.CATG}} \\
\FITS{DO.CATG}: & \FITS{LM_APP_PSF_MEDIAN}\\[0.3cm]
Created by recipe: & \NEWREC{metis_lm_adi_app}\\
Input for recipe: & None\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
\end{recipedef}
\begin{datastructdef}
