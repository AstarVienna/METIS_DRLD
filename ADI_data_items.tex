...
\begin{recipedef}
\textbf{\ac{FITS} image structure:}\\
Name: & \hyperref[dataitem:det_app_psf_median]{\PROD{det_app_PSF_MEDIAN}}\\[0.3cm]
Description: & Median PSF \\[0.3cm]
\hyperref[fits:pro.catg]{\FITS{PRO.CATG}}: & \FITS{det_app_PSF_MEDIAN}\\
OCA keywords: & \hyperref[fits:pro.catg]{\FITS{PRO.CATG}} \\
\FITS{DO.CATG}: & \FITS{det_app_PSF_MEDIAN}\\[0.3cm]
Created by recipe: & \hyperref[rec:metis_det_adi_cgrph]{\REC{metis_det_adi_cgrph}}\\
Input for recipe: & None\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
\end{recipedef}
