...
\hline
\texttt{1d-input\_spectrum\_filename} &  & mandatory\\
\hdashline
\texttt{1d-input\_spectrum\_filename} &  & mandatory\\
\end{tabular}
...
Due to the complexity of \mf a large set of parameters are required. As it is beyond the scope of this document to list all of them, we refer to App.~B in \cite{molecfit}.
