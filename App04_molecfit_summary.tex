...
\begin{tabular}{|c : c : c : c : c|} 
 ...
 \hline
 LM LSS & 1d science spectrum & \CODE{LM_LSS_STD_1D} & mandatory & 1 \\ 
  & 1d telluric spectrum & \CODE{LM_LSS_SCI_1D} & mandatory & 1 \\ 
 \hdashline
 N LSS & 1d science spectrum & \CODE{N_LSS_STD_1D} & mandatory & 1 \\ 
  & 1d telluric spectrum & \CODE{N_LSS_SCI_1D} & mandatory & 1 \\ 
 \hdashline
 \hdashline
