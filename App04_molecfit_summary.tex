...
Following \cite{molecfit} the first recipe requires a 1d-spectrum as input, either a science observation or a telluric standard star. For the \ac{LSS} mode that's not an issue as the extracted se
