...
\begin{tabular}{|c : r : c : c : c|} 
 ...
 \hline
 LM LSS & 1d science spectrum & \PROD{LM_LSS_SCI_1D} & mandatory & 1 \\ 
  & 1d telluric spectrum & \PROD{LM_LSS_STD_1D} & mandatory & 1 \\ 
 \hdashline
 N LSS & 1d science spectrum & \PROD{N_LSS_SCI_1D} & mandatory & 1 \\ 
  & 1d telluric spectrum & \PROD{N_LSS_STD_1D} & mandatory & 1 \\ 
 \hdashline
 LM IFU & 1d science spectrum & \PROD{TBD} & mandatory & 1 \\ 
 \hline
 ALL modes & Atmospheric profile & \PROD{TBD} & optional & 1 \\ 
           & GDAS profile & \PROD{TBD} & optional & 1 \\ 
           & KERNEL library & \PROD{TBD} & optional & 1 \\ 
           & inclusion regions & \PROD{TBD} & optional & 1 \\ 
           & exclusion regions & \PROD{TBD} & optional & 1 \\ 
           & pixel excl. list & \PROD{TBD} & optional & 1 \\ 
           & list of molecules & \PROD{TBD} & optional & 1 \\ 
\hline
\end{tabular}
\caption{Expected content of the \texttt{sof}-file for the recipe \texttt{XXX\_mf\_model}\label{tab:sof_mf_model}.
\newline $^a$Note that from the mandatory input spectra only one out of them is needed.}
\label{table:1}
\end{table}
%---------------------------------------------------------------------
