...
\begin{tabular}{|c : c : c : c : c|} 
 \hline
 observing & input & type & \texttt{sof}-tag & mandatory / \\ 
 mode & file & & \FITS{PRO.CATG} & optional \\ 
 \hline
 LM LSS & \texttt{1d\_input\_spectrum} & 1d science spectrum & \CODE{LM_LSS_STD_1D} & mandatory  \\ 
  & \texttt{input\_spectrum} & 1d telluric spectrum & \CODE{LM_LSS_SCI_1D} & mandatory  \\ 
 \hdashline
 N LSS & \texttt{1d\_input\_spectrum} & 1d science spectrum & \CODE{N_LSS_STD_1D} & mandatory  \\ 
  & \texttt{input\_spectrum} & 1d telluric spectrum & \CODE{N_LSS_SCI_1D} & mandatory  \\ 
 \hdashline
 & \texttt{TBD} & TBD & sof & optional  \\ 
 \hline
\end{tabular}
