...
The main output of the recipe \texttt{XXX\_mf\_model} is the best-fit model to be used to calculate the transmission on the entire wavelength range, and some \ac{QC} parameters. The latter 
