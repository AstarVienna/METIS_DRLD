...
% ##################################################################################### 
\paragraph{\hyperref[dataitem:tss_transmission]{\PROD{TSS_TRANSMISSION}}}\label{dataitem:tss_transmission}
...
% ##################################################################################### 
\paragraph{\hyperref[dataitem:lm_lss_tss_wave]{\STATCALIB{LM_LSS_TSS_WAVE}}}\label{dataitem:lm_lss_tss_wave}
TBWritten
