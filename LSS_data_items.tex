...
Input for recipe: & \hyperref[rec:lsslmrsrf]{\REC{metis_lm_lss_rsrf}}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
%\paragraph{\hyperref[dataitem:lmlssrsrfraw]{\PROD{LM_RSRF_RAW}}}\label{drsstructure:lmrsrfraw}
\begin{datastructdef}
...
Input for recipe: & \hyperref[rec:lsslmtrace]{\REC{metis_lm_lss_trace}}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
%\paragraph{\hyperref[dataitem:lmlssrsrfraw]{\PROD{LM_RSRF_RAW}}}\label{drsstructure:lmrsrfraw}
...
Input for recipe: & \hyperref[rec:lsslmwave]{\REC{metis_lm_lss_wave}}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
%\paragraph{\hyperref[dataitem:lmlssrsrfraw]{\PROD{LM_RSRF_RAW}}}\label{drsstructure:lmrsrfraw}
...
Input for recipe: & \hyperref[rec:lsslmstd]{\REC{metis_lm_lss_std}}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
%\paragraph{\hyperref[dataitem:lmlssrsrfraw]{\PROD{LM_RSRF_RAW}}}\label{drsstructure:lmrsrfraw}
...
Input for recipe: & \hyperref[rec:lsslmsci]{\REC{metis_lm_lss_sci}}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
%\paragraph{\hyperref[dataitem:lmlssrsrfraw]{\PROD{LM_RSRF_RAW}}}\label{drsstructure:lmrsrfraw}
...
% ##################################################################################### N RSRF RAW 
\paragraph{\hyperref[dataitem:nlssrsrfraw]{\RAW{N_LSS_RSRF_RAW}}}\label{dataitem:nlssrsrfraw}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
...
Input for recipe: & \hyperref[rec:lssnrsrf]{\REC{metis_n_lss_rsrf}}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
%\paragraph{\hyperref[dataitem:lmlssrsrfraw]{\PROD{LM_RSRF_RAW}}}\label{drsstructure:lmrsrfraw}
...
Input for recipe: & \hyperref[rec:lsslmtrace]{\REC{metis_n_lss_trace}}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
%\paragraph{\hyperref[dataitem:lmlssrsrfraw]{\PROD{LM_RSRF_RAW}}}\label{drsstructure:lmrsrfraw}
...
Template: & \TPL{METIS_spec_lm_cal_Standard}\\
Input for recipe: & \hyperref[rec:lssnflux]{\REC{metis_n_lss_flux}}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
%\paragraph{\hyperref[dataitem:lmlssrsrfraw]{\PROD{LM_RSRF_RAW}}}\label{drsstructure:lmrsrfraw}
...
Input for recipe: & \hyperref[rec:lssnsci]{\REC{metis_n_lss_sci}}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
%\paragraph{\hyperref[dataitem:lmlssrsrfraw]{\PROD{LM_RSRF_RAW}}}\label{drsstructure:lmrsrfraw}
...
Input for recipes: & \hyperref[rec:lsslmtrace]{\REC{metis_lm_lss_trace}}\\
                   & \hyperref[rec:lsslmwave]{\REC{metis_lm_lss_wave}}\\
                   & \hyperref[rec:lsslmstd]{\REC{metis_lm_lss_std}}\\
                   & \hyperref[rec:lsslmsci]{\REC{metis_lm_lss_sci}}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
%\paragraph{\hyperref[dataitem:lmlssrsrfraw]{\PROD{LM_RSRF_RAW}}}\label{drsstructure:lmrsrfraw}
...
Input for recipes: & \hyperref[rec:lssntrace]{\REC{metis_n_lss_trace}}\\
                   & \hyperref[rec:lssnflux]{\REC{metis_n_lss_flux}}\\
                   & \hyperref[rec:lssnsci]{\REC{metis_n_lss_sci}}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
%\paragraph{\hyperref[dataitem:lmlssrsrfraw]{\PROD{LM_RSRF_RAW}}}\label{drsstructure:lmrsrfraw}
...
OCA keywords: & \hyperref[fits:pro.catg]{\FITS{PRO.CATG}},  \hyperref[fits:ins.opti9.name]{\FITS{INS.OPTI9.NAME}}, \hyperref[fits:ins.opti12.name]{\FITS{INS.OPTI10.NAME}}, \hyperref[fits:ins.opti11.name]{\FITS{INS.OPTI11.NAME}} \\
\FITS{DO.CATG}: & n/a \\[0.3cm]
Created by: & \hyperref[rec:lsslmstd]{\REC{metis_lm_lss_std}}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
...
% ##################################################################################### 
\paragraph{\hyperref[dataitem:lsslmresp]{\PROD{MASTER_LM_RESPONSE}}}\label{dataitem:lsslmresp}
\begin{recipedef}
Name: & \hyperref[dataitem:lsslmresp]{\PROD{MASTER_LM_RESPONSE}}\\[0.3cm]
...
Produced by recipe: & \hyperref[rec:lsslmstd]{\REC{metis_LM_lss_flux}} \\
Input for recipe(s): & \hyperref[rec:lsslmsci]{\REC{metis_LM_LSS_sci}}\\
QC Parameters: &  TBD\\
...
% ##################################################################################### 
\paragraph{\hyperref[dataitem:lssnresp]{\PROD{MASTER_N_RESPONSE}}}\label{dataitem:lssnresp}
\begin{recipedef}
Name: & \hyperref[dataitem:lssnresp]{\PROD{MASTER_N_RESPONSE}}\\[0.3cm]
Description: & Master N-band response function for absolute flux calibration \\[0.3cm]
OCA keywords: & \FITS{PRO.CATG}, \FITS{INS.MODE}, \FITS{INS.SPEC.SETUP}\\
\FITS{PRO.CATG}: & \FITS{TBD} \\[0.3cm]
Produced by recipe: & \hyperref[rec:lssnflux]{\REC{metis_N_lss_flux}} \\
Input for recipe(s): & \hyperref[rec:lssnsci]{\REC{metis_N_LSS_sci}}\\
QC Parameters: &  TBD\\
Processing FITS Keywords: & provided at \ac{PAE}\\
\end{recipedef}
Corresponding \ac{CPL} structure:
