...
% ##################################################################################### LM SLITLOSS RAW 
\paragraph{\NEWRAW{LM_SLITLOSSES_RAW}}\label{dataitem:lm_slitlosses_raw}

\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWRAW{LM_SLITLOSSES_RAW}\\[0.3cm]
...
%Input for recipes: & \NEWREC{metis_lm_lss_std}\\
%& \NEWREC{metis_lm_lss_sci}\\
Input for recipes:    & \NEWREC{metis_lm_adc_slitloss} \\
...
% ##################################################################################### LM SLITLOSS RAW 
\paragraph{\NEWRAW{N_SLITLOSSES_RAW}}\label{dataitem:n_slitlosses_raw}

\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWRAW{N_SLITLOSSES_RAW}\\[0.3cm]
Description: & Raw exposure for determining the \ac{ADC} slitlosses.\\[0.3cm]
\hyperref[fits:dpr.catg]{\FITS{DPR.CATG}}: & \FITS{CALIB}\\
...
%Input for recipes: & \NEWREC{metis_n_lss_std}\\
%& \NEWREC{metis_n_lss_sci}\\
Input for recipes: & \NEWREC{metis_n_adc_slitloss} \\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
%\paragraph{\NEWPROD{LM_RSRF_RAW}}\label{drsstructure:LM_RSRF_RAW}
...
% ##################################################################################### LM RSRF RAW 
\paragraph{\NEWRAW{LM_LSS_RSRF_RAW}}\label{dataitem:lm_lss_rsrf_raw}

\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWRAW{LM_LSS_RSRF_RAW}\\[0.3cm]
...
Input for recipe: & \NEWREC{metis_lm_lss_rsrf}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
%\paragraph{\NEWPROD{LM_RSRF_RAW}}\label{drsstructure:LM_RSRF_RAW}
...
% ##################################################################################### 
\paragraph{\NEWRAW{LM_LSS_RSRF_PINH_RAW}}\label{dataitem:lm_lss_rsrf_pinh_raw}
%\TODO{CAVEAT: These obs are neither defined in the calib plan nor in the template manual yet! ToBe added after FDR}}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWRAW{LM_LSS_RSRF_PINH_RAW}\\[0.3cm]
...
Input for recipe: & \NEWREC{metis_lm_lss_trace}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
%\paragraph{\NEWPROD{LM_RSRF_RAW}}\label{drsstructure:LM_RSRF_RAW}
...
% ##################################################################################### 
\paragraph{\NEWRAW{LM_LSS_WAVE_RAW}}\label{dataitem:lm_lss_wave_raw}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWRAW{LM_LSS_WAVE_RAW}\\[0.3cm]
...
Input for recipe: & \NEWREC{metis_lm_lss_wave}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
%\paragraph{\NEWPROD{LM_RSRF_RAW}}\label{drsstructure:LM_RSRF_RAW}
...
% ##################################################################################### 
\paragraph{\NEWRAW{LM_LSS_STD_RAW}}\label{dataitem:lm_lss_std_raw}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWRAW{LM_LSS_STD_RAW}\\[0.3cm]
...
Input for recipe: & \NEWREC{metis_lm_lss_std}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
%\paragraph{\NEWPROD{LM_RSRF_RAW}}\label{drsstructure:LM_RSRF_RAW}
...
% ##################################################################################### 
\paragraph{\NEWRAW{LM_LSS_SCI_RAW}}\label{dataitem:lm_lss_sci_raw}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWRAW{LM_LSS_SCI_RAW}\\[0.3cm]
...
Input for recipe: & \NEWREC{metis_lm_lss_sci}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
%\paragraph{\NEWPROD{LM_RSRF_RAW}}\label{drsstructure:LM_RSRF_RAW}
...
% ##################################################################################### N RSRF RAW 
\paragraph{\NEWRAW{N_LSS_RSRF_RAW}}\label{dataitem:n_lss_rsrf_raw}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWRAW{N_LSS_RSRF_RAW}\\[0.3cm]
Description: & Raw exposure of the \ac{WCU} flatfield lamp through the \ac{LSS} to achieve the \ac{RSRF}.\\[0.3cm]
\hyperref[fits:dpr.catg]{\FITS{DPR.CATG}}: & \FITS{CALIB}\\
\hyperref[fits:dpr.tech]{\FITS{DPR.TECH}}: & \FITS{LSS,N} \\
\hyperref[fits:dpr.type]{\FITS{DPR.TYPE}}: & \FITS{FLAT,LAMP} \\[0.3cm]
...
Input for recipe: & \NEWREC{metis_n_lss_rsrf}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
%\paragraph{\NEWPROD{LM_RSRF_RAW}}\label{drsstructure:LM_RSRF_RAW}
...
% ##################################################################################### 
\paragraph{\NEWRAW{N_LSS_WAVE_RAW}}\label{dataitem:n_lss_wave_raw}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWRAW{N_LSS_WAVE_RAW}\\[0.3cm]
...
% ##################################################################################### 
\paragraph{\NEWRAW{N_LSS_RSRF_PINH_RAW}}\label{dataitem:n_lss_rsrf_pinh_raw}
%\TODO{CAVEAT: These obs are neither defined in the calib plan nor in the template manual yet! ToBe added after FDR}}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWRAW{N_LSS_RSRF_PINH_RAW}\\[0.3cm]
Description: & Raw exposure of the \ac{WCU} flatfield lamp through the \ac{LSS} to achieve the order detection / distortion model.\\[0.3cm]
\hyperref[fits:dpr.catg]{\FITS{DPR.CATG}}: & \FITS{CALIB}\\
\hyperref[fits:dpr.tech]{\FITS{DPR.TECH}}: & \FITS{LSS,N} \\
\hyperref[fits:dpr.type]{\FITS{DPR.TYPE}}: & \FITS{FLAT,LAMP,PINH} \\[0.3cm]
...
Input for recipe: & \NEWREC{metis_n_lss_trace}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
%\paragraph{\NEWPROD{LM_RSRF_RAW}}\label{drsstructure:LM_RSRF_RAW}
...
\end{datastructdef}
% ##################################################################################### 
\paragraph{\NEWRAW{N_LSS_STD_RAW}}\label{dataitem:n_lss_std_raw}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWRAW{N_LSS_STD_RAW}\\[0.3cm]
...
Template: & \TPL{METIS_spec_n_cal_Standard}\\
             & \TPL{METIS_spec_lmn_obs_AutoChopNodOnSlit}\\
Input for recipe: & \NEWREC{metis_n_lss_std}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
%\paragraph{\NEWPROD{LM_RSRF_RAW}}\label{drsstructure:LM_RSRF_RAW}
...
% ##################################################################################### 
\paragraph{\NEWRAW{N_LSS_SCI_RAW}}\label{dataitem:n_lss_sci_raw}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWRAW{N_LSS_SCI_RAW}\\[0.3cm]
...
Templates:   & \TPL{METIS_spec_n_obs_AutoChopNodOnSlit}\\
             & \TPL{METIS_spec_lmn_obs_AutoChopNodOnSlit}\\
Input for recipe: & \NEWREC{metis_n_lss_sci}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
%\paragraph{\NEWPROD{LM_RSRF_RAW}}\label{drsstructure:LM_RSRF_RAW}
...
% ##################################################################################### 
\paragraph{\NEWPROD{MASTER_LM_LSS_RSRF}}\label{dataitem:master_lm_lss_rsrf}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{MASTER_LM_LSS_RSRF}\\[0.3cm]
...
Created by: & \NEWREC{metis_lm_lss_rsrf}\\
Input for recipes: & \NEWREC{metis_lm_lss_trace}\\
...
% ##################################################################################### 
\paragraph{\NEWPROD{MEDIAN_LM_LSS_RSRF_IMG}}\label{dataitem:median_lm_lss_rsrf_img}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{MEDIAN_LM_LSS_RSRF_IMG}\\[0.3cm]
Description: & LM-band \ac{LSS} Median \ac{RSRF}.\\[0.3cm]
\hyperref[fits:pro.catg]{\FITS{PRO.CATG}}: & \FITS{MEDIAN_LM_LSS_RSRF_IMG}\\
OCA keywords: & \hyperref[fits:pro.catg]{\FITS{PRO.CATG}},  \hyperref[fits:ins.opti9.name]{\FITS{INS.OPTI9.NAME}}, \hyperref[fits:ins.opti12.name]{\FITS{INS.OPTI10.NAME}}, \hyperref[fits:ins.opti11.name]{\FITS{INS.OPTI11.NAME}} \\
...
\end{datastructdef}
% ##################################################################################### 
\paragraph{\NEWPROD{MEAN_LM_LSS_RSRF_IMG}}\label{dataitem:mean_lm_lss_rsrf_img}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{MEAN_LM_LSS_RSRF_IMG}\\[0.3cm]
...
% ##################################################################################### 
\paragraph{\NEWPROD{MASTER_N_LSS_RSRF}}\label{dataitem:master_n_lss_rsrf}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{MASTER_N_LSS_RSRF}\\[0.3cm]
Description: & LM-band \ac{LSS} Master \ac{RSRF}.\\[0.3cm]
...
Created by: & \NEWREC{metis_n_lss_rsrf}\\
Input for recipes: & \NEWREC{metis_n_lss_trace}\\
...
% ##################################################################################### 
\paragraph{\NEWPROD{MEDIAN_N_LSS_RSRF_IMG}}\label{dataitem:median_n_lss_rsrf_img}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{MEDIAN_N_LSS_RSRF_IMG}\\[0.3cm]
Description: & LM-band \ac{LSS} Median \ac{RSRF}.\\[0.3cm]
...
% ##################################################################################### 
\paragraph{\NEWPROD{MEAN_N_LSS_RSRF_IMG}}\label{dataitem:mean_n_lss_rsrf_img}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{MEAN_N_LSS_RSRF_IMG}\\[0.3cm]
Description: & LM-band \ac{LSS} Mean \ac{RSRF}.\\[0.3cm]
...
% ##################################################################################### 
\paragraph{\NEWPROD{LM_LSS_TRACE}}\label{dataitem:lm_lss_trace}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{LM_LSS_TRACE}\\[0.3cm]
...
Created by: & \NEWREC{metis_lm_lss_trace}\\
Input for:    & \NEWREC{metis_LM_lss_wave} \\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
...
% ##################################################################################### 
\paragraph{\NEWPROD{N_LSS_TRACE}}\label{dataitem:n_lss_trace}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{N_LSS_TRACE}\\[0.3cm]
...
Created by: & \NEWREC{metis_n_lss_trace}\\
Input for:    & \NEWREC{metis_N_lss_std} \\
              & \NEWREC{metis_N_lss_sci} \\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
\end{recipedef}
\begin{datastructdef}
...
% ##################################################################################### 
\paragraph{\NEWPROD{LM_LSS_CURVE}}\label{dataitem:lm_lss_curve}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{LM_LSS_CURVE}\\[0.3cm]
...
Created by: & \NEWREC{metis_lm_lss_wave}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
\end{recipedef}
\begin{datastructdef}
\textbf{Corresponding \ac{CPL} structure:}
...
% ##################################################################################### 
\paragraph{\NEWPROD{LM_LSS_DIST_SOL}}\label{dataitem:lm_lss_dist_sol}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{LM_LSS_DIST_SOL}\\[0.3cm]
...
Created by: & \NEWREC{metis_lm_lss_wave}\\
Input for:    & \NEWREC{metis_LM_lss_std} \\
              & \NEWREC{metis_LM_lss_sci} \\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
\end{recipedef}
\begin{datastructdef}
...
% ##################################################################################### 
\paragraph{\NEWPROD{LM_LSS_WAVE_GUESS}}\label{dataitem:lm_lss_wave_guess}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{LM_LSS_WAVE_GUESS}\\[0.3cm]
...
% ##################################################################################### 
\paragraph{\NEWPROD{LM_LSS_STD_OBJ_MAP}}\label{dataitem:lm_lss_std_obj_map}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{LM_LSS_STD_OBJ_MAP}\\[0.3cm]
...
OCA keywords: & \hyperref[fits:pro.catg]{\FITS{PRO.CATG}},  \hyperref[fits:ins.opti9.name]{\FITS{INS.OPTI9.NAME}}, \hyperref[fits:ins.opti12.name]{\FITS{INS.OPTI10.NAME}}, \hyperref[fits:ins.opti11.name]{\FITS{INS.OPTI11.NAME}} \\
\FITS{DO.CATG}: & n/a \\[0.3cm]
Created by: & \NEWREC{metis_lm_lss_std}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
...
% ##################################################################################### 
\paragraph{\NEWPROD{LM_LSS_STD_SKY_MAP}}\label{dataitem:lm_lss_std_sky_map}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{LM_LSS_STD_SKY_MAP}\\[0.3cm]
...
\end{datastructdef}
% ##################################################################################### 
\paragraph{\NEWPROD{LM_LSS_STD_1D}}\label{dataitem:lm_lss_std_1d}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{LM_LSS_STD_1D}\\[0.3cm]
...
% ##################################################################################### 
\paragraph{\NEWPROD{N_LSS_STD_OBJ_MAP}}\label{dataitem:n_lss_std_obj_map}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{N_LSS_STD_OBJ_MAP}\\[0.3cm]
Description: & Image with detected object pixels of the flux standard star..\\[0.3cm]
\hyperref[fits:pro.catg]{\FITS{PRO.CATG}}: & \FITS{N_LSS_STD_OBJ_MAP}\\
OCA keywords: & \hyperref[fits:pro.catg]{\FITS{PRO.CATG}},  \hyperref[fits:ins.opti12.name]{\FITS{INS.OPTI12.NAME}}, \hyperref[fits:ins.opti13.name]{\FITS{INS.OPTI13.NAME}}, \hyperref[fits:ins.opti14.name]{\FITS{INS.OPTI14.NAME}}\\
\FITS{DO.CATG}: & n/a \\[0.3cm]
Created by: & \NEWREC{metis_n_lss_std}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
Comment: & intermediate data product used for \ac{QC} and as mask\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
...
\end{datastructdef}
% ##################################################################################### 
\paragraph{\NEWPROD{N_LSS_STD_SKY_MAP}}\label{dataitem:n_lss_std_sky_map}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{N_LSS_STD_SKY_MAP}\\[0.3cm]
...
% ##################################################################################### 
\paragraph{\NEWPROD{N_LSS_STD_1D}}\label{dataitem:n_lss_std_1d}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{N_LSS_STD_1D}\\[0.3cm]
...
% ##################################################################################### 
\paragraph{\NEWPROD{LM_LSS_SCI_OBJ_MAP}}\label{dataitem:lm_lss_sci_obj_map}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{LM_LSS_SCI_OBJ_MAP}\\[0.3cm]
...
OCA keywords: & \hyperref[fits:pro.catg]{\FITS{PRO.CATG}},  \hyperref[fits:ins.opti9.name]{\FITS{INS.OPTI9.NAME}}, \hyperref[fits:ins.opti12.name]{\FITS{INS.OPTI10.NAME}}, \hyperref[fits:ins.opti11.name]{\FITS{INS.OPTI11.NAME}} \\
\FITS{DO.CATG}: & n/a \\[0.3cm]
Created by: & \NEWREC{metis_lm_lss_sci}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
Comment: & intermediate data product used for \ac{QC} and as mask\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
...
\end{datastructdef}
% ##################################################################################### 
\paragraph{\NEWPROD{LM_LSS_SCI_SKY_MAP}}\label{dataitem:lm_lss_sci_sky_map}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{LM_LSS_SCI_SKY_MAP}\\[0.3cm]
...
\end{datastructdef}
% ##################################################################################### 
\paragraph{\NEWPROD{LM_LSS_SCI_2D}}\label{dataitem:lm_lss_sci_2d}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{LM_LSS_SCI_2D}\\[0.3cm]
...
% ##################################################################################### 
\paragraph{\NEWPROD{LM_LSS_SCI_1D}}\label{dataitem:lm_lss_sci_1d}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{LM_LSS_SCI_1D}\\[0.3cm]
Description: & Extracted 1d science spectrum.\\[0.3cm]
...
% ##################################################################################### 
\paragraph{\NEWPROD{N_LSS_SCI_OBJ_MAP}}\label{dataitem:n_lss_sci_obj_map}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{N_LSS_SCI_OBJ_MAP}\\[0.3cm]
...
OCA keywords: & \hyperref[fits:pro.catg]{\FITS{PRO.CATG}},  \hyperref[fits:ins.opti12.name]{\FITS{INS.OPTI12.NAME}}, \hyperref[fits:ins.opti13.name]{\FITS{INS.OPTI13.NAME}}, \hyperref[fits:ins.opti14.name]{\FITS{INS.OPTI14.NAME}}\\
\FITS{DO.CATG}: & n/a \\[0.3cm]
Created by: & \NEWREC{metis_n_lss_sci}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
Comment: & intermediate data product used for \ac{QC} and as mask\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
...
% ##################################################################################### 
\paragraph{\NEWPROD{N_LSS_SCI_SKY_MAP}}\label{dataitem:n_lss_sci_sky_map}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{N_LSS_SCI_SKY_MAP}\\[0.3cm]
...
\end{datastructdef}
% ##################################################################################### 
\paragraph{\NEWPROD{N_LSS_SCI_2D}}\label{dataitem:n_lss_sci_2d}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{N_LSS_SCI_2D}\\[0.3cm]
...
\end{datastructdef}
% ##################################################################################### 
\paragraph{\NEWPROD{N_LSS_SCI_1D}}\label{dataitem:n_lss_sci_1d}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{N_LSS_SCI_1D}\\[0.3cm]
Description: & Extracted 1d science spectrum.\\[0.3cm]
...
% ##################################################################################### 
\paragraph{\NEWPROD{STD_TRANSMISSION}}\label{dataitem:std_transmission}
\begin{recipedef}
Name: & \NEWPROD{STD_TRANSMISSION}\\[0.3cm]
...
Produced by recipe: & \NEWREC{metis_LM_lss_std} \\
                    & \NEWREC{metis_N_lss_std} \\
Input for recipe(s): & \NEWREC{metis_LM_LSS_sci}\\
QC Parameters: &  none\\
...
% ##################################################################################### 
\paragraph{\NEWPROD{MASTER_LM_RESPONSE}}\label{dataitem:master_lm_response}
\begin{recipedef}
Name: & \NEWPROD{MASTER_LM_RESPONSE}\\[0.3cm]
...
% ##################################################################################### 
\paragraph{\NEWPROD{MASTER_N_RESPONSE}}\label{dataitem:master_n_response}
\begin{recipedef}
Name: & \NEWPROD{MASTER_N_RESPONSE}\\[0.3cm]
...
Produced by recipe: & \NEWREC{metis_N_lss_std} \\
Input for recipe(s): & \NEWREC{metis_N_LSS_sci}\\
QC Parameters: &  none\\
Processing FITS Keywords: & provided at \ac{PAE}\\
\end{recipedef}
Corresponding \ac{CPL} structure:
...
\end{datastructdef}
% ##################################################################################### 
\paragraph{\NEWPROD{MF_BEST_FIT_TAB}}\label{dataitem:mf_best_fit_tab}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{MF_BEST_FIT_TAB}\\[0.3cm]
...
Created by: & \NEWREC{metis_LM_lss_mf_model}\\
            & \NEWREC{metis_N_lss_mf_model}\\
Input for:    & \NEWREC{metis_LM_lss_mf_calctrans} \\
              & \NEWREC{metis_N_lss_mf_calctrans} \\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
Purpose: & wavelength calibration / rectification\\
\end{recipedef}
\begin{datastructdef}
...
% ##################################################################################### 
\paragraph{\NEWPROD{LM_LSS_SYNTH_TRANS}}\label{dataitem:lm_lss_synth_trans}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{LM_LSS_SYNTH_TRANS}\\[0.3cm]
...
Created by: & \NEWREC{metis_LM_lss_mf_calctrans}\\
Input for:    & \NEWREC{metis_LM_lss_mf_correct} \\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
\end{recipedef}
\begin{datastructdef}
\textbf{Corresponding \ac{CPL} structure:}
...
\end{datastructdef}
% ##################################################################################### 
\paragraph{\NEWPROD{N_LSS_SYNTH_TRANS}}\label{dataitem:n_lss_synth_trans}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{N_LSS_SYNTH_TRANS}\\[0.3cm]
Description: & Synthetic transmission curve to be used for telluric correction of flux standard stars\\[0.3cm]
\hyperref[fits:pro.catg]{\FITS{PRO.CATG}}: & \FITS{N_LSS_SYNTH_TRANS}\\
OCA keywords: & \hyperref[fits:pro.catg]{\FITS{PRO.CATG}}\\
\FITS{DO.CATG}: & \FITS{N_LSS_SYNTH_TRANS}\\[0.3cm]
Created by: & \NEWREC{metis_N_lss_mf_calctrans}\\
Input for:    & \NEWREC{metis_N_lss_mf_correct} \\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
\end{recipedef}
\begin{datastructdef}
\textbf{Corresponding \ac{CPL} structure:}
...
% ##################################################################################### 
%\paragraph{\NEWPROD{}}\label{dataitem:}
...
% ##################################################################################### 
\paragraph{\NEWPROD{LM_LSS_SCI_FLUX_2D}}\label{dataitem:lm_lss_sci_flux_2d}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{LM_LSS_SCI_FLUX_2D}\\[0.3cm]
...
% ##################################################################################### 
\paragraph{\NEWPROD{N_LSS_SCI_FLUX_2D}}\label{dataitem:n_lss_sci_flux_2d}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{N_LSS_SCI_FLUX_2D}\\[0.3cm]
...
% ##################################################################################### 
\paragraph{\NEWPROD{LM_LSS_SCI_FLUX_1D}}\label{dataitem:lm_lss_sci_flux_1d}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{LM_LSS_SCI_FLUX_1D}\\[0.3cm]
...
Created by: & \NEWREC{metis_lm_lss_sci}\\
Input for:    & \NEWREC{metis_LM_lss_mf_model} \\
              & \NEWREC{metis_LM_lss_mf_correct} \\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
Comment: & intermediate data product used for \ac{QC}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
...
% ##################################################################################### 
\paragraph{\NEWPROD{N_LSS_SCI_FLUX_1D}}\label{dataitem:n_lss_sci_flux_1d}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{N_LSS_SCI_FLUX_1D}\\[0.3cm]
Description: & Extracted, flux-calibrated 1d science spectrum.\\[0.3cm]
\hyperref[fits:pro.catg]{\FITS{PRO.CATG}}: & \FITS{N_LSS_SCI_FLUX_1D}\\
OCA keywords: & \hyperref[fits:pro.catg]{\FITS{PRO.CATG}},  \hyperref[fits:ins.opti12.name]{\FITS{INS.OPTI12.NAME}}, \hyperref[fits:ins.opti13.name]{\FITS{INS.OPTI13.NAME}}, \hyperref[fits:ins.opti14.name]{\FITS{INS.OPTI14.NAME}} \\
\FITS{DO.CATG}: & \FITS{N_LSS_SCI_FLUX_1D}\\[0.3cm]
Created by: & \NEWREC{metis_n_lss_sci}\\
Input for:    & \NEWREC{metis_N_lss_mf_model} \\
              & \NEWREC{metis_N_lss_mf_correct} \\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
Comment: & intermediate data product used for \ac{QC}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
...
% ##################################################################################### 
\paragraph{\NEWPROD{LM_LSS_STD_WAVE}}\label{dataitem:lm_lss_std_wave}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{LM_LSS_STD_WAVE}\\[0.3cm]
...
% ##################################################################################### 
\paragraph{\NEWPROD{LM_LSS_SCI_FLUX_TELLCORR_1D}}\label{dataitem:lm_lss_sci_flux_tellcorr_1d}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{LM_LSS_SCI_FLUX_TELLCORR_1D}\\[0.3cm]
Description: & Extracted, flux-calibrated 1d science spectrum.\\[0.3cm]
\hyperref[fits:pro.catg]{\FITS{PRO.CATG}}: & \FITS{LM_LSS_SCI_FLUX_TELLCORR_1D}\\
OCA keywords: & \hyperref[fits:pro.catg]{\FITS{PRO.CATG}},  \hyperref[fits:ins.opti9.name]{\FITS{INS.OPTI9.NAME}}, \hyperref[fits:ins.opti12.name]{\FITS{INS.OPTI10.NAME}}, \hyperref[fits:ins.opti11.name]{\FITS{INS.OPTI11.NAME}} \\
\FITS{DO.CATG}: & \FITS{LM_LSS_SCI_FLUX_TELLCORR_1D}\\[0.3cm]
Created by: & \NEWREC{metis_LM_lss_mf_correct}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
Comment: & intermediate data product used for \ac{QC}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
...
\end{datastructdef}
% ##################################################################################### 
\paragraph{\NEWPROD{N_LSS_SCI_FLUX_TELLCORR_1D}}\label{dataitem:n_lss_sci_flux_tellcorr_1d}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{N_LSS_SCI_FLUX_TELLCORR_1D}\\[0.3cm]
...
Created by: & \NEWREC{metis_N_lss_mf_correct}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
Comment: & intermediate data product used for \ac{QC}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
