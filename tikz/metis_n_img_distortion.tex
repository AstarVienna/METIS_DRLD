...
\begin{tikzpicture}
  ...
  %% Input
  \node (bpmin) [left=of step2, calproduct] {BADPIX\_MAP\_GEO};
  \draw (bpmin) -- (step2);
  ...
  ($(step3)!0.25!(stop-t)$) {};
  \node (disttable) [right=of connectdisttable, calproduct]{%
    N\_DISTORT\_TABLE
  };
  ...
  ($(step3)!0.5!(stop-t)$) {};
  \node (distmap) [right=of connectdistmap, calproduct]{%
    N\_DISTORT\_MAP
  };
  ...
  rectangle ($(step3)!0.825!(stop-t) + (2.5,0)$);
