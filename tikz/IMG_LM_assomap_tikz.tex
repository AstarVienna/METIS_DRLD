...
\begin{tikzpicture}[on grid=false,node distance=0.8cm]
  ...
  \matrix (recipes) [column sep=0.1cm, row sep=1cm]{
   ...
   \\
    ...
    \node (dist_dark) [empty]{};
    &
    \node (dark_dark) [calibproduct]{MASTER\_DARK\_2RG};
    &
    ...
    % Row *_lin
    \node (lin_lin) [statcalfile]{LINEARITY\_2RG};
    &
    \node (dist_lin) [empty]{};
    &
    \node (dark_lin)[empty]{};
    ...
    \node (dark_flat)[empty]{};
    &
    \node (flat_flat) [calibproduct]{MASTER\_FLAT\_2RG};
    &
    ...
    \node (flat_all1)[empty]{};
    &
    \node (all1_all1)[calibproduct]{STD\_REDUCED};
    &
    \node (all2_all1)[calibproduct]{STD\_BKG\_SUB};
    &
...
% Row *_all2
    ...
    \node (flat_all2)[empty]{};
    &
    \node (all1_all2)[scienceproduct]{SCI\_REDUCED};
    &
    \node (all2_all2)[scienceproduct]{SCI\_BKG\_SUB};
    &
    \node (std_all2)[empty]{};
    &
    ...
    \node (all2_sci1)[empty]{};
    &
    \node (std_sci1)[calibproduct]{FLUXCAL\_TAB};
    &
    ...
    \node (std_sci2)[empty]{};
    &
    \node (sci1_sci2)  [scienceproduct]{LM\_SCI\_CALIBRATED};
    &
    ...
    \node(sci1_prod) [empty]{};
    &
    \node (sci2_prod)[scienceproduct]{LM\_SCI\_COADD};
    \\
  };    % end matrix
