...
\begin{tikzpicture}[on grid=false,node distance=0.8cm]
  ...
  \matrix (recipes) [column sep=0.1cm, row sep=1cm]{
   ...
   \\
    ...
    \node (lin_pers)[extcalfile]{\EXTCALIB{PERSISTENCE_MAP}};
    &
    \node (dist_pers)[extcalfile]{\EXTCALIB{PERSISTENCE_MAP}};
    &
    \node (dark_pers)[extcalfile]{\EXTCALIB{PERSISTENCE_MAP}};
    &
    \node (flat_pers)[extcalfile]{\EXTCALIB{PERSISTENCE_MAP}};
    &
    \node (all1_pers)[extcalfile]{\EXTCALIB{PERSISTENCE_MAP}};
    &
    \node (all2_pers)[empty]{};
    &
    \node (std_pers)[empty]{};
...
% Row *_all2
  ...
  \draw [arrow] (lin_raw)  -- (lin_pers);
  \draw [arrow] (lin_pers)  -- (lin_lin);
  \draw [arrow] (dist_raw) -- (dist_pers);
  \draw [arrow] (dist_pers) -- (dist_dist);
  \draw [arrow] (dark_raw) -- (dark_pers);
  \draw [arrow] (dark_pers) -- (dark_dark);
  \draw [arrow] (flat_raw) -- (flat_pers);
  \draw [arrow] (flat_pers) -- (flat_flat);
  \draw [arrow] (all1_raw) -- (all1_pers);
  \draw [arrow] (all1_pers) -- (all1_all1);
