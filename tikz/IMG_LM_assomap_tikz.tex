...
%    \node[above] (sci2_raw){\recipebox{\RAW{SCIENCE}}{\REC{metis_lm_img_coadd}}};
   ...
   \\
    ...
    \node (dark_all1)[empty]{}; &
    \node (flat_all1)[empty]{}; &
    \node (all1_all1)[calibproduct]{\PROD{LM_STD_BASIC_REDUCED}}; &
    \node (all2_all1)[calibproduct]{\PROD{LM_STD_BKG_SUBTRACTED}}; &
...
% Row *_all2
    ...
    \node (dark_all2)[empty]{}; &
    \node (flat_all2)[empty]{}; &
    \node (all1_all2)[scienceproduct]{\PROD{LM_SCI_BASIC_REDUCED}}; &
    \node (all2_all2)[scienceproduct]{\PROD{LM_SCI_BKG_SUBTRACTED}}; &
    \node (std_all2)[empty]{}; &
...
%  \draw [arrow] (adi_sci2) -- (adi_prod);
  ...
  \draw [match, dashed] (bpm_bpm) -- (all1_bpm);
  \draw [match] (lin_lin) -- (all1_lin);
  \draw [match] (lin_gain) -- (all1_gain);
  \draw [match] (pers_pers) -- (all1_pers);
  \draw [match] (pers_pinh) -- (all1_pinh);
