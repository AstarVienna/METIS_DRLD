...
\begin{tikzpicture}[on grid=false,node distance=0.8cm]
  ...
  \matrix (recipes) [column sep=0.1cm, row sep=1cm]{
   ...
   \\
    ...
    \node (dist_flat)[empty]{}; &
    \node (dark_flat)[empty]{}; &
    \node (flat_flat) [calibproduct]{\NEWPROD{MASTER_IMG_FLAT_LAMP_LM}}; &
    ...
    \node (dark_all1)[empty]{}; &
    \node (flat_all1)[empty]{}; &
    \node (all1_all1)[calibproduct]{\NEWPROD{LM_STD_BASIC_REDUCED}}; &
    \node (all2_all1)[calibproduct]{\NEWPROD{LM_STD_BKG_SUBTRACTED}}; &
...
% Row *_all2
    ...
    \node (dark_all2)[empty]{}; &
    \node (flat_all2)[empty]{}; &
    \node (all1_all2)[scienceproduct]{\NEWPROD{LM_SCI_BASIC_REDUCED}}; &
    \node (all2_all2)[scienceproduct]{\NEWPROD{LM_SCI_BKG_SUBTRACTED}}; &
    \node (std_all2)[empty]{}; &
    ...
    \node (lin_dist) [empty]{}; &
    \node (pers_dist) [empty]{}; &
    \node (dist_dist)[statcalfile]{\NEWSTATCALIB{LM_DISTORTION_TABLE}}; &
    \node (dark_dist)[empty]{}; &
    \node (flat_dist) [empty]{}; &
    \node (all1_dist)[empty]{}; &
    \node (all2_dist)[empty]{}; &
