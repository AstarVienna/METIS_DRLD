...
\node (step2a) [below=0.25cm of step2, redstep]{%
    Sub-PSFs extraction and\\ alignment
  };

  \node (step2b) [below=0.25cm of step2a, redstep]{%
    Merger of \\ coronagraphic PSFs
  };


  \node (step3) [below=0.25cm of step2b, redstep]{%
    Estimate median PSF
  };
  ...
  \node (step5) [below=0.5cm of step4b, redstep]{%
    Derotate images
  };
