...
% \draw[help lines, green](-8, 0) grid (8, 21);
  ...
  \node (step6) [below=1.cm of step5, xshift=0cm,redstep]{%
    Contrast curve calculation
  };

  \node (step7) [below=1.cm of step6, xshift=0cm,redstep]{%
    Coadd images
  };
  ...
  \draw (connectpers) -- (molecparams);%-- ++(0.25, 0) -- ++(0., -0.8) -- ++(3.75, 0);;
\node (molecparams2) [left=3.95cm of connectpers,yshift=0cm, params]{%
    Recipe parameters
  };
  \draw (molecparams2) -- (connectpers);
