...
\begin{tikzpicture}
  ...
  \node (step2) [below of=step1, redstep] {thresholding};
  \pic (stop) [below=3.5cm of step2] {stop};
  ...
  %% Output
  \node (connectdark) [connection] at ($(step1)!0.5!(step2)$){};
  \node (masterdark) [right=of connectdark, calproduct] {MASTER\_DARK\_det};
  \draw (connectdark) -- (masterdark);

  \node (connecthot) [connection] at ($(step2)!0.5!(stop-t)$){};
  ...
  rectangle ($(step2)!0.8!(stop-t) + (2.5cm, 0)$);
