...
%    \node (adi_DIwcal)[empty]{};
    ...
    \node (RECscireduce_DIsciobject1d)[scienceproduct,below=2.0cm]{\EXTCALIB{IFU_SCI_REDUCED_1D}};
...
%    \node (adi_DIscireduced)[empty]{};
    ...
    \node (RECstdreduce_DIstdobject1d)[scienceproduct,below=1.25cm]{\PROD{IFU_STD_REDUCED_1D}};
