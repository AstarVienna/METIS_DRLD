...
%    \node[above] (RECbpm_raw)[empty]{}; &
    \node[above] (RECbpm_raw)[empty]{}; &
%    \node[above] (RECbpm_raw){\recipebox{\RAW{DETLIN_IFU_RAW}}{\REC{metis_det_lingain}}}; &
...
%    };
    ...
    \node (RECbpm_DIbpm)[extcalfile]{\STATCALIB{BADPIX_MAP_IFU}}; &
    \node (REClin_DIbpm)[connection]{}; &
    \node (RECpers_DIbpm)[empty]{}; &
    \node (RECdark_DIbpm)[connection]{}; &
    \node (RECgeom_DIbpm)[connection]{}; &
    \node (RECwcal_DIbpm)[connection]{}; &
    \node (RECrsrf_DIbpm)[connection]{}; &
    \node (RECstdreduce_DIbpm)[connection]{}; &
    \node (RECscireduce_DIbpm)[connection]{}; &
    \node (RECtac_DIbpm)[empty]{}; &
    \node (RECstd_DIbpm)[empty]{}; &
    \node (RECsci1_DIbpm)[empty]{}; &
    \node (RECsci2_DIbpm)[empty]{}; \\

    \node (RECbpm_DIlin)[empty]{}; &
    \node (REClin_DIlin)[statcalfile]{\STATCALIB{LINEARITY_IFU}}; &
    \node (RECpers_DIlin)[empty]{}; &
    \node (RECdark_DIlin)[connection]{}; &
    \node (RECgeom_DIlin)[connection]{}; &
    \node (RECwcal_DIlin)[connection]{}; &
    \node (RECrsrf_DIlin)[connection]{}; &
    ...
    \node (RECbpm_DIgain)[empty]{}; &
    \node (REClin_DIgain)[statcalfile]{\STATCALIB{GAIN_MAP_IFU}}; &
    \node (RECpers_DIgain)[empty]{}; &
    \node (RECdark_DIgain)[connection]{}; &
    \node (RECgeom_DIgain)[connection]{}; &
    \node (RECwcal_DIgain)[connection]{}; &
    \node (RECrsrf_DIgain)[connection]{}; &
    \node (RECstdreduce_DIgain)[connection]{}; &
    \node (RECscireduce_DIgain)[connection]{}; &
    \node (RECtac_DIgain)[empty]{}; &
    \node (RECstd_DIgain)[empty]{}; &
    \node (RECsci1_DIgain)[empty]{}; &
    \node (RECsci2_DIgain)[empty]{}; \\

    \node (RECbpm_DIpers)[empty]{}; &
    \node (REClin_DIpers)[empty]{}; &
    \node (RECpers_DIpers)[extcalfile]{\STATCALIB{PERSISTENCE_MAP}}; &
    \node (RECdark_DIpers)[connection]{}; &
    \node (RECgeom_DIpers)[connection]{}; &
    \node (RECwcal_DIpers)[connection]{}; &
    \node (RECrsrf_DIpers)[connection]{}; &
    ...
    \node (RECbpm_DIpinh)[empty]{}; &
    \node (REClin_DIpinh)[empty]{}; &
    \node (RECpers_DIpinh)[extcalfile]{\PROD{PINHOLE_TABLE}}; &
    \node (RECdark_DIpinh)[empty]{}; &
    \node (RECgeom_DIpinh)[connection]{}; &
    \node (RECwcal_DIpinh)[empty]{}; &
    \node (RECrsrf_DIpinh)[empty]{}; &
    \node (RECstdrecude_DIpinh)[empty]{}; &
    \node (RECscireduce_DIpinh)[empty]{}; &
    \node (RECtac_DIpinh)[empty]{}; &
    \node (RECstd_DIpinh)[empty]{}; &
    \node (RECsci1_DIpinh)[empty]{}; &
    \node (RECsci2_DIpinh)[empty]{}; \\

    % Row *_dark
    \node (RECbpm_DIdark)[empty]{}; &
...
%    \node (adi_DIstdreduced)[empty]{};
    ...
    \node (RECtac_DIfluxstd)[connection]{}; &
    \node (RECsci1_DIfluxstd)[empty]{}; &
    \node (RECsci2_DIfluxstd)[empty]{}; \\

    % Row *_lsf
    \node (RECbpm_DIlsf)[empty]{}; &
    \node (REClin_DIlsf)[empty]{}; &
    \node (RECpers_DIlsf)[extcalfile]{\EXTCALIB{LSF_KERNEL}}; &
    \node (RECdark_DIlsf)[empty]{}; &
    \node (RECgeom_DIlsf)[empty]{}; &
    \node (RECwcal_DIlsf)[empty]{}; &
    \node (RECrsrf_DIlsf)[empty]{}; &
    \node (RECstdreduce_DIlsf)[empty]{}; &
    \node (RECscireduce_DIlsf)[empty]{}; &
    \node (RECstd_DIlsf)[connection]{}; &
    \node (RECtac_DIlsf)[connection]{}; &
    \node (RECsci1_DIlsf)[empty]{}; &
    \node (RECsci2_DIlsf)[empty]{}; \\

    % Row *_atm
    \node (RECbpm_DIatm)[empty]{}; &
    \node (REClin_DIatm)[empty]{}; &
    \node (RECpers_DIatm)[extcalfile]{\EXTCALIB{ATM_PROFILE}}; &
    \node (RECdark_DIatm)[empty]{}; &
    \node (RECgeom_DIatm)[empty]{}; &
    \node (RECwcal_DIatm)[empty]{}; &
    \node (RECrsrf_DIatm)[empty]{}; &
    \node (RECstdreduce_DIatm)[empty]{}; &
    \node (RECscireduce_DIatm)[empty]{}; &
    \node (RECstd_DIatm)[connection]{}; &
    \node (RECtac_DIatm)[connection]{}; &
    \node (RECsci1_DIatm)[empty]{}; &
    \node (RECsci2_DIatm)[empty]{}; \\
%    &
%    \node (adi_DIfluxstd)[empty]{};

    % Row *_tac
    \node (RECbpm_DItac)[empty]{}; &
...
%    \node (adi_adi)[scienceproduct]{ADI\_SCI\_COADD};
  ...
  % dashed line separating daily procedure (currently not feasible)
 ...
 % \draw [thick,dashed] ([yshift=4ex]t1.north) -- ([yshift=-0ex]t2.south);
  ...
  \draw [arrow] (REClin_DIlin) -- (REClin_DIgain);
%% TODO: Put back in once we actually include the persistence recipe in the DRLD
%  \draw [arrow] (RECpers_raw) -- (RECpers_DIpers);
  ...
  \draw [match, dashed] (RECbpm_DIbpm) -- (RECscireduce_DIbpm);
...
%        (RECrsrf_DIlin) [xshift=-0.15cm] arc [start angle=180, end angle=0, radius=.15cm] --
        (RECscireduce_DIlin);
  \draw [match] (REClin_DIgain) -- (RECscireduce_DIgain);
...
%        (RECgeom_DIpers) [xshift=-0.15cm] arc [start angle=180, end angle=0, radius=.15cm] --
  ...
  \draw [match] (RECpers_DIpinh) --
  % At least there is still this one hoop in the matrix!
        (RECdark_DIpinh) [xshift=-0.15cm] arc [start angle=180, end angle=0, radius=.15cm] --
        (RECgeom_DIpinh);
  ...
  \draw [match] (RECpers_DIfluxstd) -- (RECtac_DIfluxstd);   % Line from FLUXSTD_CATALOG to further
  \draw [match] (RECpers_DIlsf) -- (RECtac_DIlsf);
  \draw [match] (RECpers_DIatm) -- (RECtac_DIatm);
