...
\begin{tikzpicture}[on grid=false, node distance=0.8cm]
  ...
  \matrix (recipes) [column sep=1mm, row sep=1cm]{
    ...
    \node[above] (geom_raw){%
      \recipebox{\NEWRAW{IFU_DISTORTION_RAW}}{\NEWREC{metis_ifu_distortion}}
    };
    &
    \node[above] (rsrf_raw){%
      \recipebox{\NEWRAW{IFU_RSRF_RAW}}{\NEWREC{metis_ifu_rsrf}}
    };
    &
    \node[above] (dark_raw) {%
      \recipebox{\NEWRAW{DARK_IFU_RAW}}{\NEWREC{metis_det_dark}}
    };
    &
    \node[above] (wcal_raw){%
      \recipebox{\NEWRAW{IFU_WAVE_RAW}}{\NEWREC{metis_ifu_wavecal}}
    };
    &
    \node[above] (std_raw){%
    ...
    &
    \node[above] (tac_raw){%
      \recipenotitlebox{\NEWREC{metis_ifu_tellcorr}}
    };
    &
    \node[above] (sci2_raw){%
      \recipenotitlebox{\NEWREC{metis_ifu_sci_postprocess}}
    };
%    &
%    \node[above] (adi_raw){%
...
%    };
    ...
    \node (geom_dark)[empty]{}; &
    \node (rsrf_dark)[empty]{}; &
    \node (dark_dark) [calibproduct] {\NEWPROD{MASTER_DARK_IFU}}; &
...
%    \node (adi_dark)[empty]{};
    ...
    % Row *_geom
    \node (geom_geom) [statcalfile] {\NEWPROD{IFU_DISTORTION_TABLE}}; &
    ...
    % Row *_rsrf
    \node (geom_rsrf) [empty]{}; &
    \node (rsrf_rsrf) [statcalfile] {\NEWPROD{RSRF_IFU}}; &
    \node (dark_rsrf)[empty]{}; &
    \node (wcal_rsrf)[empty]{}; &
...
%    \node (adi_rsrf)[empty]{};
    ...
    \node (dark_wcal)[empty]{};
    &
    \node (wcal_wcal) [calibproduct] {\NEWPROD{IFU_WAVECAL}};
    &
...
%    \node (adi_std)[empty]{};
    ...
    \node (wcal_fcal)[empty]{};
    &
    \node (std_fcal)[calibproduct] {\NEWPROD{FLUXCAL_TAB}};
    &
...
%    \node (adi_fcal)[empty]{};
    ...
    \node (std_sci1)[empty]{};
    &
    \node (sci1_sci1)[scienceproduct] {\NEWPROD{IFU_SCI_REDUCED}};
    & &
    \node (tac_sci1)[scienceproduct] {\NEWPROD{IFU_SCI_REDUCED_TAC}};
    &
...
%    \node (adi_sci1)[empty]{};
    ...
    \node (std_sci2)[empty]{};
    &
    \node (sci1_sci2)[scienceproduct] {\NEWPROD{IFU_SCI_COMBINED}};
    & &
    \node (tac_sci2)[scienceproduct] {\NEWPROD{IFU_SCI_COMBINED_TAC}};
    &
    \node (sci2_sci2) [empty]{};
%    &
%    \node (adi_sci2) [connection]{};
    ...
    \node (tac_adi)[empty]{};
    &
    \node (sci2_adi)[scienceproduct] {\NEWPROD{IFU_SCI_COADD}};
%    &
