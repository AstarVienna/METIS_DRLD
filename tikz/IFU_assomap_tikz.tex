...
%        (RECpers_DIlin) [xshift=-0.15cm] arc [start angle=180, end angle=0, radius=.15cm] --
        ...
        (RECscireduce_DIlin);
  \draw [match] (RECpers_DIpers) -- (RECscireduce_DIpers);
  \draw [match] (RECdark_DIdark) -- (RECscireduce_DIdark);
  \draw [match] (RECpers_DIpinh) -- (RECgeom_DIpinh);
  \draw [match] (RECgeom_DIgeom) --
        (RECdark_DIgeom) [xshift=-0.15cm] arc [start angle=180, end angle=0, radius=.15cm] --
        (RECscireduce_DIgeom);
  ...
  \draw [match] (RECpers_DIlsf) -- (RECtac_DIlsf);   % Line from FLUXSTD_CATALOG to further
  \draw [match] (RECpers_DIatm) -- (RECtac_DIatm);   % Line from FLUXSTD_CATALOG to further
