...
%        (RECpers_DIlin) [xshift=-0.15cm] arc [start angle=180, end angle=0, radius=.15cm] --
  ...
  \draw [match] (RECpers_DIpers) --
        ...
        (RECscireduce_DIpers);
  \draw [match] (RECdark_DIdark) --
        (RECrsrf_DIdark) [xshift=-0.15cm] arc [start angle=180, end angle=0, radius=.15cm] --
        (RECscireduce_DIdark);

  \draw [match] (RECgeom_DIgeom) --
        (RECwcal_DIgeom) [xshift=-0.15cm] arc [start angle=180, end angle=0, radius=.15cm] --
        (RECscireduce_DIgeom);
