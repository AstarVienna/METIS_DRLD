...
%    };
    ...
    \node (rsrf_dark)[empty]{};
    &
    \node (dark_dark) [calibproduct]{\PROD{MASTER_DARK_IFU}};
    &
...
%    \node (adi_dark)[empty]{};
    ...
    % Row *_geom
    \node (geom_geom) [statcalfile]{\PROD{IFU_DISTORTION_TABLE}};
    &
    ...
    \node (geom_rsrf) [empty]{};
    &
    \node (rsrf_rsrf) [statcalfile]{\PROD{RSRF_IFU}};
    &
    \node (dark_rsrf)[empty]{};
    &
    \node (wcal_rsrf)[empty]{};
...
%    \node (adi_rsrf)[empty]{};
    ...
    \node (dark_wcal)[empty]{};
    &
    \node (wcal_wcal) [calibproduct]{\PROD{IFU_WAVECAL}};
    &
...
%    \node (adi_std)[empty]{};
    ...
    \node (wcal_fcal)[empty]{};
    &
    \node (std_fcal)[calibproduct]{\PROD{FLUXCAL_TAB}};
    &
...
%    \node (adi_fcal)[empty]{};
    ...
    \node (std_sci1)[empty]{};
    &
    \node (sci1_sci1) [scienceproduct]{\PROD{IFU_SCI_REDUCED}};
    & &
    \node (tac_sci1)[scienceproduct]{\PROD{IFU_SCI_REDUCED_TAC}};
    &
...
%    \node (adi_sci1)[empty]{};
    ...
    \node (std_sci2)[empty]{};
    &
    \node (sci1_sci2)[scienceproduct]{\PROD{IFU_SCI_COMBINED}};
    & &
    \node (tac_sci2)[scienceproduct]{\PROD{IFU_SCI_COMBINED_TAC}};
    &
    \node (sci2_sci2) [empty]{};
%    &
%    \node (adi_sci2) [connection]{};
    ...
    \node (tac_adi)[empty]{};
    &
    \node (sci2_adi)[scienceproduct]{\PROD{IFU_SCI_COADD}};
%    &
