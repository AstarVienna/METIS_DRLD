...
%    };
    ...
    \node (geom_persistence)[empty]{}; &
    \node (rsrf_persistence)[empty]{}; &
    \node (dark_persistence)[calibproduct]{\hyperref[dataitem:ifu_std_bkg]{\PROD{LM_STD_BKG}}}; &
    \node (wcal_persistence)[empty]{}; &
    \node (std_persistence)[empty]{}; &
    \node (sci1_persistence)[empty]{}; &
    \node (tac_persistence)[empty]{}; &
    \node (sci2_persistence)[empty]{}; &
    \node (adi_persistence)[empty]{}; \\
