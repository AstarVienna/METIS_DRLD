...
\begin{tikzpicture}[on grid=false, node distance=0.8cm]
  ...
  \matrix (recipes) [column sep=1mm, row sep=1cm]{
    ...
    \node[above] (RECstdreduce_raw){%
      \recipebox{\hyperref[dataitem:ifu_wave_raw]{\RAW{IFU_STD_RAW}}}{\hyperref[rec:metis_ifu_basic_reduce]{\REC{metis_ifu_reduce}}}
    };
    &
    \node[above] (RECscireduce_raw){%
      \recipebox{\hyperref[dataitem:ifu_wave_raw]{\RAW{IFU_SCI_RAW}}}{\hyperref[rec:metis_ifu_basic_reduce]{\REC{metis_ifu_reduce}}}
    };
    &
...
%    \node (adi_DIwcal)[empty]{};
    ...
    \node (RECscireduce_DIscireducedcube)[scienceproduct,below=1.25cm] {\hyperref[dataitem:ifu_sci_basic]{\EXTCALIB{IFU_SCI_REDUCED_CUBE}}};
    \node (RECscireduce_DIsciobject1d)[scienceproduct,below=2.0cm] {\hyperref[dataitem:ifu_sci_basic]{\EXTCALIB{IFU_SCI_OBJECT_1D}}};
...
%    \node (RECtac_DIsci1)[scienceproduct] {\hyperref[dataitem:ifu_sci_reduced_tac]{\PROD{IFU_SCI_CALIBRATED_TAC}}};
    ...
    &
    \node (RECsci1_DIsci1)[scienceproduct] {\hyperref[dataitem:ifu_sci_reduced]{\PROD{IFU_SCI_CUBE_CALIBRATED}}};
    &
