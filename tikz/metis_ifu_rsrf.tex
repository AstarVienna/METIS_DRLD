...
\begin{tikzpicture}
  ...
  \node (input) [below=0.75cm of start-m, input]{%
    \textsl{N} \hyperref[dataitem:ifu_rsrf_raw]{\RAW{IFU_RSRF_RAW}}
  };
...
%  \draw (persistence) -- (connectpersistence);
  ...
  \node (darkin) [left=of connect_dark, calproduct]{%
    \hyperref[dataitem:master_dark_ifu]{\STATCALIB{MASTER_DARK_IFU}}
  };
  ...
  \node (bpmin) [left=of connect_bp, calproduct]{%
    \hyperref[dataitem:badpix_map_ifu]{\STATCALIB{BADPIX_MAP_IFU}}
  };
  ...
  \node (wavecal) [left=of connect_wavecal, calproduct]{%
    \hyperref[dataitem:ifu_wavecal]{\STATCALIB{IFU_WAVECAL}}
  };
  ...
  \node (rsrf) [right=of connectrsrf, calproduct]{%
    \hyperref[dataitem:rsrf_ifu]{\STATCALIB{RSRF_IFU}}
  };
  ...
  \node (flat) [right=of connectflat, calproduct]{%
    \hyperref[dataitem:master_flat_ifu]{\STATCALIB{MASTER_FLAT_IFU}}
  };
