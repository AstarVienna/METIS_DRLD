...
%  };
  ...
  \node (step2) [below=3.cm of input, redstep]{locate images};
...
%  \draw [connection_arrow] (bpmin) -- (step2);
  ...
  \node (connect_dark) [connection] at
    ($(input)!0.45!(step2)$) {};
  \node (master_dark) [left=of connect_dark, calproduct]{\STATCALIB{MASTER_DARK_IFU}};
  \draw[connection_arrow](master_dark)--(connect_dark);
  ...
  %% Frame around recipe
  \draw [frame] ($(input)!0.25!(step2) - (3.,0)$)
  rectangle ($(step3)!0.275!(stop-t) + (2.75,0)$);
  \node [framecolor, anchor=north west] at
  ($(input)!0.25!(step2) - (3., 0)$) {%
