...
%  };
  ...
  \node (step2) [below=4.cm of input, redstep]{locate images};
...
%  \draw [connection_arrow] (bpmin) -- (step2);
  ...
  %% Frame around recipe
  \draw [frame] ($(input)!0.1!(step2) - (3.,0)$)
