...
\begin{tikzpicture}
  ...
  \node (input) [below=0.75cm of start-m, input] {%
    \textsl{N} \hyperref[dataitem:lm_image_sci_raw]{\RAW{LM_IMAGE_SCI_RAW}} \\
% TODO: This recipe is also for STD data
%     \textsl{N} \hyperref[dataitem:lm_std_raw]{\RAW{LM_STD_RAW}} \\
    \textsl{M} \hyperref[dataitem:ifu_sky_raw]{\RAW{IFU_SKY_RAW}}};
  ...
  \node (linearity) [left=of connect_linearity, external]{%
    \hyperref[dataitem:linearity_det]{\EXTCALIB{LINEARITY_det}}};
...
%   \draw (params) -- (connectparams);
  ...
  \node (flatin) [left=of connect_masterflat, calproduct]{%
    \hyperref[dataitem:master_img_flat_lamp_lm]{\STATCALIB{MASTER_IMG_FLAT_LAMP_LM}}\\
    or \hyperref[dataitem:master_img_flat_twilight_lm]{\STATCALIB{MASTER_IMG_FLAT_TWILIGHT_LM}}};
  ...
  \node (scired) [right=of connect_scired, external]{%
    \hyperref[dataitem:lm_sci_basic_reduced]{\PROD{LM_SCI_BASIC_REDUCED}}};
