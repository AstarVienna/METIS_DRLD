...
\begin{tikzpicture}[on grid=false,node distance=0.8cm]
  ...
  \matrix (recipes) [column sep=5mm, row sep=1cm]{
    ...
    % Row *_lin
    \node (lin_lin)[statcalfile]{LINEARITY\_GEO}; &
    \node (pers_lin)[empty]{}; &
    \node (dist_lin)[empty]{}; &
    \node (dark_lin)[empty]{}; &
    ...
    \node (pers_dark)[empty]{}; &
    \node (dist_dark)[empty]{}; &
    \node (dark_dark)[qcproduct]{MASTER\_DARK\_GEO}; &
    ...
    \node (dist_flat) [empty]{}; &
    \node (dark_flat)[empty]{}; &
    \node (flat_flat) [qcproduct]{MASTER\_FLAT\_GEO}; &
    ...
    \node (chop_chopstd)[calibproduct]{STD\_BKG\_SUB}; &
    ...
    \node (chop_chopsci)[scienceproduct]{SCI\_BKG\_SUB}; &
    ...
    \node (flat_cal)[empty]{}; &
    \node (chop_cal)[empty]{}; &
    \node (std_cal)[calibproduct]{FLUXCAL\_TAB}; &
    ...
    \node (lin_dist)[empty]{}; &
    \node (pers_dist)[empty]{}; &
    \node (dist_dist)[statcalfile]{DISTORTION\_TAB}; &
    \node (dark_dist)[empty]{}; &
    \node (flat_dist)[empty]{}; &
    \node (chop_dist)[empty]{}; &
    \node (std_dist)[empty]{}; &
    ...
    \node (chop_rest)[empty] {}; &
    \node (std_rest)[empty]{}; &
    \node (cal_rest) [scienceproduct]{N\_SCI\_CALIBRATED}; &
    ...
    \node (std_prod)[empty]{}; &
    \node (cal_prod) [empty]{}; &
    \node (rest_prod) [scienceproduct]{N\_SCI\_RESTORED};
    \\
    & & & & & \\
  };    % end matrix
