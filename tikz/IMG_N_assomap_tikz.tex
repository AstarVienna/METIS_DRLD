...
\begin{tikzpicture}[on grid=false,node distance=0.8cm]
  ...
  \matrix (recipes) [column sep=5mm, row sep=1cm]{
    ...
    % Row *_lin
    \node (lin_lin)[statcalfile]{\NEWSTATCALIB{LINEARITY\_GEO}}; &
    \node (pers_lin)[empty]{}; &
    \node (dist_lin)[empty]{}; &
    \node (dark_lin)[empty]{}; &
    ...
    \node (pers_dark)[empty]{}; &
    \node (dist_dark)[empty]{}; &
    \node (dark_dark)[qcproduct]{\NEWQC{MASTER_DARK_GEO}}; &
    ...
    \node (dist_flat) [empty]{}; &
    \node (dark_flat)[empty]{}; &
    \node (flat_flat) [qcproduct]{\NEWQC{MASTER_FLAT_GEO}}; &
    ...
    \node (chop_chopstd)[calibproduct]{\NEWPROD{STD_BKG_SUB}}; &
    ...
    \node (chop_chopsci)[scienceproduct]{\NEWPROD{SCI_BKG_SUB}}; &
