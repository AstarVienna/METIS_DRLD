...
\begin{tikzpicture}[on grid=false,node distance=0.8cm]
  ...
  \matrix (recipes) [column sep=5mm, row sep=1cm]{
    ...
    &
    \node[above] (dist_raw){%
      \recipebox{DISTORTION}{n\_img\_distortion}
    };
    &
    \node[above] (dark_raw) {%
    ...
    &
    \node[above] (flat_raw){%
      \recipebox{FLAT}{n\_img\_flat}
    };
    &
    \node[above] (chop_raw){%
      \recipebox{CHOPNOD}{n\_img\_chopnod}
    };
    &
    \node[above] (std_raw){%
      \recipebox{PHOT STD}{n\_img\_std\_process}
    };
    &
    \node[above] (cal_raw){%
      \recipebox{SCIENCE}{n\_img\_sci\_calibrate}
    };
    &
    \node[above] (rest_raw){%
      \recipebox{SCIENCE}{n\_img\_restore}
    };
    \\

    %%% Calibration products
    % Row *_lin
    \node (lin_lin)[statcalfile]{\hyperref[dataitem:linearity_geo]{\STATCALIB{LINEARITY\_GEO}}}; &
    \node (pers_lin)[empty]{}; &
    \node (dist_lin)[empty]{}; &
    \node (dark_lin)[empty]{}; &
    ...
    % Row persistence
    \node (lin_pers)[empty]{}; &
    \node (pers_pers)[extcalfile]{\hyperref[dataitem:persistence_map]{\STATCALIB{PERSISTENCE_MAP}}}; &
    \node (dist_pers)[empty]{}; &
    \node (dark_pers)[empty]{}; &
    ...
    \node (pers_dark)[empty]{}; &
    \node (dist_dark)[empty]{}; &
    \node (dark_dark)[qcproduct]{\hyperref[dataitem:master_dark_geo]{\QC{MASTER_DARK_GEO}}}; &
    ...
    \node (dist_flat) [empty]{}; &
    \node (dark_flat)[empty]{}; &
    \node (flat_flat) [qcproduct]{\hyperref[dataitem:master_flat_geo]{\QC{MASTER_FLAT_GEO}}}; &
    ...
    \node (chop_chopstd)[calibproduct]{\hyperref[dataitem:std_bkg_sub]{\PROD{STD_BKG_SUB}}}; &
    ...
    \node (chop_chopsci)[scienceproduct]{\hyperref[dataitem:sci_bkg_sub]{\PROD{SCI_BKG_SUB}}}; &
    ...
    \node (flat_cal)[empty]{}; &
    \node (chop_cal)[empty]{}; &
    \node (std_cal)[calibproduct]{\hyperref[dataitem:fluxcal_tab]{\PROD{FLUXCAL_TAB}}}; &
    ...
    \node (chop_rest)[empty] {}; &
    \node (std_rest)[empty]{}; &
    \node (cal_rest)[scienceproduct]{\hyperref[dataitem:n_sci_calibrated]{\PROD{N_SCI_CALIBRATED}}}; &
    ...
    \node (std_prod)[empty]{}; &
    \node (cal_prod) [empty]{}; &
    \node (rest_prod)[scienceproduct]{\hyperref[dataitem:n_sci_restored]{\PROD{N_SCI_RESTORED}}};
    \\
    & & & & & \\
  };    % end matrix
