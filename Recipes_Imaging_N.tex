...
%------------------------------------------------------------------------------------------------------------------
\subsubsection{\REC{metis_n_img_flat}: N-band imaging flatfield}
...
%%%%%%%
%------------------------------------------------------------------------------------------------------------------
\subsubsection{\REC{metis_n_img_chopnod}: N-band imaging chop-nod combination}
\label{img_n_chopnod}
...
%%%%%%%%%%%%%%%%%%%
\clearpage
\subsubsection{\REC{metis_n_img_std_process}: N-band imaging photometric standard analysis}
...
\subsubsection{\REC{metis_n_img_calibrate}: N-band imaging calibration}
...
\subsubsection{\REC{metis_n_img_restore}: N-band imaging restoration}
...
%%%%%%%%%%%%%%
\clearpage
\subsubsection{\REC{metis_n_img_distortion}: N-band imaging distortion calibration}
