...
\begin{recipedef}
  ...
  Input data:          & \hyperref[dataitem:n_flat_raw]{\RAW{N_FLAT_RAW}} \\
                       & \hyperref[dataitem:master_img_flat_n]{\PROD{MASTER_IMG_FLAT_N}} (for twilight flats)                               \\
...
%The width of the mask shall be at least 26 pixels and no larger than 32 pixels.
