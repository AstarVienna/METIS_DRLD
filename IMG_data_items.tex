...
\paragraph{\hyperref[dataitem:detlinraw]{\RAW{DETLIN_det_RAW}}}\label{dataitem:detlinraw}\label{dataitem:detlinraw2rg}\label{dataitem:detlinrawgeo}\label{dataitem:detlinrawifu}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \hyperref[dataitem:detlinraw]{\FITS{DETLIN_det_RAW}}\\[0.3cm]
...
\paragraph{\hyperref[dataitem:linearity]}{\PROD{LINEARITY_det}}\label{dataitem:linearity_det}\label{dataitem:linearity}\label{dataitem:linearity2rg}\label{dataitem:linearitylms}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
