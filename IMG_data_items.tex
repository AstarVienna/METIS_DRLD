...
\paragraph{\NEWRAW{LM_IMAGE_SCI_RAW}}\label{dataitem:lm_image_sci_raw}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWRAW{LM_IMAGE_SCI_RAW}\\[0.3cm]
...
Input for:    & \NEWREC{metis_lm_img_basic_reduce} \\
...
\paragraph{\NEWRAW{N_IMAGE_SCI_RAW}}\label{dataitem:n_image_sci_raw}

\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWRAW{N_IMAGE_SCI_RAW}\\[0.3cm]
...
Template: & \TPL{METIS_img_n_cal_standard}\\
                     ...
                     & \TPL{METIS_img_lmn_obs_AutoChopNod} \\
                     & \TPL{METIS_img_lmn_obs_GenericChopNod} \\
Input for recipe: & \NEWREC{metis_n_img_chopnod} \\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
%\paragraph{\NEWPROD{LM_RSRF_RAW}}\label{drsstructure:LM_RSRF_RAW}
...
\paragraph{\NEWRAW{LM_CHOPPERHOME_RAW}}\label{dataitem:lm_chopperhome_raw}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWRAW{LM_CHOPPERHOME_RAW}\\[0.3cm]
Description: & Raw exposure of the LM image mode.\\[0.3cm]
...
Input for:    & \NEWREC{metis_img_chophome} \\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
%\paragraph{\NEWPROD{LM_RSRF_RAW}}\label{drsstructure:LM_RSRF_RAW}
...
\paragraph{\NEWRAW{DETLIN_det_RAW}}\label{dataitem:detlin_det_raw}
An \NEWRAW{DETLIN_det_RAW} can be one of
\begin{itemize}
    \item \NEWRAW{DETLIN_2RG_RAW}
    \item \NEWRAW{DETLIN_GEO_RAW}
    \item \NEWRAW{DETLIN_IFU_RAW}
\end{itemize}

\paragraph{\NEWRAW{DETLIN_2RG_RAW}}\label{dataitem:detlin_2rg_raw}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWRAW{DETLIN_2RG_RAW}\\[0.3cm]
...
Input for recipe: & \NEWREC{metis_det_lingain}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
\end{recipedef}
\begin{datastructdef}
\textbf{Corresponding \ac{CPL} structure:}
...
\paragraph{\NEWRAW{DETLIN_GEO_RAW}}\label{dataitem:detlin_geo_raw}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWRAW{DETLIN_GEO_RAW}\\[0.3cm]
...
\paragraph{\NEWRAW{DETLIN_IFU_RAW}}\label{dataitem:detlin_ifu_raw}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWRAW{DETLIN_IFU_RAW}\\[0.3cm]
Description: & Raw data for non-linearity determination.\\[0.3cm]
\hyperref[fits:dpr.catg]{\FITS{DPR.CATG}}: & \FITS{CALIB}\\
...
\paragraph{\NEWRAW{DARK_det_RAW}}\label{dataitem:dark_det_raw}
An \NEWRAW{DARK_det_RAW} can be one of
\begin{itemize}
    \item \NEWRAW{DARK_2RG_RAW}
    \item \NEWRAW{DARK_GEO_RAW}
    \item \NEWRAW{DARK_IFU_RAW}
\end{itemize}


\paragraph{\NEWRAW{DARK_2RG_RAW}}\label{dataitem:dark_2rg_raw}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWRAW{DARK_2RG_RAW}\\[0.3cm]
...
Input for recipe: & \NEWREC{metis_det_dark}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
\end{recipedef}
\begin{datastructdef}
\textbf{Corresponding \ac{CPL} structure:}
...
\paragraph{\NEWRAW{DARK_GEO_RAW}}\label{dataitem:dark_geo_raw}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWRAW{DARK_GEO_RAW}\\[0.3cm]
Description: & Raw data for creating a master dark.\\[0.3cm]
\hyperref[fits:dpr.catg]{\FITS{DPR.CATG}}: & \FITS{CALIB}\\
\hyperref[fits:dpr.tech]{\FITS{DPR.TECH}}: & \FITS{IMAGE,N}\\
\hyperref[fits:dpr.type]{\FITS{DPR.TYPE}}: & \FITS{DARK}\\
...
\paragraph{\NEWRAW{DARK_IFU_RAW}}\label{dataitem:dark_ifu_raw}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWRAW{DARK_IFU_RAW}\\[0.3cm]
Description: & Raw data for creating a master dark.\\[0.3cm]
\hyperref[fits:dpr.catg]{\FITS{DPR.CATG}}: & \FITS{CALIB}\\
\hyperref[fits:dpr.tech]{\FITS{DPR.TECH}}: & \FITS{IFU}\\
\hyperref[fits:dpr.type]{\FITS{DPR.TYPE}}: & \FITS{DARK}\\
...
\paragraph{\NEWRAW{det_WCU_OFF_RAW}}\label{dataitem:det_wcu_off_raw}
An \NEWRAW{det_WCU_OFF_RAW} can be one of
\begin{itemize}
    \item \NEWRAW{LM_WCU_OFF_RAW}
    \item \NEWRAW{N_WCU_OFF_RAW}
    \item \NEWRAW{IFU_WCU_OFF_RAW}
\end{itemize}

\paragraph{\NEWRAW{LM_WCU_OFF_RAW}}\label{dataitem:lm_wcu_off_raw}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWRAW{LM_WCU_OFF_RAW}\\[0.3cm]
...
Input for:    & \NEWREC{metis_det_lingain} \\
...
\paragraph{\NEWRAW{N_WCU_OFF_RAW}}\label{dataitem:n_wcu_off_raw}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWRAW{N_WCU_OFF_RAW}\\[0.3cm]
Description: & Raw data for dark subtraction in other recipes.\\[0.3cm]
\hyperref[fits:dpr.catg]{\FITS{DPR.CATG}}: & \FITS{CALIB}\\
\hyperref[fits:dpr.tech]{\FITS{DPR.TECH}}: & \FITS{IMAGE,N}\\
\hyperref[fits:dpr.type]{\FITS{DPR.TYPE}}: & \FITS{DARK,WCUOFF}\\
...
\paragraph{\NEWRAW{IFU_WCU_OFF_RAW}}\label{dataitem:ifu_wcu_off_raw}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWRAW{IFU_WCU_OFF_RAW}\\[0.3cm]
Description: & Raw data for dark subtraction in other recipes.\\[0.3cm]
\hyperref[fits:dpr.catg]{\FITS{DPR.CATG}}: & \FITS{CALIB}\\
\hyperref[fits:dpr.tech]{\FITS{DPR.TECH}}: & \FITS{IFU}\\
\hyperref[fits:dpr.type]{\FITS{DPR.TYPE}}: & \FITS{DARK,WCUOFF}\\
...
\paragraph{\NEWRAW{LM_FLAT_LAMP_RAW}}\label{dataitem:lm_flat_lamp_raw}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWRAW{LM_FLAT_LAMP_RAW}\\[0.3cm]
...
Input for recipe: & \NEWREC{metis_lm_img_flat}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
\end{recipedef}
\begin{datastructdef}
\textbf{Corresponding \ac{CPL} structure:}
...
\paragraph{\NEWRAW{LM_FLAT_TWILIGHT_RAW}}\label{dataitem:lm_flat_twilight_raw}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWRAW{LM_FLAT_TWILIGHT_RAW}\\[0.3cm]
Description: & Flat field image taken with lamp or sky. \\[0.3cm]
\hyperref[fits:dpr.catg]{\FITS{DPR.CATG}}: & \FITS{CALIB}\\
\hyperref[fits:dpr.tech]{\FITS{DPR.TECH}}: & \FITS{IMAGE,LM} \\
...
\paragraph{\NEWRAW{N_FLAT_LAMP_RAW}}\label{dataitem:n_flat_lamp_raw}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWRAW{N_FLAT_LAMP_RAW}\\[0.3cm]
...
Input for recipe: & \NEWREC{metis_n_img_flat}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
\end{recipedef}
\begin{datastructdef}
\textbf{Corresponding \ac{CPL} structure:}
...
\paragraph{\NEWRAW{N_FLAT_TWILIGHT_RAW}}\label{dataitem:n_flat_twilight_raw}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWRAW{N_FLAT_TWILIGHT_RAW}\\[0.3cm]
...
% #####################################################################################
\paragraph{\NEWRAW{LM_DISTORTION_RAW}}\label{dataitem:lm_distortion_raw}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWRAW{LM_DISTORTION_RAW}\\[0.3cm]
...
Input for recipe: & \NEWREC{metis_lm_img_distortion}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
%\paragraph{\NEWPROD{LM_RSRF_RAW}}\label{drsstructure:LM_RSRF_RAW}
...
% #####################################################################################
\paragraph{\NEWRAW{N_DISTORTION_RAW}}\label{dataitem:n_distortion_raw}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWRAW{N_DISTORTION_RAW}\\[0.3cm]
Description: & Images of grid mask in WCU-FP2 or CFO-FP2.\\[0.3cm]
\hyperref[fits:dpr.catg]{\FITS{DPR.CATG}}: & \FITS{CALIB}\\
\hyperref[fits:dpr.tech]{\FITS{DPR.TECH}}: & \FITS{IMAGE,N} \\
\hyperref[fits:dpr.type]{\FITS{DPR.TYPE}}: & \FITS{DISTORTION} \\[0.3cm]
...
Input for recipe: & \NEWREC{metis_n_img_distortion}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
%\paragraph{\NEWPROD{LM_RSRF_RAW}}\label{drsstructure:LM_RSRF_RAW}
...
\paragraph{\NEWRAW{LM_PUPIL_RAW}}\label{dataitem:lm_pupil_raw}

\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWRAW{LM_PUPIL_RAW}\\[0.3cm]
...
Input for recipe: & \NEWREC{metis_pupil_imaging}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
%\paragraph{\NEWPROD{LM_RSRF_RAW}}\label{drsstructure:LM_RSRF_RAW}
...
\paragraph{\NEWRAW{N_PUPIL_RAW}}\label{dataitem:n_pupil_raw}

\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWRAW{N_PUPIL_RAW}\\[0.3cm]
...
\paragraph{\NEWPROD{MASTER_IMG_FLAT_LAMP_LM}}\label{dataitem:master_img_flat_lamp_lm}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{MASTER_IMG_FLAT_LAMP_LM}\\[0.3cm]
Description: & Master flat frame for LM image data \\[0.3cm]
\hyperref[fits:pro.catg]{\FITS{PRO.CATG}}: & \FITS{MASTER_IMG_FLAT_LAMP_LM} \\[0.3cm]
...
Created by: & \NEWREC{metis_lm_img_flat} \\
Input for:    & \NEWREC{metis_lm_img_basic_reduce} \\
              & \NEWREC{metis_img_chophome} \\
              & \NEWREC{metis_lm_adc_slitloss} \\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
...
\paragraph{\NEWPROD{MASTER_IMG_FLAT_TWILIGHT_LM}}\label{dataitem:master_img_flat_twilight_lm}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{MASTER_IMG_FLAT_TWILIGHT_LM}\\[0.3cm]
Description: & Master flat frame for LM image data \\[0.3cm]
\hyperref[fits:pro.catg]{\FITS{PRO.CATG}}: & \FITS{MASTER_IMG_FLAT_TWILIGHT_LM} \\[0.3cm]
OCA keywords: & \hyperref[fits:pro.catg]{\FITS{PRO.CATG}}\\
...
\paragraph{\NEWPROD{MASTER_IMG_FLAT_LAMP_N}}\label{dataitem:master_img_flat_lamp_n}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{MASTER_IMG_FLAT_LAMP_N}\\[0.3cm]
Description: & Master flat frame for N image data \\[0.3cm]
\hyperref[fits:pro.catg]{\FITS{PRO.CATG}}: & \FITS{MASTER_IMG_FLAT_LAMP_N} \\[0.3cm]
OCA keywords: & \hyperref[fits:pro.catg]{\FITS{PRO.CATG}}\\
\FITS{DO.CATG}: & \FITS{MASTER_IMG_FLAT_LAMP_N}\\[0.3cm]
%Template: & \TPL{METIS_n_img_flat}\\
Created by: & \NEWREC{metis_n_img_flat} \\
Input for:    & \NEWREC{metis_n_img_chopnod} \\
              & \NEWREC{metis_n_adc_slitloss} \\
...
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
%\paragraph{\NEWPROD{N_MASTER_FLAT}}\label{drsstructure:N_MASTER_FLAT}
\begin{datastructdef}
\textbf{Corresponding \ac{CPL} structure:}
\begin{enumerate}
    \item \texttt{cpl\_propertylist * keywords: Primary keywords (\hyperref[fits:dpr.catg]{\FITS{DPR.CATG}},  \hyperref[fits:dpr.tech]{\FITS{DPR.TECH}},  \hyperref[fits:dpr.type]{\FITS{DPR.TYPE}},  \hyperref[fits:ins.opti3.name]{\FITS{INS.OPTI3.NAME}},  \hyperref[fits:ins.opti9.name]{\FITS{INS.OPTI9.NAME}},  \hyperref[fits:ins.opti10.name]{\FITS{INS.OPTI10.NAME}})}
...
\paragraph{\NEWPROD{MASTER_IMG_FLAT_TWILIGHT_N}}\label{dataitem:master_img_flat_twilight_n}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{MASTER_IMG_FLAT_TWILIGHT_N}\\[0.3cm]
Description: & Master flat frame for N image data \\[0.3cm]
\hyperref[fits:pro.catg]{\FITS{PRO.CATG}}: & \FITS{MASTER_IMG_FLAT_TWILIGHT_N} \\[0.3cm]
OCA keywords: & \hyperref[fits:pro.catg]{\FITS{PRO.CATG}}\\
...
\paragraph{\NEWPROD{LM_STD_BASIC_REDUCED}}\label{dataitem:lm_std_basic_reduced}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{LM_STD_BASIC_REDUCED}\\[0.3cm]
...
Produced by recipe: & \NEWREC{metis_lm_img_basic_reduce}\\
Input for recipe: & \NEWREC{metis_lm_img_background} \\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
\end{recipedef}
\begin{datastructdef}
\textbf{Corresponding \ac{CPL} structure:}
...
\paragraph{\NEWPROD{LM_SCI_BKG}}\label{dataitem:lm_sci_bkg}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{LM_SCI_BKG}\\[0.3cm]
...
Produced by recipe: & \NEWREC{metis_lm_img_background}\\
%Input for recipe: & \NEWREC{metis_lm_img_calibrate} \\
...
\paragraph{\NEWPROD{LM_STD_BKG}}\label{dataitem:lm_std_bkg}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{LM_STD_BKG}\\[0.3cm]
...
Created by: & \NEWREC{metis_lm_img_background}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
%\paragraph{\NEWPROD{LM_RSRF_RAW}}\label{drsstructure:LM_RSRF_RAW}
...
\paragraph{\NEWPROD{LM_SCI_BKG_SUBTRACTED}}\label{dataitem:lm_sci_bkg_subtracted}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{LM_SCI_BKG_SUBTRACTED}\\[0.3cm]
...
%             & \TPL{METIS_img_lm_*_obs_*}       \\
Created by: & \NEWREC{metis_lm_img_background}\\
Input for:    & \NEWREC{metis_lm_img_calibrate} \\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
%\paragraph{\NEWPROD{LM_RSRF_RAW}}\label{drsstructure:LM_RSRF_RAW}
...
\paragraph{\NEWPROD{LM_STD_BKG_SUBTRACTED}}\label{dataitem:lm_std_bkg_subtracted}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{LM_STD_BKG_SUBTRACTED}\\[0.3cm]
...
Input for:    & \NEWREC{metis_lm_img_std_process} \\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
%\paragraph{\NEWPROD{LM_RSRF_RAW}}\label{drsstructure:LM_RSRF_RAW}
...
\paragraph{\NEWPROD{N_STD_BKG_SUBTRACTED}}\label{dataitem:n_std_bkg_subtracted}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{N_STD_BKG_SUBTRACTED}\\[0.3cm]
...
Produced by recipe: & \NEWREC{metis_n_img_chopnod} \\
Input for recipe: & \NEWREC{metis_n_img_std_process}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:nrsrfraw}\\
\end{recipedef}
%\paragraph{\NEWPROD{N_RSRF_RAW}}\label{drsstructure:N_RSRF_RAW}
\begin{datastructdef}
\textbf{Corresponding \ac{CPL} structure:}
\begin{enumerate}
    \item \texttt{cpl\_propertylist * keywords: Primary keywords (\hyperref[fits:pro.catg]{\FITS{PRO.CATG}},  \hyperref[fits:ins.opti3.name]{\FITS{INS.OPTI3.NAME}},  \hyperref[fits:ins.opti9.name]{\FITS{INS.OPTI9.NAME}},  \hyperref[fits:ins.opti10.name]{\FITS{INS.OPTI10.NAME}})}
...
\paragraph{\NEWPROD{LM_STD_OBJECT_CAT}}\label{dataitem:lm_std_object_cat}
\begin{recipedef}
\textbf{\ac{FITS} TABLE file structure:}\\
Name: & \NEWPROD{LM_STD_OBJECT_CAT}\\[0.3cm]
...
\paragraph{\NEWPROD{LM_SCI_BASIC_REDUCED}}\label{dataitem:lm_sci_basic_reduced}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{LM_SCI_BASIC_REDUCED}\\[0.3cm]
...
Input for:    & \NEWREC{metis_lm_img_background} \\
              & \NEWREC{metis_img_adi_cgrph} \\
...
\paragraph{\NEWPROD{N_SCI_BKG_SUBTRACTED}}\label{dataitem:n_sci_bkg_subtracted}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{N_SCI_BKG_SUBTRACTED}\\[0.3cm]
...
%             & \TPL{METIS_img_n_*_obs_*}       \\
Produced by recipe: & \NEWREC{metis_n_img_chopnod} \\
Input for:    & \NEWREC{metis_n_img_calibrate} \\
              & \NEWREC{metis_img_adi_cgrph} \\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
...
\paragraph{\NEWPROD{LM_SCI_OBJECT_CAT}}\label{dataitem:lm_sci_object_cat}
\begin{recipedef}
\textbf{\ac{FITS} TABLE file structure:}\\
Name: & \NEWPROD{LM_SCI_OBJECT_CAT}\\[0.3cm]
...
\paragraph{\NEWPROD{LM_SCI_CALIBRATED}}\label{dataitem:lm_sci_calibrated}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{LM_SCI_CALIBRATED}\\[0.3cm]
...
% Template: & \TPL{METIS_img_lm_cal_standard}\\
%             & \TPL{METIS_img_lm_*_obs_*}       \\
Created by:   & \NEWREC{metis_lm_img_calibrate} \\
Input for:    & \NEWREC{metis_lm_img_sci_postprocess} \\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
\paragraph{\NEWPROD{LM_SCI_CALIBRATED}}\label{drsstructure:LM_SCI_CALIBRATED}
\begin{datastructdef}
\textbf{Corresponding \ac{CPL} structure:}
\begin{enumerate}
    \item \texttt{cpl\_propertylist * keywords: Primary keywords (\hyperref[fits:dpr.catg]{\FITS{DPR.CATG}},  \hyperref[fits:dpr.tech]{\FITS{DPR.TECH}},  \hyperref[fits:dpr.type]{\FITS{DPR.TYPE}},  \hyperref[fits:ins.opti3.name]{\FITS{INS.OPTI3.NAME}},  \hyperref[fits:ins.opti9.name]{\FITS{INS.OPTI9.NAME}},  \hyperref[fits:ins.opti10.name]{\FITS{INS.OPTI10.NAME}})}
...
\paragraph{\NEWPROD{N_SCI_CALIBRATED}}\label{dataitem:n_sci_calibrated}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{N_SCI_CALIBRATED}\\[0.3cm]
...
% Template: & \TPL{METIS_img_n_cal_standard}\\
%             & \TPL{METIS_img_n_*_obs_*}       \\
Created by:   & \NEWREC{metis_n_img_calibrate} \\
Input for:    & \NEWREC{metis_n_img_restore} \\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:nrsrfraw}\\
\end{recipedef}
\paragraph{\NEWPROD{N_SCI_CALIBRATED}}\label{drsstructure:N_SCI_CALIBRATED}
\begin{datastructdef}
\textbf{Corresponding \ac{CPL} structure:}
\begin{enumerate}
    \item \texttt{cpl\_propertylist * keywords: Primary keywords (\hyperref[fits:dpr.catg]{\FITS{DPR.CATG}},  \hyperref[fits:dpr.tech]{\FITS{DPR.TECH}},  \hyperref[fits:dpr.type]{\FITS{DPR.TYPE}},  \hyperref[fits:ins.opti3.name]{\FITS{INS.OPTI3.NAME}},  \hyperref[fits:ins.opti9.name]{\FITS{INS.OPTI9.NAME}},  \hyperref[fits:ins.opti10.name]{\FITS{INS.OPTI10.NAME}})}
...
\paragraph{\NEWPROD{LM_SCI_COADD}}\label{dataitem:lm_sci_coadd}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{LM_SCI_COADD}\\[0.3cm]
...
Input for recipe: & None \\
Produced by recipe: & \NEWREC{metis_lm_img_sci_postprocess}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
\end{recipedef}
\begin{datastructdef}
\textbf{Corresponding \ac{CPL} structure:}
...
\paragraph{\NEWPROD{N_SCI_RESTORED}}\label{dataitem:n_sci_restored}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{N_SCI_RESTORED}\\[0.3cm]
...
% Template: & \TPL{METIS_img_n_cal_standard}\\
%             & \TPL{METIS_img_n_*_obs_*}       \\
Created by:   & \NEWREC{metis_n_img_restore} \\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:nrsrfraw}\\
\end{recipedef}
\paragraph{\NEWPROD{N_SCI_RESTORED}}\label{drsstructure:N_SCI_RESTORED}
\begin{datastructdef}
\textbf{Corresponding \ac{CPL} structure:}
\begin{enumerate}
    \item \texttt{cpl\_propertylist * keywords: Primary keywords (\hyperref[fits:dpr.catg]{\FITS{DPR.CATG}},  \hyperref[fits:dpr.tech]{\FITS{DPR.TECH}},  \hyperref[fits:dpr.type]{\FITS{DPR.TYPE}},  \hyperref[fits:ins.opti3.name]{\FITS{INS.OPTI3.NAME}},  \hyperref[fits:ins.opti9.name]{\FITS{INS.OPTI9.NAME}},  \hyperref[fits:ins.opti10.name]{\FITS{INS.OPTI10.NAME}})}
...
\paragraph{\NEWPROD{det_DIST_REDUCED}}\label{dataitem:det_dist_reduced}
Depending on context, a \NEWPROD{det_DIST_REDUCED} can refer to either a
\begin{enumerate}
\item \NEWPROD{N_DIST_REDUCED}
\item \NEWPROD{LM_DIST_REDUCED}
% \item \NEWPROD{IFU_DIST_REDUCED}
\end{enumerate}


\paragraph{\NEWPROD{LM_DIST_REDUCED}}\label{dataitem:lm_dist_reduced}
\begin{recipedef}
\textbf{\ac{FITS} TABLE file structure:}\\
Name: & \NEWPROD{LM_DIST_REDUCED}\\[0.3cm]
...
%Template: & \TPL{METIS_img_lm_cal_distortion}\\
Created by: & \NEWREC{metis_lm_img_distortion}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:nrsrfraw}\\
\end{recipedef}
\paragraph{\NEWPROD{LM_DIST_REDUCED}}\label{drsstructure:LM_DIST_REDUCED}
\begin{datastructdef}
\textbf{Corresponding \ac{CPL} structure:}
\begin{enumerate}
    \item \texttt{cpl\_propertylist * keywords: Primary keywords (\hyperref[fits:dpr.catg]{\FITS{DPR.CATG}},  \hyperref[fits:dpr.tech]{\FITS{DPR.TECH}},  \hyperref[fits:dpr.type]{\FITS{DPR.TYPE}},  \hyperref[fits:ins.opti3.name]{\FITS{INS.OPTI3.NAME}},  \hyperref[fits:ins.opti9.name]{\FITS{INS.OPTI9.NAME}},  \hyperref[fits:ins.opti10.name]{\FITS{INS.OPTI10.NAME}})}
...
\paragraph{\NEWPROD{N_DIST_REDUCED}}\label{dataitem:n_dist_reduced}

\begin{recipedef}
\textbf{\ac{FITS} TABLE file structure:}\\
Name: & \NEWPROD{N_DIST_REDUCED}\\[0.3cm]
Description: & Table of polynomial coefficients for distortion correction\\[0.3cm]
\hyperref[fits:pro.catg]{\FITS{PRO.CATG}}: & \FITS{N_DIST_REDUCED} \\[0.3cm]
OCA keywords: & \hyperref[fits:pro.catg]{\FITS{PRO.CATG}}\\
\FITS{DO.CATG}: & \FITS{N_DIST_REDUCED}\\[0.3cm]
%Template: & \TPL{METIS_img_n_cal_distortion}\\
Created by: & \NEWREC{metis_n_img_distortion}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:nrsrfraw}\\
\end{recipedef}
\paragraph{\NEWPROD{N_DIST_REDUCED}}\label{drsstructure:N_DIST_REDUCED}
\begin{datastructdef}
\textbf{Corresponding \ac{CPL} structure:}
\begin{enumerate}
    \item \texttt{cpl\_propertylist * keywords: Primary keywords (\hyperref[fits:dpr.catg]{\FITS{DPR.CATG}},  \hyperref[fits:dpr.tech]{\FITS{DPR.TECH}},  \hyperref[fits:dpr.type]{\FITS{DPR.TYPE}},  \hyperref[fits:ins.opti3.name]{\FITS{INS.OPTI3.NAME}},  \hyperref[fits:ins.opti9.name]{\FITS{INS.OPTI9.NAME}},  \hyperref[fits:ins.opti10.name]{\FITS{INS.OPTI10.NAME}})}
...
%\clearpage
\paragraph{\NEWPROD{LM_PUPIL_REDUCED}}\label{dataitem:lm_pupil_reduced}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{LM_PUPIL_REDUCED}\\[0.3cm]
...
Input for recipe: & None \\
Produced by recipe: & \NEWREC{metis_pupil_imaging}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
\end{recipedef}
\begin{datastructdef}
\textbf{Corresponding \ac{CPL} structure:}
...
%\clearpage
\paragraph{\NEWPROD{N_PUPIL_REDUCED}}\label{dataitem:n_pupil_reduced}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{N_PUPIL_REDUCED}\\[0.3cm]
...
\paragraph{\NEWPROD{LM_STD_COMBINED}}\label{dataitem:lm_std_combined}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{LM_STD_COMBINED}\\[0.3cm]
...
Input for recipe: & None \\
Produced by recipe: & \NEWREC{metis_lm_img_std_process}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
\end{recipedef}
\begin{datastructdef}
\textbf{Corresponding \ac{CPL} structure:}
