...
\paragraph{\hyperref[dataitem:linearity_det]{\PROD{LINEARITY_det}}}\label{dataitem:linearity_det}\label{dataitem:linearity}\label{dataitem:linearity_lm}\label{dataitem:linearity_ifu}\label{dataitem:linearity_n}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
