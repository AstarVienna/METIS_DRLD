...
https://www.eso.org/sci/software/pycpl/                       & Gain is determined as the slope of variance against mean (\hyperref[drl:metis_derive_gain]{\CODE{metis_derive_gain}}) \\
  ...
  QC1 parameters:      & \hyperref[qc:lingainmean]{\QC{QC LIN GAIN MEAN}}                                    \\
                       & \hyperref[qc:lingainrms]{\QC{QC LIN GAIN RMS}}                                      \\
...
\begin{recipedef}
  ...
  Algorithm:           & Group files by detector and \texttt{DIT}, based on header keywords           \\
                       & Call function \REC{metis_determine_dark} for each set of files\\
                       & Compute median or average of input frames to improve statistics.            \\  % separate routine, or part of determine dark
                       & call \REC{metis_update_dark_mask} to flag deviant pixels \\
