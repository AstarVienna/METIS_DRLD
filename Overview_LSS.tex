...
\begin{table}
  ...
  \begin{center}
    ...
    \TPL{STD} & \CODE{DPR.CATG==CALIB} & \hyperref[rec:metis_lm_lss_std]{\REC{metis_LM_lss_std}}& Object name (\ac{STD} star) & \hyperref[dataitem:persistence_map]{\EXTCALIB{PERSISTENCE_MAP}} & Instrumental\\
      & \CODE{DPR.TYPE==FLUX,STD}   &			   & Exposure time &  & response function\\
    		& \CODE{DPR.TECH==SPECTRUM}  &			&	Grism	&	\hyperref[dataitem:gain_map_2rg]{\PROD{GAIN_MAP_2RG}} & Transmission (optionally)\\
