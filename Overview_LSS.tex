...
%    \TPL{SCIENCE} & \CODE{DPR.CATG==SCIENCE} & \REC{metis_LM_lss_sci} & Object name & \EXTCALIB{PERSISTENCE_MAP}  & Science grade spectrum\\
...
%    \hline
%         	& \CODE{DPR.CATG==CALIB} & \hyperref[rec:metis_n_lss_trace]{\REC*{metis_N_lss_trace} }& Exposure time	& 	\EXTCALIB{PERSISTENCE_MAP} & Order location\\
