...
\begin{table}
  ...
  \begin{center}
    ...
    \hline
    \TPL{STD} & \CODE{DPR.CATG==CALIB} & \hyperref[rec:lsslmstd]{\REC{metis_LM_lss_std}}& Object name (Flux STD) & \hyperref[dataitem:gain_map_lm]{\PROD{GAIN_MAP_LM}} & Instrumental\\
