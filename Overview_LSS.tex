...
\begin{table}
  ...
  \begin{center}
    ...
    \hline
    		...
    		& \CODE{PRO.CATG==TBD}   &  &  & & \\
    \hline
            & \CODE{DPR.CATG==SCIENCE} &  \hyperref[rec:LMLSSmfcorrect]{\REC{metis_LM_lss_mf_correct}} & Object name & synthetic Transmission & Absorption corrected\\
...
\begin{table}
  ...
  \begin{center}
    ...
    data & Keywords	 & Processing steps	&		&	  &	\\
    \hline
    Science grade spectrum & \CODE{DPR.CATG==SCIENCE} & \hyperref[rec:NLSSmfmodel]{\REC{metis_N_lss_mf_model}} & Object name & \hyperref[dataitem:lsf_kernel]{\STATCALIB{LSF_KERNEL}}	 & Best-fit \\
