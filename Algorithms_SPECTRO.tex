...
For the time being we assume no significant wavelength-dependent slit-losses e.g. by different performance of the \ac{AO} in the science and the calibrator observations, which might affect the accuracy of the absolute flux calibration. \ac{RMS} \\
