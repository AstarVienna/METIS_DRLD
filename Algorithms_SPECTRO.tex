...
One of the most critical steps in the framework of \texttt{molecfit} is the fit of the \ac{LSF}. In order to get a first estimate we simulated \ac{LSS} observations of a point source with a constant (i.e. flat) spectrum with ScopeSIM\footnote{\url{https://scopesim.readthedocs.io/en/stable/}\newline\url{https://github.com/AstarVienna/ScopeSim}} in a way to purely get spectra with an unaffected \ac{LSF}. The extracted, background-removed 1d-spectra were used as input for \texttt{molecfit v1.5.9} (see Fig.~\ref{Fig:lss_sim}). 
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.9\textwidth]{figures/LSS_CrtAlg_files/LSS_sim_spectra.pdf}
    \caption[Simulated spectra of a flat source with telluric absorptions]{%
        Simulated 1D LMN-Band spectra of a flat source with telluric absorptions. The yellow shaded areas show the fitting regions of the incoroprated molecules}
  \label{Fig:lss_sim}
\end{figure}
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.9\textwidth]{figures/LSS_CrtAlg_files/LSS_mf_results.pdf}
    \caption[Simulated spectra of a flat source with telluric absorptions]{%
        Simulated 1D LMN-Band spectra of a flat source with telluric absorptions. The yellow shaded areas show the fitting regions of the incoroprated molecules}
  \label{Fig:lss_sim}
\end{figure}
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.9\textwidth]{figures/LSS_CrtAlg_files/LSS_mf_details.pdf}
    \caption[Simulated spectra of a flat source with telluric absorptions]{%
        Simulated 1D LMN-Band spectra of a flat source with telluric absorptions. The yellow shaded areas show the fitting regions of the incoroprated molecules}
  \label{Fig:lss_sim}
\end{figure}
