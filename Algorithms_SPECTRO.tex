...
\end{itemize}
As mentioned above, \textit{molecfit-on-science} will be the default method. It is therefore the users sole responsibility to decide whether a telluric \ac{STD} is required/desired. However, the selection of the \ac{STD} should not be arbitrary, but only possible from a provided catalogue.\\
