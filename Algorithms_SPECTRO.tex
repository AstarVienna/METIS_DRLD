...
\begin{figure}[ht]
  ...
  \includegraphics[width=1.0\textwidth]{figures/LSS_CrtAlg_files/LSS_sim_spectra.pdf}
    \caption[Simulated spectra of a flat source with telluric absorptions]{%
        Simulated 1D LMN-Band spectra of a flat source with telluric absorptions. The yellow shaded areas show the fitting regions of the incorporated molecules (M-band: H$_2$O and CO$_2$ between $[4.82, 4.92]\mu$m and $[5.0, 5.1]\mu$m; N-band: CO$_2$ between $[10.2, 10.35]\mu$m and $[10.49, 10.7]\mu$m}
  \label{Fig:lss_sim}
\end{figure}
\begin{figure}[ht]
  \centering
...
\begin{figure}[ht]
  ...
  \includegraphics[width=1.0\textwidth]{figures/LSS_CrtAlg_files/LSS_mf_results.pdf}
    \caption[Molecfit results]{%
        Fitting results with \texttt{molecfit 1.}
  \label{Fig:lss_res}
\end{figure}
