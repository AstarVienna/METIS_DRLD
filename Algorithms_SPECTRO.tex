...
\begin{figure}[ht]
  ...
  \includegraphics[width=0.9\textwidth]{figures/LSS_CrtAlg_files/LSS_sim_spectra.pdf}
    \caption[Simulated spectra of a flat source with telluric absorptions]{%
        Simulated 1D LMN-Band spectra of a flat source with telluric absorptions. The yellow shaded areas show the fitting regions of the incorprated molecules}
  \label{Fig:lss_sim}
\end{figure}
\begin{figure}[ht]
  \centering
