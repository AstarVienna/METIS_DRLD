...
We emphasize that these results are based on first attempts. The quality of the correction can most probably be improved and therefore should be seen as demonstration that in principle \texttt{moelcfit} can be considered as an option for the telluric correction. 
\begin{figure}[ht]
  \centering
