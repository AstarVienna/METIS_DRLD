...
\begin{itemize}
    ...
    \item These spectral regions are then fit by a polynomial (or alternatively a Rayleigh-Jeans approximation). The degree of the polynomial will be determined when the set of \ac{TSS} is established. 
