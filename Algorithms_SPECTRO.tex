...
\end{figure}
%------------------------------------------------------------------------------
\subsubsection{Other algorithms included in the telluric correction approach} 
\subsection{Normalisation of stellar continua}
The normalisation of spectra can be a tricky issue especially for cool stars with plenty intrinsic spectral features. A general approach is therefore not possible. However, having

Others TBD:
\begin{itemize}
    \item airmass correction: see approach in latest mf release
    \item quality control params: see approach in latest mf release
%    \item TSS spectra normalisation: TBWritten
\end{itemize}
