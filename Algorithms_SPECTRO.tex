...
\begin{equation}
    \mathcal{F}_\textrm{sci}=\mathcal{F}_{0,\textrm{cal}}*\left(\mathcal{S}_\textrm{sci}/\mathcal{S}_\textrm{cal}\right)*\left(\mathcal{T}_\textrm{skyCalcal} / T_\textrm{skyCalsci}\right)
\end{equation}
%------------------------------------------------------------------------------
