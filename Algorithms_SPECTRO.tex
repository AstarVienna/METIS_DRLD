...
\end{itemize}
\textit{Notes:}\\
The newest release\footnote{\color{red}NOT YET RELEASE, EXPECTED IN MAY 2023\color{black}} of \texttt{molecfit} will contain a routine to correct transmission spectra for airmass. This allows the usage of \ac{TSS} which are at a different airmass than the science target.\\
