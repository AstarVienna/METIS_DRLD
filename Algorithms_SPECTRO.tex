...
\begin{itemize}
    \item Modelling/fitting of atmospheric features in well defined wavelength ranges (recipes
    \item Calculation of the entire transmission curve
    \item Application of the telluric correction
\end{itemize}
