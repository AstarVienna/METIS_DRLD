...
%------------------------------------------------------------------------------
\subsubsection{Estimate for the quality of the telluric correction (QC parameters)}\label{sssec:tellcorrqc}
...
\end{itemize}
\textit{....more maybe to follow when mf is released and more info is available}
