...
Flux calibration implies

In principle, also \ac{STD} can be used in case the \ac{SNR} of the observed spectrum is sufficient enough and in case a good model is available.\\

%The recipes \hyperref[rec:metis_lm_lss_std]{\REC{metis_LM_lss_std}} and \hyperref[rec:metis_n_lss_std]{\REC{metis_N_lss_std}} will derive a transmission function by means of the \ac{STD}, which will be used for the telluric correction of the chosen flux standard star. 
