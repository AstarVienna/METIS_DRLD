...
and \FITS{DET.NDIT} combination as the science data, and some, but not all,
need to use the same filter, or the same mask, or the same grism.
...
Table~\cite{tab:fitsmatchedkeywordssummary}
