...
\item[Quality Control Level 1 (QC1):] The goal of the QC1 pipeline is
  ...
  The QC1 pipeline is run offline by ESO in Garching.
...
\item[Quality Control Level 2 (QC2):] The QC2 pipeline produces
  ...
  Science data products and QC parameters can be ingested into the ESO Science Archive, depending on the project.
