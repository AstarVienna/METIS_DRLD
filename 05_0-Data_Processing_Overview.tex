...
\begin{table}
  ...
  \begin{tabularx}{\textwidth}{lXccXccccc}
    \hline
                           & Dark / Linearity & Flat  & RSRF & Wave & Background subtraction & Telluric & Flux & Distortion & NCPA + PSF \\
    \hline\hline
    \CODE{IMG_LM}          & \yes & \yes & \no  & \no  & Dither         & \no      & \yes & \yes       & \no        \\
    \CODE{IMG_LM_(RA/C)VC} & \yes & \yes & \no  & \no  & ADI            & \no      & \yes & \yes       & \yes       & \no  \\
 %   \CODE{IMG_LM_CLC}      & \yes & \yes & \no  & \no  & ADI            & \no      & \yes & \yes       & \yes       & \no  \\
    \CODE{IMG_LM_APP}      & \yes & \yes & \no  & \no  & Dither + ADI   & \no      & \yes & \yes       & \yes       & \no  \\
    \CODE{SPEC_LM}         & \yes & \no  & \yes  & \yes & Dither along slit & \yes  & \yes & \yes       & \no       \\
    \CODE{IFU}             & \yes & \no  & \yes  & \yes & Dither         & \yes     & \yes & \yes       & \no        & \yes \\
