...
\subsubsection{{QC det cgrph SCI NEXP}}\label{qc:qc_det_cgrph_sci_nexposures}
\begin{recipedef}
...
\subsubsection{{QC det APP SCI NEXP}}\label{qc:qc_det_app_sci_nexposures}
\begin{recipedef}
...
\subsubsection{{QC IFU cgrph SCI NEXP}}\label{qc:qc_ifu_cgrph_sci_nexposures}
\begin{recipedef}
