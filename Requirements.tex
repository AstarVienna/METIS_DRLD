...
%All pipeline subsystem requirements are listed; an entry
%stating \emph{N/A} in the last column indicates that this document does not
%provide evidence to verify the requirement in question.
...
\begin{longtable}[c]{|l|l|l|}
 ...
 \textbf{Req. ID} & \textbf{Requirement Title} & \textbf{Section} \\
    \hline
		...
		\REQ{METIS-6062} & Software Assurance Requirements & \ref{sec:development_plan} \\
...
% 		\REQ{METIS-6071} & External Interfaces to METIS &  N/A \\
		...
		\REQ{METIS-6075} & Data rates & \ref{ssec:criticalifudatarate} \\
...
% 		\REQ{METIS-6092} & METIS Internal Interfaces & N/A \\
		...
		\REQ{METIS-6131} & LMS data products & \ref{rec:metis_ifu_reduce} \\
		\REQ{METIS-6265} & LMS straylight & \ref{rec:metis_ifu_reduce}  \\
% 		\REQ{METIS-6267} & Design Life & N/A \\
		\REQ{METIS-6309} & Masked regions of the LMS detectors & \ref{rec:metis_ifu_reduce} \\
