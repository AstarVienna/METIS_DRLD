...
\subsection{Wavelength calibration algorithm and distortion correction}\label{Sec:critalg_wavecal}
...
\item Since we know the wavelength range (from the optical system), a
  ...
  \STATCALIB{ATM_LINE_TAB}) is possible.
\end{itemize}
...
Images in the NQ band are taken in a sequence of chopped and nodded
...
\item Take three more exposures with the same across-slice dither
  pattern.
\end{itemize}
The pattern is visualised in Fig.~\ref{fig:lms_pattern}. In principle,
...
\begin{figure}[hb]
  \centering
  \resizebox{0.8\textwidth}{!}{\includegraphics{PSF_LMS_slices}}
  \caption[LMS dithering and rotation pattern]{%
    LMS observation pattern overlaid on a METIS SCAO PSF (by Marcus
    Feldt, MPIA). Red horizontal lines mark the LMS slices of a first
...
\begin{center}
  ...
  \begin{tabular}{|l|r|r|c|c|}
    \hline
    \multicolumn{1}{|c|}{\textbf{Observing mode}} & \multicolumn{1}{c|}{\textbf{Max.\ Data rate}} & \multicolumn{1}{c|}{\textbf{Max.\ Data volume}} & \multicolumn{1}{c|}{\textbf{Night fraction}} & \multicolumn{1}{c|}{\textbf{Exp.\ Data volume}} \\
    ...
    IMG\_NQ (burst mode)                          & 250                                     & 6.87                                      & 0.15                                         & 1.06                                      \\
    IMG\_NQ (half-cycle average)                  & 80                                      & 2.20                                      & 0.00                                         & 0.00                                      \\
    \hline
    \textbf{Spectroscopy}                         &                                         &                                           &                                              &                                           \\
    SPEC\_LM                                      & 200                                     & 5.49                                      & 0.08                                         & 0.42                                      \\
    SPEC\_NQ                                      & 250                                     & 6.87                                      & 0.08                                         & 0.53                                      \\
    LMS + IMG\_LM parallel (1)                    & 1000                                    & 27.46                                     & 0.15                                         & 4.23                                      \\
    LMS + IMG\_LM parallel (2)                    & 55                                      & 1.52                                      & 0.38                                         & 0.59                                      \\
    \hline
