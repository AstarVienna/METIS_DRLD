...
\begin{table}[ht]
  \centering
  \caption{METIS Data Rates \\ The exposures in the IMG\_N burst mode will by default be avareaged to $10\mathrm{Hz}$; the numbers given in this table for the IMG\_N burst mode assume an averaging to 44 ms, $\approx 25\mathrm{Hz}$.}\label{tab:data_rates}
