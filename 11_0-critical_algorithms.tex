...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textit{Status at FDR}: The science drivers (AGN and circumstellar disks) are compact enough to treak as point-like, using the VISIR algorithm for compact sources. Exten
        \item \textit{Prototype delivery}: None.
    \end{itemize}
...
%    grisms (\hyperref[dataitem:grism_tab]{\STATCALIB{GRISM_TAB}}).
