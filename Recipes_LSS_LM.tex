...
\subsubsection{\REC{metis_det_lingain} and \REC{metis_det_dark}: Linearity/Gain determination}
...
%------------------------------------------------------------------------------------------------------------------
\subsubsection{\REC{metis_LM_lss_rsrf}: LM-LSS Flatfielding}\label{rec:metis_lm_lss_rsrf}
...
%------------------------------------------------------------------------------------------------------------------
\subsubsection{\REC{metis_LM_lss_trace}: LM-LSS Order detection}\label{rec:metis_lm_lss_trace}
...
\clearpage
%------------------------------------------------------------------------------------------------------------------
\subsubsection{\REC{metis_LM_lss_wave}: LM-LSS wavelength calibration}\label{rec:metis_lm_lss_wave}
...
\clearpage
%------------------------------------------------------------------------------------------------------------------
\subsubsection{\REC{metis_LM_lss_std}: LM-LSS standard star calibration}\label{rec:metis_lm_lss_std}
...
\subsubsection{\REC{metis_LM_lss_sci}: LM-LSS science reduction}\label{rec:metis_lm_lss_sci}
...
\subsubsection{\REC{metis_LM_lss_mf_model}: LM-LSS telluric correction}\label{rec:metis_lm_lss_mf_model}
...
\subsubsection{\REC{metis_LM_lss_mf_calctrans}: LM-LSS telluric correction}\label{rec:metis_lm_lss_mf_calctrans}
...
\subsubsection{\REC{metis_LM_lss_mf_correct}: LM-LSS telluric correction}\label{rec:metis_lm_lss_mf_correct}
