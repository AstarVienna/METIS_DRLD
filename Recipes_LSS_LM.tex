...
These recipes aim for detector-specific calibrations and are therefore the same as in the imagin pipeline. Detecdescribed in the corresponding sections \ref{} and \ref{}, respectively.
