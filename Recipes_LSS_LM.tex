...
Type:		& Calibration\\
Requirements: & None \\
Observing templates: & \TPL{METIS_spec_lm_cal_rsrf} \\
...
The recipe \hyperref[rec:lsslmtrace]{\REC{metis_LM_lss_trace}} aims at detecting the orders and a polynomial fitting of the order locations (see \cite{pis02} and \cite{pis21} for details on the algorithms).
...
Type:		& Calibration\\
Requirements: & None \\
Observing templates: & \TPL{METIS_spec_lm_cal_rsrfpinh}  \\
...
Observing templates: & \TPL{METIS_spec_lm_cal_standard}\\
