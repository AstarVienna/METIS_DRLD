...
\subsubsection{LM-LSS Flatfielding recipe \REC{metis_LM_lss_rsrf}:}
\TODO{Not yet revised (see \cite{DRLS})}\\


\subsubsection{LM-LSS wavelength calibration recipe \REC{metis_LM_lss_wave}:}
...
\subsubsection{LM-LSS flux calibration recipe \REC{metis_LM_lss_flux}:}
...
\end{recipedef}
\subsubsection{LM-LSS telluric correction recipe \REC{metis_LM_lss_tac}:}
\TODO{Not yet revised (see \cite{DRLS})}\\
