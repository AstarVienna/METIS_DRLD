...
Expected accuracies: & 1/10th of a pixel after post-processing (cf. \cite{METIS-calibration_plan}, R-MET-106, METIS-167, METIS-1371)\\
...
Expected accuracies: & for wavelength: 1/10th of a pixel after post-processing\\
            ...
            & for flux: 10\% over an atmospheric band (cf. \cite{METIS-calibration_plan}, R-MET-107)\\
            & $<30$\% absolute line flux accuracy (cf. \cite{METIS-calibration_plan}, R-MET-107)\\
            & $<5$\% absolute flux calibration (cf. \cite{METIS-calibration_plan}, R-MET-82)\\
