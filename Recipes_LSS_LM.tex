...
QC1 parameters: & \QC{QC LM LSS STD BACKGD MEAN}: Mean value of background\\
                ...
                & \QC{QC LM LSS STD SNR}: Signal-to-noise ratio of flux standard star spectrum\\
...
QC1 parameters: & \QC{QC LM LSS SCI SNR}: Signal-to-noise ratio of science spectrum\\
                & \QC{QC LM LSS SCI NOISELEV}: Noise level of science spectrum\\
                & \QC{QC LM LSS SCI FLUX SNR}: Signal-to-noise ratio of flux calibrated science spectrum\\
