...
\subbsubsection{Recipes \REC{metis_det_lingain} and \REC{metis_det_dark}}
These recipes aim for detector-specific calibrations and are therefore the same as in the imagin pipeline. Detector calibrations described in the corresponding sections \ref{} and \ref{}, respectively.
