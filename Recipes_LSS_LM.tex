...
QC1 parameters: & \hyperref[qc:qc_lm_lss_std_backgd_mean]{\QC{QC LM LSS STD BACKGD MEAN}}: Mean value of background\\
                ...
                & \hyperref[qc:qc_lm_lss_std_noiselev]{\QC{QC LM LSS STD SNRNOISE}}: Noise level of flux standard star spectrum\\
...
QC1 parameters: & \hyperref[qc:qc_lm_lss_sci_snr]{\QC{QC LM LSS SCI SNR}}: Signal-to-noise ration of science spectrum\\
                ...
                & \hyperref[qc:qc_lm_lss_sci_flux_noiselev]{\QC{QC LM LSS SCI FLUX SNRNOISE}}: Noise level of flux calibrated science spectrum\\
