...
In case a telluric absorption correction is required, this recipe
applies a transmission spectrum of the Earth's atmosphere to the
SCIENCE data. Up to now, we assume that the modelling approach with
\texttt{molecfit} will be the default method (see
Fig.~\ref{Fig:rec_lm_lss_tellcorr}) rather than
dedicated telluric standard star observations. \\
