...
\begin{recipedef}
Name: & \hyperref[drl:metis_determine_dark]{\DRL{metis_determine_dark}} \\
...
\begin{recipedef}
Name: & \hyperref[drl:metis_update_dark_mask]{\DRL{metis_update_dark_mask}} \\
Purpose: & Flag deviant (hot, cold, bad) pixels in the master dark and update the image mask\\
Used in recipes: & \hyperref[rec:metis_det_dark]{\REC{metis_det_dark}}\\
%Working remarks: & None \\
%Function Parameters: & None \\
...
\begin{recipedef}
Name: & \hyperref[drl:metis_apply_persistence_correction]{\DRL{metis_apply_persistence_correction}} \\
