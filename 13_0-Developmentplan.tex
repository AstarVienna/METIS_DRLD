...
The pipeline package will be carefully reviewed to check its compliance to \cite{1618} approximately 3 months (TBD) before the PAE review. The verification consists of
\begin{itemize}
    \item
\end{itemize}
