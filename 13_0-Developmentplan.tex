...
\begin{enumerate}
    \item Review and adapt the schedule for the pipeline software development after successful PIP FDR in compliance with the METIS DRL Validation and Test Plan (\cite. In particular, a detailed schedule will be set up with ESO regarding updated versions of pipeline package consisting of
    \begin{itemize}
