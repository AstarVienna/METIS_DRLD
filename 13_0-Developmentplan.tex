...
\begin{table}
  ...
  \begin{tabularx}{\textwidth}{llll}
    ...
    Post-FDR 2       & Data reduction system chain skeleton &  T$_{FDR}$ + 12 months & Nov 2024 \\
...
\begin{enumerate}
    \item Review and adapt the schedule for the pipeline software development after successful PIP FDR. In particular, a detailed schedule will be set up with ESO regarding updated versions of 
    \begin{itemize}
        Data Reduction Library
        Test and calibration data
        Test reports
        Pipeline/QC user manual
    \end{itemize}
    \item Delivery of simulated and processed data at T$_{FDR}$ + 6 months.
    \item Delivery of the data reduction system schain skeleton
\end{enumerate}