...
It is planned that the commissioning period will be devided in three sections
\begin{itemize}
    \item Commissioning period 1 (COM1)
    \item Performance Assessment Period
    \item Commissioning period 2 (COM2)
\end{itemize}
