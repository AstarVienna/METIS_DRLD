...
The scope of the data flow end-to-end simulation is to validate the full process of pipeline data processing. The end-to-end tests then consist of starting the workflows, let them sort the data, execute the recipes in
the right order, and correctly passing intermediate data products from one to the other, until the final data
