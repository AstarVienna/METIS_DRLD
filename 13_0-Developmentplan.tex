...
\begin{enumerate}
    ...
    \end{itemize}
    Following the outline of the system AIT plan, LMS-related modules should be first available in the first monthsof the system AIT phase CD, followed later by IMG-related modules.
