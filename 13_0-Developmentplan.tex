...
Test data are are required for the pipeline software development, including prototyping algorithms, developing pipeline recipes and workflows and for testing and validating the pipeline.
