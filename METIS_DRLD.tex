...
\newcommand{\issuenumber}{0-3}                % Version
\newcommand{\issuedate}{2022-09-07}              % Date
...
%% Write a raw FITS file like this: \RAW{LM_SCI_RAW}
\makeatletter
...
{% begin code
  \begin{tcolorbox}[breakable,enhanced jigsaw]%
    \begin{longtable}{p{0.22\hsize}p{0.72\hsize}}}
      {% end code
    \end{longtable}%
  \end{tcolorbox}}
