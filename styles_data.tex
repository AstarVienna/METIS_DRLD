...
\NewDocumentCommand{\ITEM}{smm O{dataitem}}{%
    \IfBooleanTF{#1}{%
...
\NewDocumentCommand{\NEWRAW}{s m}{\IfBooleanTF#1{\ITEM*{RAW}{#2}}{#1\ITEM{RAW}{#2}}}
...
\NewDocumentCommand{\NEWREC}{s m}{\IfBooleanTF#1{\ITEM*{REC}{#2}[rec]}{\ITEM{REC}{#2}[rec]}}
\NewDocumentCommand{\NEWQC}{s m}{\IfBooleanTF#1{\ITEM*{QC}{#2}}{\ITEM{QC}{#2}}}
