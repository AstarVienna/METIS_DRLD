...
%%
%% subsection for LMS/IFU recipes
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
recipes (\REC{metis_ifu_basic}, \REC{metis_ifu_background}), then
...
perhaps using the distortion table from \REC{metis_ifu_distortion} if
...
Input data:          & Raw flats taken with black-body calibration lamp.                        \\
                     & \CODE{MASTER_DARK_IFU}                                                   \\
                     & \CODE{BADPIX_MAP_IFU}                                                    \\
                     & \CODE{IFU_WAVECAL}: image with wavelength at each pixel.                 \\
Parameters:          & TBD                                                                      \\
...
(\CODE{IFU_SCI_COMBINED}) but may be applied to other products of
...
\begin{recipedef}
  ...
  Templates:           & ---                                                                             \\
  Input data:          & \CODE{IFU_SCI_COMBINED} -- reduced combined IFU cube                            \\
...
Calibration of the geometric distortion of the LMS/IFU is done by
