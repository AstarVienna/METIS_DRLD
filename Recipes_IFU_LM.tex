...
Matched Keywords: & \FITS{DET.DIT}\\
  ...
  QC1 parameters:      &  \QC{QC IFU TELLURIC CHI2}     \\
                       &  \QC{QC IFU TELLURIC NPIXTHRESH}     \\
                       &  \QC{QC IFU TELLURIC CONVERSION}     \\
\end{recipedef}
...
Matched Keywords: & \FITS{DRS.IFU}\\
  ...
  QC1 parameters:      &  \QC{QC IFU CALIBRATE MAXFLUX}     \\
                       &  \QC{QC IFU CALIBRATE MINFLUX}     \\
\end{recipedef}
...
%                  & \PROD{IFU_SCI_COADD_ERROR}        \\
  QC1 parameters: &  \QC{QC IFU POSTPROCESS GRIDRANGE}     \\
                  &  \QC{QC IFU POSTPROCESS MEDIANMEAN}     \\
                  &  \QC{QC IFU POSTPROCESS MEDIANRMS}     \\
                  &  \QC{QC IFU POSTPROCESS MEDIANMEDIAN}     \\
                  &  \QC{QC IFU POSTPROCESS DELTAC}     \\
