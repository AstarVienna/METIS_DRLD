...
For the LM band detectors in the IFU, the pixels on the edges of the detectors shall be masked with the following widths \cite{matisse_minutes} (\REQ{METIS-9141}):
\begin{itemize}
