...
\clearpage
\subsubsection{\REC*{metis_ifu_telluric}: IFU telluric absorption correction (OUTDATET!)}
...
\clearpage
\subsubsection{\REC*{metis_ifu_telluric}: IFU telluric absorption correction (NEW!)}
\label{sssec:ifu_telluric_new}
\label{rec:metis_ifu_telluric_new}
To Be adapted to the telluriccorr package of ESO --> WK to make 3 recipes out of it
...
whose coefficients can be used to map positions in the detector
