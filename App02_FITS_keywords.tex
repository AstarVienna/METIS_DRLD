...
Comment & Alias of combination of keywords used to identify the filter settings. \\
...
Value & \%.50s \tabularnewline
Unit & none \tabularnewline
Comment & Alias of combination of keywords used to identify the slit settings. \\
...
Value & \%.50s \tabularnewline
Unit & none \tabularnewline
Comment & Alias of combination of keywords used to identify the neutral density filter settings. \\
...
Value & \%.50s \tabularnewline
Unit & none \tabularnewline
Comment & Alias of combination of keywords used to identify the IFU settings. \\
...
Value & \%.50s \tabularnewline
Unit & none \tabularnewline
Comment & Alias of combination of keywords used to identify the coronograph settings. \\
...
Value & \%.50s \tabularnewline
Unit & none \tabularnewline
Comment & Alias of combination of keywords used to identify the pupil settings. \\
...
\subsection{QUALDATA}\label{fits:qualdata}
\begin{recipedef}
