tmp% This section contains a description of the format of all FITS keywords
\section{FITS keywords}
\label{app:fits_keywords}

The below lists of keys make up the interface to the \ac{ICS}, in compliance with \REQ{METIS-6081}.
