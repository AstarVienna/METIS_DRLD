...
\subsubsection{INS.OPTI19.NAME}\label{fits:ins.opti19.name}
\begin{recipedef}
  Name & INS OPTI19 NAME \tabularnewline
  Class & header \tabularnewline
  Context & INS \tabularnewline
  Type & string \tabularnewline
  Value & \%.50s \tabularnewline
  Unit & None  \tabularnewline
  Comment & WCU BB exit aperture masks \tabularnewline
  Range & \tabularnewline
  Description & WCU BB exit aperture masks \tabularnewline
\end{recipedef}
