...
QC outputs: & \QC{QC LM cgrph SCI CONTRAST RAW LAMD}\\
  ...
  Output FITS files: & \hyperref[dataitem:lm_cgrph_sci_contrast_radprof]{\PROD{LM_cgrph_SCI_CONTRAST_RADPROF}} \\
...
QC outputs: & \QC{QC N cgrph SCI CONTRAST RAW LAMD}\\
  ...
  Output FITS files: & \hyperref[dataitem:n_cgrph_sci_contrast_radprof]{\PROD{N_cgrph_SCI_CONTRAST_RADPROF}} \\
...
QC outputs: & \QC{QC det APP SCI CONTRAST RAW LAMD}\\
  ...
  Output FITS files: & \hyperref[dataitem:lm_app_sci_contrast_radprof]{\PROD{LM_APP_SCI_CONTRAST_RADPROF}} \\
