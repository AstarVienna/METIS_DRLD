...
Used in recipes: & \hyperref[rec:metis_img_adi_cgrph]{\REC{metis_img_adi_cgrph}}\\
...
Used in recipes: & \hyperref[rec:metis_lm_adi_app]{\REC{metis_lm_adi_app}}\\
%Working remarks: & None \\
%Function Parameters: & None \\
Input: & $n\times$ \texttt{const hdrl\_image * input} \\
%Other inputs: & None \\
...
% HB 20230707: I (temporarily?) commented out the _PSF_MEDIAN data items because they are not output of the recipe, see comment in ADI_data_items.tex
\begin{recipedef}
...
\begin{recipedef}
Name: & \hyperref[drl:lm_merge_app_psf]{\DRL{lm_merge_app_psf}} \\
...
%\begin{recipedef}
%Name: & \hyperref[drl:n_merge_app_psf]{\DRL{n_merge_app_psf}} \\
...
QC outputs: & QC LM cgrph SCI CONTRAST RAW LAMD\\
  ...
  Output FITS files: & \hyperref[dataitem:lm_cgrph_sci_contrast_raw]{\PROD{LM_cgrph_SCI_CONTRAST_RAW}} \\
                     & \hyperref[dataitem:lm_cgrph_sci_contrast_adi]{\PROD{LM_cgrph_SCI_CONTRAST_ADI}} \\
                     & \hyperref[dataitem:lm_cgrph_sci_throughput]{\PROD{LM_cgrph_SCI_THROUGHPUT}} \\
Outputs: & \texttt{cpl\_error\_code} \\
...
QC outputs: & QC N cgrph SCI CONTRAST RAW LAMD\\
  ...
  Output FITS files: & \hyperref[dataitem:n_cgrph_sci_contrast_raw]{\PROD{N_cgrph_SCI_CONTRAST_RAW}} \\
                     & \hyperref[dataitem:n_cgrph_sci_contrast_adi]{\PROD{N_cgrph_SCI_CONTRAST_ADI}} \\
                     & \hyperref[dataitem:n_cgrph_sci_throughput]{\PROD{N_cgrph_SCI_THROUGHPUT}} \\
Outputs: & \texttt{cpl\_error\_code} \\
...
QC outputs: & QC det APP SCI CONTRAST RAW LAMD\\
  ...
  Output FITS files: & \hyperref[dataitem:lm_app_sci_contrast_raw]{\PROD{LM_APP_SCI_CONTRAST_RAW}} \\
