...
\subsubsection{\texttt{n\_adi\_cgrph\_centroid}}\label{drl:n_adi_cgrph_centroid}
\begin{recipedef}
...
\subsubsection{\texttt{lm\_adi\_app\_centroid}}\label{drl:lm_adi_app_centroid}
\begin{recipedef}
...
\subsubsection{\texttt{n\_adi\_app\_centroid}}\label{drl:n_adi_app_centroid}
\begin{recipedef}
...
\subsubsection{\texttt{lm\_adi\_cgrph\_psf}}\label{drl:lm_adi_cgrph_psf}
\begin{recipedef}
...
\subsubsection{\texttt{n\_adi\_cgrph\_psf}}\label{drl:n_adi_cgrph_psf}
\begin{recipedef}
...
\subsubsection{\texttt{lm\_adi\_app\_psf}}\label{drl:lm_adi_app_psf}
\begin{recipedef}
...
\subsubsection{\texttt{n\_adi\_app\_psf}}\label{drl:n_adi_app_psf}
\begin{recipedef}
...
\subsubsection{\texttt{lm\_merge\_app\_psf}}\label{drl:lm_merge_app_adi_psf}
\begin{recipedef}
...
\subsubsection{\texttt{n\_merge\_app\_psf}}\label{drl:n_merge_app_adi_psf}
\begin{recipedef}
...
\subsubsection{\texttt{adi\_regrid}}\label{drl:adi_regrid}
\begin{recipedef}
...
\subsubsection{\texttt{ifu\_adi\_regrid}}\label{drl:ifu_adi_regrid}
\begin{recipedef}
...
\subsubsection{\texttt{adi\_derotate}}\label{drl:adi_derotate}
\begin{recipedef}
...
Output FITS files: & \PROD{det_cgrph_SCI_DEROTATED_PFSUB} \\
...
\subsubsection{\texttt{lm\_adi\_cgrph\_contrast}}\label{drl:lm_adi_cgrph_contrast}
\begin{recipedef}
...
QC outputs: & QC DET CGRPH SCI CONTRAST RAW LAMD\\
  ...
  Output FITS files: & \PROD{det_cgrph_SCI_CONTRAST_RAW} \\
                     & \PROD{det_cgrph_SCI_CONTRAST_ADI} \\
                     & \PROD{det_cgrph_SCI_THROUGHPUT} \\
Outputs: & \texttt{cpl\_error\_code} \\
...
\subsubsection{\texttt{n\_adi\_cgrph\_contrast}}\label{drl:n_adi_cgrph_contrast}
\begin{recipedef}
...
\subsubsection{\texttt{lm\_adi\_app\_contrast}}\label{drl:lm_adi_app_contrast}
\begin{recipedef}
...
QC outputs: & QC DET APP SCI CONTRAST RAW LAMD\\
  ...
  Output FITS files: & \PROD{det_app_SCI_CONTRAST_RAW} \\
                     & \PROD{det_app_SCI_CONTRAST_ADI} \\
                     & \PROD{det_app_SCI_THROUGHPUT} \\
Outputs: & \texttt{cpl\_error\_code} \\
...
\subsubsection{\texttt{n\_adi\_app\_contrast}}\label{drl:n_adi_app_contrast}
\begin{recipedef}
