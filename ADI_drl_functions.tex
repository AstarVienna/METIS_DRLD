...
Outputs: & \NEWPROD{lm_cgrph_CENTROID_TAB}\\
...
\begin{recipedef}
Name: & \NEWDRL{n_adi_cgrph_centroid} \\
...
%Output FITS files: & None \\
Outputs: & \NEWPROD{n_cgrph_CENTROID_TAB}\\
                & \texttt{cpl\_error\_code} \\
...
%Output FITS files: & None \\
Outputs: & \NEWPROD{lm_app_CENTROID_TAB}\\
                & \texttt{cpl\_error\_code} \\
...
% \begin{recipedef}
% Name: & \NEWDRL{n_adi_app_centroid} \\
...
% %Output FITS files: & None \\
% Outputs: & \NEWPROD{n_app_CENTROID_TAB}\\
%                 & \texttt{cpl\_error\_code} \\
...
Input: & $n\times$ \texttt{const hdrl\_image * input} \\
       &  \NEWPROD{lm_cgrph_CENTROID_TAB}\\
%Other inputs: & None \\
QC outputs: & \QC{QC det cgrph SCI FWHM nn}\\
%Output FITS files: & None \\
Outputs: & \NEWPROD{lm_cgrph_PSF_MEDIAN}\\
...
Function Parameters: & combination method (median, mean, sigma clipped...)\\
                     & parameters for combination method\\
Input: & $n\times$ \texttt{const hdrl\_image * input} \\
       &  \NEWPROD{N_cgrph_CENTROID_TAB}\\
%Other inputs: & None \\
QC outputs: & \QC{QC det cgrph SCI FWHM nn}\\
%Output FITS files: & None \\
Outputs: & \NEWPROD{N_cgrph_PSF_MEDIAN}\\
Outputs: & \texttt{hdrl\_image * psf\_median}\\
                & \texttt{cpl\_error\_code} \\
General description: & Calculation of median PSF for sequence of ADI images\ \\
Mathematical description: & see Section~\ref{ssec:algo_app_imaging} \\
...
%Output FITS files: & None \\
Outputs: & \NEWPROD{LM_APP_PSF_MEDIAN}\\
Outputs: & \texttt{hdrl\_image * psf\_median}\\
                & \texttt{cpl\_error\_code} \\
General description: & Calculation of median PSF for sequence of ADI images\ \\
Mathematical description: & see Section~\ref{ssec:algo_app_imaging} \\
...
%                      & parameters for combination method\\
% Input: & $n\times$ \texttt{const hdrl\_image * input} \\
%        &  \NEWPROD{n_app_CENTROID_TAB}\\
% %Other inputs: & None \\
% QC outputs: & QC det APP SCI FWHM nn\\
% %Output FITS files: & None \\
% Outputs: & \NEWPROD{n_app_PSF_MEDIAN}\\
%                 & \texttt{cpl\_error\_code} \\
...
Input: & $n\times$ \texttt{const hdrl\_image * input} \\
       & \NEWPROD{det_cgrph_CENTROID_TAB}\\
       & \NEWPROD{det_DISTORTION_TABLE}\\
%Other inputs: & Parameters for regridding \\
QC outputs: & None\\
Output FITS files: & \NEWPROD{det_cgrph_SCI_CENTRED} \\
Outputs: &   \texttt{cpl\_error\_code} \\
...
Output FITS files: & \NEWPROD{det_cgrph_SCI_DEROTATED_PSFSUB} \\
                   & \NEWPROD{det_cgrph_SCI_DEROTATED} \\
Outputs: & \NEWPROD{det_cgrph_PSF_MEDIAN}\\
%                & \texttt{cpl\_error\_code} \\
...
\begin{recipedef}
Name: & \NEWDRL{lm_adi_cgrph_contrast} \\
...
QC outputs: & \QC{QC LM cgrph SCI CONTRAST RAW LAMD}\\
  ...
  Output FITS files: & \NEWPROD{LM_cgrph_SCI_CONTRAST_RADPROF} \\
                     & \NEWPROD{LM_cgrph_SCI_CONTRAST_ADI} \\
                     & \NEWPROD{LM_cgrph_SCI_THROUGHPUT} \\
Outputs: & \texttt{cpl\_error\_code} \\
...
\begin{recipedef}
Name: & \NEWDRL{n_adi_cgrph_contrast} \\
...
QC outputs: & \QC{QC N cgrph SCI CONTRAST RAW LAMD}\\
  ...
  Output FITS files: & \NEWPROD{N_cgrph_SCI_CONTRAST_RADPROF} \\
                     & \NEWPROD{N_cgrph_SCI_CONTRAST_ADI} \\
                     & \NEWPROD{N_cgrph_SCI_THROUGHPUT} \\
Outputs: & \texttt{cpl\_error\_code} \\
...
\begin{recipedef}
Name: & \NEWDRL{lm_adi_app_contrast} \\
...
QC outputs: & \QC{QC det APP SCI CONTRAST RAW LAMD}\\
  ...
  Output FITS files: & \NEWPROD{LM_APP_SCI_CONTRAST_RADPROF} \\
...
%\begin{recipedef}
%Name: & \NEWDRL{n_adi_app_contrast} \\
