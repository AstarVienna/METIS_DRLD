...
\subsubsection{\texttt{lm\_adi\_cgrph\_contrast}}\label{drl:lm_adi_contrast}
\begin{recipedef}
...
\subsubsection{\texttt{n\_adi\_cgrph\_contrast}}\label{drl:n_adi_contrast}
\begin{recipedef}
...
\subsubsection{\texttt{lm\_adi\_app\_contrast}}\label{drl:lm_adi_contrast}
\begin{recipedef}
Name: & \hyperref[drl:lm_adi_contrast]{\DRL{lm\_adi\_contrast}} \\
...
\subsubsection{\texttt{n\_adi\_app\_contrast}}\label{drl:n_adi_contrast}
\begin{recipedef}
Name: & \hyperref[drl:n_adi_contrast]{\DRL{n\_adi\_contrast}} \\
