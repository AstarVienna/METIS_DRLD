...
%                        & Coronagraphic throughput map and profile         \\
                       ...
                       & \hyperref[dataitem:lm_off_axis_psf_raw]{\PROD{LM_OFF_AXIS_PSF_RAW}} or \hyperref[dataitem:n_off_axis_psf_raw]{\PROD{N_OFF_AXIS_PSF_RAW}}\\
...
\begin{recipedef}\label{rec:metis_det_adi_app}
  Name:                & \hyperref[rec:metis_det_adi_app]{\REC{metis_det_adi_app}}                                        \\
  ...
  Input data:          & \hyperref[dataitem:lm_sci_basic_reduced]{\PROD{LM_SCI_BASIC_REDUCED}}                            \\
                       ...
                       & \hyperref[dataitem:lm_off_axis_psf_raw]{\PROD{LM_OFF_AXIS_PSF_RAW}}                                                  \\
   Matched keywords:   & Detector ID             \\
                       & Filter ID               \\
                       & Object ID               \\
                       & coronagraphic mask, \TBD\\
...
%                        & Coronagraphic throughput map and profile                                                  \\
                       & \hyperref[dataitem:det_app_sci_throughput]{\PROD{det_APP_SCI_THROUGHPUT}} \\
                       & \hyperref[dataitem:ifu_off_axis_psf_raw]{\PROD{IFU_OFF_AXIS_PSF_RAW}} \\
   Matched keywords:   & Detector ID             \\
                       & Filter ID               \\
                       & Object ID               \\
  Parameters:          & combination method (median, mean, sigclip, \dots)\\
