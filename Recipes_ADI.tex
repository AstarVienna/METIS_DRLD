...
\begin{recipedef}\label{rec:metis_det_adi_cgrph}
  ...
  Templates:           & \TPL{??} \TBD                               \\
  Type:                & Science                                                    \\
  Input data:          & \hyperref[dataitem:lmscibasicreduced]{\PROD{LM_SCI_BASIC_REDUCED}} or   \hyperref[dataitem:lmscibasicreduced]{\PROD{N_SCI_BASIC_REDUCED}}                         \\
...
\begin{recipedef}\label{rec:metis_det_adi_app}
  ...
  Templates:           & \TPL{??}                               \\
  Type:                & Science                                                    \\
  Input data:          & \hyperref[dataitem:lmscibasicreduced]{\PROD{LM_SCI_BASIC_REDUCED}}                            \\
