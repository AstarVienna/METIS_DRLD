...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS FLUX INTORDR LEVEL}}\label{qc:qc_lm_lss_flux_intordr_level}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS FLUX AVGLEVEL}}\label{qc:qc_lm_lss_flux_avglevel}
\begin{recipedef}
Name & \QC{QC LM LSS FLUX AVGLEVEL} \tabularnewline
Class & header \tabularnewline
Context & QC \tabularnewline
Type & double \tabularnewline
Value & \%.3f \tabularnewline
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS FLUX WAVECAL DEVMEAN}}\label{qc:qc_lm_lss_flux_wavecal_devmean}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS FLUX WAVECAL FWHM}}\label{qc:qc_lm_lss_flux_wavecal_fwhm}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS FLUX WAVECAL NIDENT}}\label{qc:qc_lm_lss_flux_wavecal_nident}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS FLUX WAVECAL NMATCH}}\label{qc:qc_lm_lss_flux_wavecal_nmatch}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS FLUX WAVECAL POLYDEG}}\label{qc:qc_lm_lss_flux_wavecal_polydeg}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS FLUX WAVECAL POLYCOEFF<n>}}\label{qc:qc_lm_lss_flux_wavecal_polycoeff<n>}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% The following 3 QCs are duplicate QCs from above with slightly different names STD -> FLUX, and
% are thus removed
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS FLUX STDSNR}}\label{qc:qc_lm_lss_flux_stdsnr}
\TODO{CHECK!!!}
%\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS FLUX SNRNOISE}}\label{qc:qc_lm_lss_flux_snrnoise}
\TODO{CHECK!!!}
%\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS FLUX FWHM}}\label{qc:qc_lm_lss_flux_fwhm}
\TODO{CHECK!!!}
%\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS FLUX PSFLOSS}}\label{qc:qc_lm_lss_flux_psfloss}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS FLUX INTORDR LEVEL}}\label{qc:qc_n_lss_flux_intordr_level}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS FLUX AVGLEVEL}}\label{qc:qc_n_lss_flux_avglevel}
\begin{recipedef}
Name & \QC{QC N LSS FLUX AVGLEVEL} \tabularnewline
Class & header \tabularnewline
Context & QC \tabularnewline
Type & double \tabularnewline
Value & \%.3f \tabularnewline
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS FLUX WAVECAL DEVMEAN}}\label{qc:qc_n_lss_flux_wavecal_devmean}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS FLUX WAVECAL FWHM}}\label{qc:qc_n_lss_flux_wavecal_fwhm}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS FLUX WAVECAL NIDENT}}\label{qc:qc_n_lss_flux_wavecal_nident}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS FLUX WAVECAL NMATCH}}\label{qc:qc_n_lss_flux_wavecal_nmatch}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS FLUX WAVECAL POLYDEG}}\label{qc:qc_n_lss_flux_wavecal_polydeg}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS FLUX WAVECAL POLYCOEFF<n>}}\label{qc:qc_n_lss_flux_wavecal_polycoeff<n>}
\begin{recipedef}
...
% are thus removed
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS FLUX STDSNR}}\label{qc:qc_n_lss_flux_stdsnr}
\TODO{CHECK!!!}
%\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS FLUX SNRNOISE}}\label{qc:qc_n_lss_flux_snrnoise}
\TODO{CHECK!!!}
%\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS FLUX FWHM}}\label{qc:qc_n_lss_flux_fwhm}
\TODO{CHECK!!!}
%\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS FLUX PSFLOSS}}\label{qc:qc_n_lss_flux_psfloss}
\begin{recipedef}
