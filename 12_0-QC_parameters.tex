...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC DARK MEAN}}\label{qc:qc_dark_mean}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC DARK MEDIAN}}\label{qc:qc_dark_median}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC DARK RMS}}\label{qc:qc_dark_rms}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC DARK NBADPIX}}\label{qc:qc_dark_nbadpix}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC DARK NCOLDPIX}}\label{qc:qc_dark_ncoldpix}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC DARK NHOTPIX}}\label{qc:qc_dark_nhotpix}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM MASTERFLAT RMS}}\label{qc:qc_lm_masterflat_rms}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM MASTERFLAT NBADPIX}}\label{qc:qc_lm_masterflat_nbadpix}
\begin{recipedef}
...
\paragraph{\QC{QC N MASTERFLAT RMS}}\label{qc:qc_n_masterflat_rms}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N MASTERFLAT NBADPIX}}\label{qc:qc_n_masterflat_nbadpix}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LIN GAIN MEAN}}\label{qc:qc_lin_gain_mean}
\begin{recipedef}
...
\paragraph{\QC{QC LIN GAIN RMS}}\label{qc:qc_lin_gain_rms}
\begin{recipedef}
...
\paragraph{\QC{QC LM IMG STD BACKGD RMS}}\label{qc:qc_lm_img_std_backgd_rms}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM IMG MEDIAN}}\label{qc:qc_lm_img_median}
\begin{recipedef}
...
\paragraph{\QC{QC LM IMG STANDARD DEVIATION}}\label{qc:qc_lm_img_standard_deviation}
\begin{recipedef}
...
\paragraph{\QC{QC LM IMG PEAK}}\label{qc:qc_lm_img_peak}
\begin{recipedef}
...
\paragraph{\QC{QC LM IMG BKG MEDIAN}}\label{qc:qc_lm_img_bkg_median}
\begin{recipedef}
...
\paragraph{\QC{QC LM IMG BKG MEDIAN DEVIATION}}\label{qc:qc_lm_img_bkg_median_deviation}
\begin{recipedef}
...
\paragraph{\QC{QC LIN NUM BADPIX}}\label{qc:qc_lin_num_badpix}
\begin{recipedef}
...
\paragraph{\QC{QC IFU STD FWHM}}\label{qc:qc_ifu_std_fwhm}
\begin{recipedef}
...
\paragraph{\QC{QC IFU STD ELLIP}}\label{qc:qc_ifu_std_ellip}
\begin{recipedef}
...
\paragraph{\QC{QC IFU WAVECAL LINE WIDTH}}\label{qc:qc_ifu_wavecal_line_width}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS RSRF MEAN LEVEL}}\label{qc:qc_lm_lss_rsrf_mean_level}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS RSRF MEDIAN LEVEL}}\label{qc:qc_lm_lss_rsrf_median_level}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS RSRF INTORDR LEVEL}}\label{qc:qc_lm_lss_rsrf_intordr_level}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS RSRF NORM STDEV}}\label{qc:qc_lm_lss_rsrf_norm_stdev}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS RSRF NORM SNR}}\label{qc:qc_lm_lss_rsrf_norm_snr}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS TRACE LPOLYDEG}}\label{qc:qc_lm_lss_trace_lpolydeg}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS TRACE LCOEFF<i>}}\label{qc:qc_lm_lss_trace_lcoeff<i>}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS TRACE RPOLYDEG}}\label{qc:qc_lm_lss_trace_rpolydeg}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS TRACE RCOEFF<i>}}\label{qc:qc_lm_lss_trace_rcoeff<i>}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS TRACE INTORDR LEVEL}}\label{qc:qc_lm_lss_trace_intordr_level}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS WAVE POLYDEG}}\label{qc:qc_lm_lss_wave_polydeg}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS WAVE COEFF<i>}}\label{qc:qc_lm_lss_wave_coeff<i>}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS WAVE NLINES}}\label{qc:qc_lm_lss_wave_nlines}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS WAVE LINEFWHMAVG}}\label{qc:qc_lm_lss_wave_linefwhmavg}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS WAVE INTORDR LEVEL}}\label{qc:qc_lm_lss_wave_intordr_level}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS STD BACKGD MEAN}}\label{qc:qc_lm_lss_std_backgd_mean}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS STD BACKGD MEDIAN}}\label{qc:qc_lm_lss_std_backgd_median}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS STD BACKGD STDEV}}\label{qc:qc_lm_lss_std_backgd_stdev}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS STD SNR}}\label{qc:qc_lm_lss_std_snr}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS STD NOISELEV}}\label{qc:qc_lm_lss_std_noiselev}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS STD FWHM}}\label{qc:qc_lm_lss_std_fwhm}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS STD INTORDR LEVEL}}\label{qc:qc_lm_lss_std_intordr_level}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS STD AVGLEVEL}}\label{qc:qc_lm_lss_std_avglevel}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS STD WAVECAL DEVMEAN}}\label{qc:qc_lm_lss_std_wavecal_devmean}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS STD WAVECAL FWHM}}\label{qc:qc_lm_lss_std_wavecal_fwhm}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS STD WAVECAL NIDENT}}\label{qc:qc_lm_lss_std_wavecal_nident}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS STD WAVECAL NMATCH}}\label{qc:qc_lm_lss_std_wavecal_nmatch}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS STD WAVECAL POLYDEG}}\label{qc:qc_lm_lss_std_wavecal_polydeg}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS STD WAVECAL POLYCOEFF<n>}}\label{qc:qc_lm_lss_std_wavecal_polycoeff<n>}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\paragraph{\QC{QC LM LSS STD PSFLOSS}}\label{qc:qc_lm_lss_std_psfloss}
%\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS SCI SNR}}\label{qc:qc_lm_lss_sci_snr}
\begin{recipedef}
...
\end{recipedef}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS SCI NOISELEV}}\label{qc:qc_lm_lss_sci_noiselev}
\begin{recipedef}
...
\end{recipedef}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS SCI FLUX SNR}}\label{qc:qc_lm_lss_sci_flux_snr}
\begin{recipedef}
...
\end{recipedef}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS SCI FLUX NOISELEV}}\label{qc:qc_lm_lss_sci_flux_noiselev}
\begin{recipedef}
...
\end{recipedef}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS SCI INTORDR LEVEL}}\label{qc:qc_lm_lss_sci_intordr_level}
\begin{recipedef}
...
\end{recipedef}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS SCI WAVECAL DEVMEAN}}\label{qc:qc_lm_lss_sci_wavecal_devmean}
\begin{recipedef}
...
\end{recipedef}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS SCI WAVECAL FWHM}}\label{qc:qc_lm_lss_sci_wavecal_fwhm}
\begin{recipedef}
...
\end{recipedef}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS SCI WAVECAL NIDENT}}\label{qc:qc_lm_lss_sci_wavecal_nident}
\begin{recipedef}
...
\end{recipedef}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS SCI WAVECAL NMATCH}}\label{qc:qc_lm_lss_sci_wavecal_nmatch}
\begin{recipedef}
...
\end{recipedef}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS SCI WAVECAL POLYDEG}}\label{qc:qc_lm_lss_sci_wavecal_polydeg}
\begin{recipedef}
...
\end{recipedef}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS SCI WAVECAL POLYCOEFF<n>}}\label{qc:qc_lm_lss_sci_wavecal_polycoeff<n>}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS RSRF MEAN LEVEL}}\label{qc:qc_n_lss_rsrf_mean_level}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS RSRF MEDIAN LEVEL}}\label{qc:qc_n_lss_rsrf_median_level}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS RSRF INTORDR LEVEL}}\label{qc:qc_n_lss_rsrf_intordr_level}
\begin{recipedef}
Name & \QC{QC N LSS RSRF MEDIAN LEVEL} \tabularnewline
Class & header \tabularnewline
Context & QC \tabularnewline
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS RSRF NORM STDEV}}\label{qc:qc_n_lss_rsrf_norm_stdev}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS RSRF NORM SNR}}\label{qc:qc_n_lss_rsrf_norm_snr}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS TRACE LPOLYDEG}}\label{qc:qc_n_lss_trace_lpolydeg}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS TRACE LCOEFF<i>}}\label{qc:qc_n_lss_trace_lcoeff<i>}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS TRACE RPOLYDEG}}\label{qc:qc_n_lss_trace_rpolydeg}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS TRACE RCOEFF<i>}}\label{qc:qc_n_lss_trace_rcoeff<i>}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS TRACE INTORDR LEVEL}}\label{qc:qc_n_lss_trace_intordr_level}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS STD BACKGD MEAN}}\label{qc:qc_n_lss_std_backgd_mean}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS STD BACKGD MEDIAN}}\label{qc:qc_n_lss_std_backgd_median}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS STD BACKGD STDEV}}\label{qc:qc_n_lss_std_backgd_stdev}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS STD SNR}}\label{qc:qc_n_lss_std_snr}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS STD NOISELEV}}\label{qc:qc_n_lss_std_noiselev}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS STD FWHM}}\label{qc:qc_n_lss_std_fwhm}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS STD INTORDR LEVEL}}\label{qc:qc_n_lss_std_intordr_level}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS STD AVGLEVEL}}\label{qc:qc_n_lss_std_avglevel}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS STD WAVECAL DEVMEAN}}\label{qc:qc_n_lss_std_wavecal_devmean}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS STD WAVECAL FWHM}}\label{qc:qc_n_lss_std_wavecal_fwhm}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS STD WAVECAL NIDENT}}\label{qc:qc_n_lss_std_wavecal_nident}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS STD WAVECAL NMATCH}}\label{qc:qc_n_lss_std_wavecal_nmatch}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS STD WAVECAL POLYDEG}}\label{qc:qc_n_lss_std_wavecal_polydeg}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS STD WAVECAL POLYCOEFF<n>}}\label{qc:qc_n_lss_std_wavecal_polycoeff<n>}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\paragraph{\QC{QC N LSS STD PSFLOSS}}\label{qc:qc_n_lss_std_psfloss}
%\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS SCI SNR}}\label{qc:qc_n_lss_sci_snr}
\begin{recipedef}
...
\end{recipedef}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS SCI NOISELEV}}\label{qc:qc_n_lss_sci_noiselev}
\begin{recipedef}
...
\end{recipedef}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS SCI FLUX SNR}}\label{qc:qc_n_lss_sci_flux_snr}
\begin{recipedef}
...
\end{recipedef}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS SCI FLUX NOISELEV}}\label{qc:qc_n_lss_sci_flux_noiselev}
\begin{recipedef}
...
\end{recipedef}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS SCI INTORDR LEVEL}}\label{qc:qc_n_lss_sci_intordr_level}
\begin{recipedef}
...
\end{recipedef}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS SCI WAVECAL DEVMEAN}}\label{qc:qc_n_lss_sci_wavecal_devmean}
\begin{recipedef}
...
\end{recipedef}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS SCI WAVECAL FWHM}}\label{qc:qc_n_lss_sci_wavecal_fwhm}
\begin{recipedef}
...
\end{recipedef}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS SCI WAVECAL NIDENT}}\label{qc:qc_n_lss_sci_wavecal_nident}
\begin{recipedef}
...
\end{recipedef}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS SCI WAVECAL NMATCH}}\label{qc:qc_n_lss_sci_wavecal_nmatch}
\begin{recipedef}
...
\end{recipedef}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS SCI WAVECAL POLYDEG}}\label{qc:qc_n_lss_sci_wavecal_polydeg}
\begin{recipedef}
...
\end{recipedef}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS SCI WAVECAL POLYCOEFF<n>}}\label{qc:qc_n_lss_sci_wavecal_polycoeff<n>}
\begin{recipedef}
