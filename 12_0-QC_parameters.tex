...
Range & None \tabularnewline
Created by & \REC{metis_det_dark}\\
Description & Number of cold pixels in the image mask \tabularnewline
Comment & \tabularnewline
\end{recipedef}
...
Range & None \tabularnewline
Created by & \REC{metis_det_dark}\\
Description & Number of hot pixels in the image mask \tabularnewline
Comment & \tabularnewline
\end{recipedef}
...
Range & None \tabularnewline
Created by & \REC{metis_det_dark}\\
Description & Median of the median values of individual dark frames \tabularnewline
Comment & \tabularnewline
\end{recipedef}
...
Range & None \tabularnewline
Created by & \REC{metis_det_dark}\\
Description & Mean of the median values of individual dark frames \tabularnewline
Comment & \tabularnewline
\end{recipedef}
...
Range & None \tabularnewline
Created by & \REC{metis_det_dark}\\
Description & RMS of the median values of individual dark frames \tabularnewline
Comment & \tabularnewline
\end{recipedef}
...
Range & None \tabularnewline
Created by & \REC{metis_det_dark}\\
Description & Minimum of the median values of individual dark frames \tabularnewline
Comment & \tabularnewline
\end{recipedef}
...
Range & None \tabularnewline
Created by & \REC{metis_det_dark}\\
Description & Maximum of the median values of individual dark frames \tabularnewline
Comment & \tabularnewline
\end{recipedef}
...
%% CHOPHOME
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{QC CAL CHOPHOME XCEN}
\label{qc:qc_cal_chophome_xcen}
\begin{recipedef}
  Name & \QC{QC CAL CHOPHOME XCEN} \tabularnewline
  Class & header \tabularnewline
  Context & QC \tabularnewline
  Type & double \tabularnewline
  Value & \%.2f \tabularnewline
  Unit & Pixel  \tabularnewline
  Default & None \tabularnewline
  Range & None \tabularnewline
  Created by & \REC{metis_cal_chophome} \\
  Description & Centroid of point source in $x$ \tabularnewline
  Comment & \tabularnewline
\end{recipedef}

\subsubsection{QC CAL CHOPHOME XCEN STDEV}
\label{qc:qc_cal_chophome_xcen_stdev}
\begin{recipedef}
  Name & \QC{QC CAL CHOPHOME XCEN STDEV} \tabularnewline
  Class & header \tabularnewline
  Context & QC \tabularnewline
  Type & double \tabularnewline
  Value & \%.2f \tabularnewline
  ...
  Default & None \tabularnewline
  Range & None \tabularnewline
  Created by & \REC{metis_cal_chophome} \tabularnewline
  Description & Uncertainty of centroid in $x$ \tabularnewline
  Comment & \tabularnewline
\end{recipedef}

\subsubsection{QC CAL CHOPHOME YCEN}
\label{qc:qc_cal_chophome_ycen}
\begin{recipedef}
  Name & \QC{QC CAL CHOPHOME YCEN} \tabularnewline
  Class & header \tabularnewline
  Context & QC \tabularnewline
  Type & double \tabularnewline
  Value & \%.2f \tabularnewline
  ...
  Range & None \tabularnewline
  Created by & \REC{metis_cal_chophome} \tabularnewline
  Description & Centroid of point source in $y$ \tabularnewline
  Comment & \tabularnewline
\end{recipedef}

\subsubsection{QC CAL CHOPHOME YCEN STDEV}
\label{qc:qc_cal_chophome_ycen_stdev}
\begin{recipedef}
  Name & \QC{QC CAL CHOPHOME YCEN STDEV} \tabularnewline
  Class & header \tabularnewline
  Context & QC \tabularnewline
  Type & double \tabularnewline
  Value & \%.2f \tabularnewline
  ...
  Range & None \tabularnewline
  Created by & \REC{metis_cal_chophome} \tabularnewline
  Description & Uncertainty of centroid in $y$ \tabularnewline
  Comment & \tabularnewline
\end{recipedef}

\subsubsection{QC CAL CHOPHOME FWHM}
\label{qc:qc_cal_chophome_fwhm}
\begin{recipedef}
  Name & \QC{QC CAL CHOPHOME FWHM} \tabularnewline
  Class & header \tabularnewline
  Context & QC \tabularnewline
  Type & double \tabularnewline
  Value & \%.2f \tabularnewline
  ...
  Range & None \tabularnewline
  Created by & \REC{metis_cal_chophome} \tabularnewline
  Description & FWHM of point source \tabularnewline
  Comment & \tabularnewline
\end{recipedef}

\subsubsection{QC CAL CHOPHOME SNR}
\label{qc:qc_cal_chophome_snr}
\begin{recipedef}
  Name & \QC{QC CAL CHOPHOME SNR} \tabularnewline
  Class & header \tabularnewline
  Context & QC \tabularnewline
  Type & double \tabularnewline
  Value & \%.2f \tabularnewline
  ...
  Range & None \tabularnewline
  Created by & \REC{metis_cal_chophome} \tabularnewline
  Description & Signal-to-noise ratio of point source \tabularnewline
  Comment & \tabularnewline
\end{recipedef}

\subsubsection{QC CAL CHOPHOME OFFX}
\label{qc:qc_cal_chophome_offx}
\begin{recipedef}
  Name & \QC{QC CAL CHOPHOME OFFX} \tabularnewline
  Class & header \tabularnewline
  Context & QC \tabularnewline
  Type & double \tabularnewline
  Value & \%.2f \tabularnewline
  ...
  Range & None \tabularnewline
  Created by & \REC{metis_cal_chophome} \tabularnewline
  Description & Chopper offset in $x$ \tabularnewline
  Comment & \tabularnewline
\end{recipedef}

\subsubsection{QC CAL CHOPHOME OFFY}
\label{qc:qc_cal_chophome_offy}
\begin{recipedef}
  Name & \QC{QC CAL CHOPHOME OFFY} \tabularnewline
  Class & header \tabularnewline
  Context & QC \tabularnewline
  Type & double \tabularnewline
  Value & \%.2f \tabularnewline
  Unit & mas  \tabularnewline
  Default & None \tabularnewline
  Range & None \tabularnewline
  Created by & \REC{metis_cal_chophome} \tabularnewline
  Description & Chopper offset in $y$ \tabularnewline
  Comment & \tabularnewline
\end{recipedef}
...
\begin{recipedef}
Name & \QC{QC LIN MAX FLUX} \tabularnewline
Class & header \tabularnewline
Context & QC \tabularnewline
Type & double \tabularnewline
Value & \%.3f \tabularnewline
...
Range & None \tabularnewline
Created by & \REC{metis_lm_img_std_process}\\
Description & Sensitivity of extended source detections \tabularnewline
Comment & \tabularnewline
\end{recipedef}
...
Range & None \tabularnewline
Created by & \REC{metis_lm_img_basic_reduce}\\
Description & Peak value of the LM image \tabularnewline
Comment &  \tabularnewline
\end{recipedef}
...
Range & None \tabularnewline
Created by & \REC{metis_ifu_distortion}\\
Description & Measured FWHM of the spots \tabularnewline
Comment & None \tabularnewline
\end{recipedef}
...
Range & None \tabularnewline
Created by & \REC{metis_lm_lss_rsrf}\\
Description & \ac{SNR} of the normalised \ac{RSRF} \tabularnewline
Comment & None \tabularnewline
\end{recipedef}
...
Description & Signal-to-noise ratio of science spectrum \tabularnewline
Comment & None \tabularnewline
\end{recipedef}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Range & None \tabularnewline
Created by & \REC{metis_lm_lss_sci}\\
Description & Signal-to-noise ratio of flux calibrated science spectrum \tabularnewline
Comment & None \tabularnewline
\end{recipedef}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{recipedef}
Name & \QC{QC N LSS RSRF INTORDR LEVEL} \tabularnewline
Class & header \tabularnewline
Context & QC \tabularnewline
Type & double \tabularnewline
Value & \%.3f \tabularnewline
