...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS STD SNRNOISE}}\label{qc:qc_lm_lss_std_snrnoise}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS STD INTORDR LEVEL}}\label{qc:qc_lm_lss_flux_intordr_level}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS STD AVGLEVEL}}\label{qc:qc_lm_lss_flux_avglevel}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS STD WAVECAL DEVMEAN}}\label{qc:qc_lm_lss_flux_wavecal_devmean}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS STD WAVECAL FWHM}}\label{qc:qc_lm_lss_flux_wavecal_fwhm}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS STD WAVECAL NIDENT}}\label{qc:qc_lm_lss_flux_wavecal_nident}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS STD WAVECAL NMATCH}}\label{qc:qc_lm_lss_flux_wavecal_nmatch}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS STD WAVECAL POLYDEG}}\label{qc:qc_lm_lss_flux_wavecal_polydeg}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS STD WAVECAL POLYCOEFF<n>}}\label{qc:qc_lm_lss_flux_wavecal_polycoeff<n>}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\paragraph{\QC{QC LM LSS STD PSFLOSS}}\label{qc:qc_lm_lss_flux_psfloss}
%\begin{recipedef}
...
\end{recipedef}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS SCI SNRNOISE}}\label{qc:qc_lm_lss_sci_snrnoise}
\begin{recipedef}
...
\end{recipedef}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC LM LSS SCI FLUX SNRNOISE}}\label{qc:qc_lm_lss_sci_flux_snrnoise}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS STD SNRNOISE}}\label{qc:qc_n_lss_std_snrnoise}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS STD INTORDR LEVEL}}\label{qc:qc_n_lss_flux_intordr_level}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS STD AVGLEVEL}}\label{qc:qc_n_lss_flux_avglevel}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS STD WAVECAL DEVMEAN}}\label{qc:qc_n_lss_flux_wavecal_devmean}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS STD WAVECAL FWHM}}\label{qc:qc_n_lss_flux_wavecal_fwhm}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS STD WAVECAL NIDENT}}\label{qc:qc_n_lss_flux_wavecal_nident}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS STD WAVECAL NMATCH}}\label{qc:qc_n_lss_flux_wavecal_nmatch}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS STD WAVECAL POLYDEG}}\label{qc:qc_n_lss_flux_wavecal_polydeg}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS STD WAVECAL POLYCOEFF<n>}}\label{qc:qc_n_lss_flux_wavecal_polycoeff<n>}
\begin{recipedef}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\paragraph{\QC{QC N LSS STD PSFLOSS}}\label{qc:qc_n_lss_flux_psfloss}
%\begin{recipedef}
...
\end{recipedef}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS SCI SNRNOISE}}\label{qc:qc_n_lss_sci_snrnoise}
\begin{recipedef}
...
\end{recipedef}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\QC{QC N LSS SCI FLUX SNRNOISE}}\label{qc:qc_n_lss_sci_flux_snrnoise}
\begin{recipedef}
