...
\begin{itemize}
  \item \FITS{det} is a placeholder for either \FITS{LM}, \FITS{N}, or \FITS{IFU}
  \item \FITS{cgrph} is a placeholder for one of the coronographs
...
Created by & \NEWDRL{metis_apply_persistence_correction}\\
...
Default & None  \tabularnewline
Range & None \tabularnewline
Created by & \NEWREC{metis_det_lingain}\\
...
Default & None  \tabularnewline
Range & None \tabularnewline
Created by & \NEWREC{metis_lm_img_std_process}\\
...
Default & None  \tabularnewline
Range & None \tabularnewline
Created by & \NEWREC{metis_n_img_std_process}\\
Description & peak counts of the standard star \tabularnewline
Comment & \tabularnewline
\end{recipedef}
...
Default & None  \tabularnewline
Range & None \tabularnewline
Created by & \NEWREC{metis_lm_img_basic_reduce}\\
...
Range & None \tabularnewline
Created by & \NEWREC{metis_det_lingain}\\
Description & Number of bad pixels as derived in \NEWREC{metis_det_lingain}.\tabularnewline
Comment & None \tabularnewline
\end{recipedef}
