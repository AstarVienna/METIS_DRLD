...
\paragraph{\hyperref[dataitem:gainmap2rg]{\PROD{GAIN_MAP_2RG}} and \hyperref[dataitem:gainmapgeo]{\PROD{GAIN_MAP_GEO}}}\label{dataitem:gainmap}\label{dataitem:gainmapgeo}\label{dataitem:gainmap2rg}
