...
Created by: & \hyperref[rec:metis_lm_distortion]{\REC{metis_lm_img_distortion}} \\
...
Created by: & \hyperref[rec:metis_n_distortion]{\REC{metis_n_img_distortion}} \\
Input for recipe: & \hyperref[rec:metis_lm_img_calibrate]{\REC{metis_lm_img_calibrate}}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
...
Created by: & \hyperref[rec:metis_lm_distortion]{\REC{metis_n_img_distortion}} \\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
%Data item structure: & see \ref{drsstructure:nrsrfraw}\\
\end{recipedef}
