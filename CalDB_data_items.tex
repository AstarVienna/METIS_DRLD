...
Input for:    & \hyperref[rec:metis_lm_lss_rsrf]{\REC{metis_LM_lss_rsrf}} \\
...
Created by recipe: & \hyperref[rec:metis_det_lingain]{\REC{metis_det_lingain}} \\
Input for:    & \hyperref[rec:metis_det_dark]{\REC{metis_det_dark}} \\
              & \hyperref[rec:metis_lm_lss_rsrf]{\REC{metis_LM_lss_rsrf}} \\
              & \hyperref[rec:metis_lm_lss_trace]{\REC{metis_LM_lss_trace}} \\
              & \hyperref[rec:metis_lm_lss_wave]{\REC{metis_LM_lss_wave}} \\
              & \hyperref[rec:metis_lm_lss_std]{\REC{metis_LM_lss_std}} \\
...
Input for:    & \hyperref[rec:metis_lm_img_flat]{\REC{metis_lm_img_flat}} \\
...
%Template: & \TPL{METIS_gen_cal_dark},  \TPL{METIS_gen_cal_Insdark}\\
Created by: & \hyperref[drl:det_dark]{\REC{metis_det_dark}} \\
Input for:    & \hyperref[rec:metis_n_img_flat]{\REC{metis_n_img_flat}} \\
              & \hyperref[rec:metis_n_lss_rsrf]{\REC{metis_N_lss_rsrf}} \\
              & \hyperref[rec:metis_n_lss_trace]{\REC{metis_N_lss_trace}} \\
              & \hyperref[rec:metis_n_lss_std]{\REC{metis_N_lss_std}} \\
              & \hyperref[rec:metis_n_lss_sci]{\REC{metis_N_lss_sci}} \\
...
Input for:    & \hyperref[rec:metis_ifu_std_process]{\REC{metis_ifu_std_process}} \\
              & \hyperref[rec:metis_ifu_sci_process]{\REC{metis_ifu_sci_process}} \\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
% Purpose: & \\
\end{recipedef}
...
Input for:    & \hyperref[rec:metis_lm_img_std_process]{\REC{metis_lm_img_std_process}} \\
              & \hyperref[rec:metis_n_img_std_process]{\REC{metis_n_img_std_process}} \\
\end{recipedef}
% \begin{datastructdef}
% \textbf{Corresponding \ac{CPL} structure:}
% \begin{enumerate}
...
Input for:    & \hyperref[rec:metis_ifu_sci_process]{\REC{metis_ifu_sci_process}} \\
              & \hyperref[rec:metis_lm_img_calibrate]{\REC{metis_lm_img_calibrate}} \\
              & \hyperref[rec:metis_n_img_calibrate]{\REC{metis_n_img_calibrate}} \\
...
Input for:    & \hyperref[rec:metis_lm_lss_std]{\REC{metis_LM_lss_std}} \\
              & \hyperref[rec:metis_lm_lss_sci]{\REC{metis_LM_lss_sci}} \\
              & \hyperref[rec:metis_lm_lss_mf_model]{\REC{metis_LM_lss_mf_model}} \\
              & \hyperref[rec:metis_lm_lss_mf_calctrans]{\REC{metis_LM_lss_mf_calctrans}} \\
              & \hyperref[rec:metis_n_lss_std]{\REC{metis_N_lss_std}} \\
              & \hyperref[rec:metis_n_lss_sci]{\REC{metis_N_lss_sci}} \\
              & \hyperref[rec:metis_n_lss_mf_model]{\REC{metis_N_lss_mf_model}} \\
              & \hyperref[rec:metis_n_lss_mf_calctrans]{\REC{metis_N_lss_mf_calctrans}} \\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
...
Input for:    & \hyperref[rec:metis_lm_lss_wave]{\REC{metis_LM_lss_wave}} \\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
Purpose: & wavelength calibration\\
\end{recipedef}
\begin{datastructdef}
...
Input for:    & \hyperref[rec:metis_n_lss_std]{\REC{metis_N_lss_std}} \\
              & \hyperref[rec:metis_n_lss_sci]{\REC{metis_N_lss_sci}} \\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
Purpose: & flux calibration\\
\end{recipedef}
