...
Input for:    & \REC{metis_img_adi_cgrph}, \REC{metis_lm_app_cgrph}, \REC{metis_lm_adi_app} \\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
...
Source: & obtained from simulated images or high SNR observations\\
Input for:    & \REC{metis_img_adi_cgrph}, \REC{metis_n_app_cgrph}, \REC{metis_n_adi_app} \\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
Purpose: & centroiding of ADI images\\
\end{recipedef}
\begin{datastructdef}
...
Source: & obtained from simulated images or high SNR observations\\
Input for:    & \REC{metis_img_adi_cgrph}, \REC{metis_ifu_app_cgrph}, \REC{metis_ifu_adi_app} \\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
Purpose: & centroiding of ADI images\\
\end{recipedef}
\begin{datastructdef}
