...
\paragraph{\hyperref[dataitem:persistencemap]{\PROD{PERSISTENCE_MAP}}}\label{dataitem:persistencemap}

\paragraph{\hyperref[dataitem:gainmap2rg]{\PROD{GAIN_MAP_det}}}\label{dataitem:gainmapdet}\label{dataitem:gainmap}

\paragraph{\hyperref[dataitem:gainmap2rg]{\PROD{GAIN_MAP_2RG}}}\label{dataitem:gainmap2rg}
See \hyperref[dataitem:gainmapdet]{\PROD{GAIN_MAP_det}}.

\paragraph{\hyperref[dataitem:gainmapgeo]{\PROD{GAIN_MAP_GEO}}}\label{dataitem:gainmapgeo}
See \hyperref[dataitem:gainmapdet]{\PROD{GAIN_MAP_det}}.

%\clearpage
\subsubsection{LMS calibration database item structures}\label{sssec:lmscaldbdatastructs}
%\clearpage
...
% ##################################################################################### 
\paragraph{\hyperref[dataitem:atmlinecat]{\EXTCALIB{ATM_LINE_CAT}}}\label{dataitem:atmlinecat}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \hyperref[dataitem:atmlinecat]{\FITS{ATM_LINE_CAT}}\\[0.3cm]
...
% ##################################################################################### 
\paragraph{\hyperref[dataitem:aopsfmodel]{\EXTCALIB{AO_PSF_MODEL}}}\label{dataitem:aopsfmodel}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \hyperref[dataitem:aopsfmodel]{\FITS{AO_PSF_MODEL}}\\[0.3cm]
...
% ##################################################################################### 
\paragraph{\hyperref[dataitem:atmprofile]{\EXTCALIB{ATM_PROFILE}}}\label{dataitem:atmprofile}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \hyperref[dataitem:atmprofile]{\FITS{ATM_PROFILE}}\\[0.3cm]
...
\paragraph{\hyperref[dataitem:lasertab]{\STATCALIB{LASER_TAB}}}\label{dataitem:lasertab}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \hyperref[dataitem:atmlinecat]{\FITS{LASER_TAB}}\\[0.3cm]
...
% ##################################################################################### 
\paragraph{\hyperref[dataitem:tssmodelcat]{\STATCALIB{TSS_MODEL_CAT}}}\label{dataitem:tssmodelcat}
TBWritten
% ##################################################################################### 
\paragraph{\hyperref[dataitem:tssconttab]{\STATCALIB{TSS_CONT_TAB}}}\label{dataitem:tssconttab}
TBWritten


% ##################################################################################### 
\paragraph{\hyperref[dataitem:reffluxcat]{\STATCALIB{REF_FLUX_CAT}}}\label{dataitem:reffluxcat}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \hyperref[dataitem:reffluxcat]{\FITS{REF_FLUX_CAT}}\\[0.3cm]
...
% ##################################################################################### 
\paragraph{\hyperref[dataitem:lmadcslitloss]{\STATCALIB{LM_ADC_SLITLOSS}}}\label{dataitem:lmadcslitloss}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \hyperref[dataitem:lmadcslitloss]{\FITS{LM_ADC_SLITLOSS}}\\[0.3cm]
...
% ##################################################################################### 
\paragraph{\hyperref[dataitem:nadcslitloss]{\STATCALIB{N_ADC_SLITLOSS}}}\label{dataitem:nadcslitloss}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \hyperref[dataitem:nadcslitloss]{\FITS{N_ADC_SLITLOSS}}\\[0.3cm]
...
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \hyperref[dataitem:lsfkernel]{\FITS{LSF_KERNEL}}\\[0.3cm]
...
% ##################################################################################### 
\paragraph{\hyperref[dataitem:nlssdistsol]{\STATCALIB{N_LSS_DIST_SOL}}}\label{dataitem:nlssdistsol}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \hyperref[dataitem:nlssdistsol]{\FITS{N_LSS_DIST_SOL}}\\[0.3cm]
...
% ##################################################################################### 
\paragraph{\hyperref[dataitem:nlsswaveguess]{\STATCALIB{N_LSS_WAVE_GUESS}}}\label{dataitem:nlsswaveguess}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \hyperref[dataitem:nlsswaveguess]{\FITS{N_LSS_WAVE_GUESS}}\\[0.3cm]
...
% ##################################################################################### 
\paragraph{\hyperref[dataitem:lmsynthtrans]{\STATCALIB{LM_SYNTH_TRANS}}}\label{dataitem:lmsynthtrans}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \hyperref[dataitem:lmsynthtrans]{\FITS{LM_SYNTH_TRANS}}\\[0.3cm]
...
% ##################################################################################### 
\paragraph{\hyperref[dataitem:nsynthtrans]{\STATCALIB{N_SYNTH_TRANS}}}\label{dataitem:nsynthtrans}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \hyperref[dataitem:nsynthtrans]{\FITS{N_SYNTH_TRANS}}\\[0.3cm]
Description: & Synthetic transmission curve to be used for telluric correction of flux standard stars\\[0.3cm]
