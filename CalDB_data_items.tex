...
\paragraph{\NEWSTATCALIB{GAIN_MAP_det}}\label{dataitem:gain_map_det}\label{dataitem:gainmap}
\label{dataitem:gain_map_2rg}\label{dataitem:gain_map_geo}\label{dataitem:gain_map_ifu}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWSTATCALIB{GAIN_MAP_det}\\[0.3cm]
...
Created by recipe: & \NEWREC{metis_det_lingain} \\
Input for:    & \NEWREC{metis_LM_lss_rsrf} \\
...
\paragraph{\NEWPROD{BADPIX_MAP_det}}\label{dataitem:badpix_map_det}\label{dataitem:badpixmap}

\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{BADPIX_MAP_det}\\[0.3cm]
...
Created by recipe: & \NEWREC{metis_det_lingain} \\
                  & \NEWREC{metis_ifu_rsrf} \\
                  & \NEWREC{metis_det_dark} \\
                  & \NEWREC{metis_lm_img_flat} \\
                  & \NEWREC{metis_n_img_flat} \\
Input for:    & \NEWREC{metis_ifu_wavecal} \\
              & \NEWREC{metis_ifu_rsrf} \\
              & \NEWREC{metis_ifu_std_process} \\
              & \NEWREC{metis_ifu_sci_process} \\
              & \NEWREC{metis_lm_img_flat} \\
              & \NEWREC{metis_lm_img_sci_postprocess} \\
              & \NEWREC{metis_lm_img_distortion} \\
              & \NEWREC{metis_n_img_flat} \\
              & \NEWREC{metis_n_img_chopnod} \\
              & \NEWREC{metis_n_img_distortion} \\
              & \NEWREC{metis_LM_lss_rsrf} \\
              & \NEWREC{metis_LM_lss_trace} \\
              & \NEWREC{metis_LM_lss_wave} \\
              & \NEWREC{metis_LM_lss_std} \\
              & \NEWREC{metis_LM_lss_sci} \\
...
\paragraph{\NEWPROD{BADPIX_MAP_2RG}}\label{dataitem:badpix_map_2rg}
See \NEWPROD{BADPIX_MAP_det}.

\paragraph{\NEWPROD{BADPIX_MAP_GEO}}\label{dataitem:badpix_map_geo}
See \NEWPROD{BADPIX_MAP_det}.

\paragraph{\NEWPROD{BADPIX_MAP_IFU}}\label{dataitem:badpix_map_ifu}
See \NEWPROD{BADPIX_MAP_det}.

\paragraph{\NEWPROD{LINEARITY_det}}\label{dataitem:linearity_det}\label{dataitem:linearity}\label{dataitem:linearity_lm}\label{dataitem:linearity_ifu}\label{dataitem:linearity_n}\label{dataitem:linearity_2rg}\label{dataitem:linearity_geo}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{LINEARITY_det}\\[0.3cm]
...
Created by recipe: & \NEWREC{metis_det_lingain} \\
Input for:    & \NEWREC{metis_det_dark} \\
              & \NEWREC{metis_LM_lss_rsrf} \\
              & \NEWREC{metis_LM_lss_trace} \\
              & \NEWREC{metis_LM_lss_wave} \\
              & \NEWREC{metis_LM_lss_std} \\
...
\paragraph{\NEWPROD{MASTER_DARK_det}}\label{dataitem:master_dark_det}
\label{dataitem:masterdark}
Depending on context, a \NEWPROD{MASTER_DARK_det} can refer to either a
\begin{enumerate}
\item \NEWPROD{MASTER_DARK_GEO}
\item \NEWPROD{MASTER_DARK_2RG}
\item \NEWPROD{MASTER_DARK_IFU}
\end{enumerate}


\paragraph{\NEWPROD{MASTER_DARK_2RG}}\label{dataitem:master_dark_2rg}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{MASTER_DARK_2RG}\\[0.3cm]
...
Input for:    & \NEWREC{metis_lm_img_flat} \\
              & \NEWREC{metis_lm_img_basic_reduce} \\
              & \NEWREC{metis_LM_lss_rsrf} \\
              & \NEWREC{metis_LM_lss_trace} \\
              & \NEWREC{metis_LM_lss_wave} \\
              & \NEWREC{metis_LM_lss_std} \\
...
\paragraph{\NEWPROD{MASTER_DARK_GEO}}\label{dataitem:master_dark_geo}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{MASTER_DARK_GEO}\\[0.3cm]
...
%Template: & \TPL{METIS_gen_cal_dark},  \TPL{METIS_gen_cal_Insdark}\\
Created by: & \NEWREC{metis_det_dark} \\
Input for:    & \NEWREC{metis_n_img_flat} \\
              & \NEWREC{metis_N_lss_rsrf} \\
              & \NEWREC{metis_N_lss_trace} \\
              & \NEWREC{metis_N_lss_std} \\
              & \NEWREC{metis_N_lss_sci} \\
...
\paragraph{\NEWPROD{RSRF_IFU}}\label{dataitem:rsrf_ifu}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWPROD{RSRF_IFU}\\[0.3cm]
...
Input for:    & \NEWREC{metis_ifu_std_process} \\
              & \NEWREC{metis_ifu_sci_process} \\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
% Purpose: & \\
\end{recipedef}
...
\paragraph{\NEWPROD{det_DISTORTION_TABLE}}\label{dataitem:det_distortion_table}
Depending on context, a \NEWPROD{det_DISTORTION_TABLE} can refer to either a
\begin{enumerate}
\item \NEWPROD{N_DISTORTION_TABLE}
\item \NEWPROD{LM_DISTORTION_TABLE}
\item \NEWPROD{IFU_DISTORTION_TABLE}
\end{enumerate}


\paragraph{\NEWPROD{LM_DISTORTION_TABLE}}\label{dataitem:lm_distortion_table}
\begin{recipedef}
\textbf{\ac{FITS} TABLE file structure:}\\
Name: & \NEWPROD{LM_DISTORTION_TABLE}\\[0.3cm]
...
%Data item structure: & see \ref{drsstructure:lmrsrfraw}\\
\end{recipedef}
\paragraph{\NEWPROD{LM_DISTORTION_TABLE}}\label{drsstructure:LM_DISTORTION_TABLE}
\begin{datastructdef}
\textbf{Corresponding \ac{CPL} structure:}
\begin{enumerate}
    \item \texttt{cpl\_propertylist * keywords: Primary keywords (\hyperref[fits:dpr.catg]{\FITS{DPR.CATG}},  \hyperref[fits:dpr.tech]{\FITS{DPR.TECH}},  \hyperref[fits:dpr.type]{\FITS{DPR.TYPE}},  \hyperref[fits:ins.opti3.name]{\FITS{INS.OPTI3.NAME}},  \hyperref[fits:ins.opti9.name]{\FITS{INS.OPTI9.NAME}},  \hyperref[fits:ins.opti10.name]{\FITS{INS.OPTI10.NAME}})}
...
\paragraph{\NEWPROD{N_DISTORTION_TABLE}}\label{dataitem:n_distortion_table}
\begin{recipedef}
\textbf{\ac{FITS} TABLE file structure:}\\
Name: & \NEWPROD{N_DISTORTION_TABLE}\\[0.3cm]
Description: & Table of distortion information\\[0.3cm]
...
\end{recipedef}
\paragraph{\NEWPROD{N_DISTORTION_TABLE}}\label{drsstructure:N_DISTORTION_TABLE}
\begin{datastructdef}
\textbf{Corresponding \ac{CPL} structure:}
\begin{enumerate}
    \item \texttt{cpl\_propertylist * keywords: Primary keywords (\hyperref[fits:dpr.catg]{\FITS{DPR.CATG}},  \hyperref[fits:dpr.tech]{\FITS{DPR.TECH}},  \hyperref[fits:dpr.type]{\FITS{DPR.TYPE}},  \hyperref[fits:ins.opti3.name]{\FITS{INS.OPTI3.NAME}},  \hyperref[fits:ins.opti9.name]{\FITS{INS.OPTI9.NAME}},  \hyperref[fits:ins.opti10.name]{\FITS{INS.OPTI10.NAME}})}
...
\paragraph{\NEWPROD{det_DISTORTION_MAP}}\label{dataitem:det_distortion_map}
Depending on context, a \NEWPROD{det_DISTORTION_MAP} can refer to either a
\begin{enumerate}
\item \NEWPROD{N_DISTORTION_MAP}
\item \NEWPROD{LM_DISTORTION_MAP}
% \item \NEWPROD{ifu_distortion_map}
\end{enumerate}


\paragraph{\NEWPROD{LM_DISTORTION_MAP}}\label{dataitem:lm_distortion_map}
\begin{recipedef}
\textbf{\ac{FITS} IMAGE file structure:}\\
Name: & \NEWPROD{LM_DISTORTION_MAP}\\[0.3cm]
...
%Data item structure: & see \ref{drsstructure:nrsrfraw}\\
\end{recipedef}
\paragraph{\NEWPROD{LM_DISTORTION_MAP}}\label{drsstructure:LM_DISTORTION_MAP}
\begin{datastructdef}
\textbf{Corresponding \ac{CPL} structure:}
\begin{enumerate}
    \item \texttt{cpl\_propertylist * keywords: Primary keywords (\hyperref[fits:dpr.catg]{\FITS{DPR.CATG}},  \hyperref[fits:dpr.tech]{\FITS{DPR.TECH}},  \hyperref[fits:dpr.type]{\FITS{DPR.TYPE}},  \hyperref[fits:ins.opti3.name]{\FITS{INS.OPTI3.NAME}},  \hyperref[fits:ins.opti9.name]{\FITS{INS.OPTI9.NAME}},  \hyperref[fits:ins.opti10.name]{\FITS{INS.OPTI10.NAME}})}
...
\paragraph{\NEWPROD{N_DISTORTION_MAP}}\label{dataitem:n_distortion_map}
\begin{recipedef}
\textbf{\ac{FITS} IMAGE file structure:}\\
Name: & \NEWPROD{N_DISTORTION_MAP}\\[0.3cm]
Description: & Map of pixel scale across the detector\\[0.3cm]
...
%Data item structure: & see \ref{drsstructure:nrsrfraw}\\
\end{recipedef}
\paragraph{\NEWPROD{N_DISTORTION_MAP}}\label{drsstructure:N_DISTORTION_MAP}
\begin{datastructdef}
\textbf{Corresponding \ac{CPL} structure:}
\begin{enumerate}
    \item \texttt{cpl\_propertylist * keywords: Primary keywords (\hyperref[fits:dpr.catg]{\FITS{DPR.CATG}},  \hyperref[fits:dpr.tech]{\FITS{DPR.TECH}},  \hyperref[fits:dpr.type]{\FITS{DPR.TYPE}},  \hyperref[fits:ins.opti3.name]{\FITS{INS.OPTI3.NAME}},  \hyperref[fits:ins.opti9.name]{\FITS{INS.OPTI9.NAME}},  \hyperref[fits:ins.opti10.name]{\FITS{INS.OPTI10.NAME}})}
...
% \paragraph{\NEWEXTCALIB{LM_DETECTOR_MASK}}\label{dataitem:lm_detector_mask}
% \begin{recipedef}
% \textbf{\ac{FITS} file structure:}\\
% Name: & \NEWEXTCALIB{LM_DETECTOR_MASK}\\[0.3cm]
...
% Input for recipes: & \NEWREC{metis_lm_img_basic_reduce}\\
% Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
% \end{recipedef}
% \begin{datastructdef}
% \textbf{Corresponding \ac{CPL} structure:}
...
\paragraph{\NEWEXTCALIB{FLUXSTD_CATALOG}}\label{dataitem:fluxstd_catalog}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWEXTCALIB{FLUXSTD_CATALOG}\\[0.3cm]
...
Input for:    & \NEWREC{metis_lm_img_std_process} \\
              & \NEWREC{metis_n_img_std_process} \\
\end{recipedef}
% \begin{datastructdef}
% \textbf{Corresponding \ac{CPL} structure:}
% \begin{enumerate}
...
\paragraph{\NEWEXTCALIB{PINHOLE_TABLE}}\label{dataitem:pinhole_table}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWEXTCALIB{PINHOLE_TABLE}\\[0.3cm]
...
% TODO: Source
Used in recipes: & \NEWREC{metis_lm_img_distortion}\\
                 & \NEWREC{metis_n_img_distortion}\\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
\end{recipedef}
\begin{datastructdef}
...
Input for:    & \NEWREC{metis_ifu_sci_process} \\
              & \NEWREC{metis_lm_img_calibrate} \\
              & \NEWREC{metis_n_img_calibrate} \\
...
% ##################################################################################### 
\paragraph{\NEWEXTCALIB{PERSISTENCE_MAP}}\label{dataitem:persistence_map}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWEXTCALIB{PERSISTENCE_MAP}\\[0.3cm]
...
Source: & created by \ac{ESO} with recipe \NEWREC{metis_det_persistence}\\
Input for:    & \NEWREC{metis_det_dark} \\
              & \NEWREC{metis_LM_lss_rsrf} \\
              & \NEWREC{metis_LM_lss_trace} \\
              & \NEWREC{metis_LM_lss_wave} \\
...
\paragraph{\NEWEXTCALIB{ATM_LINE_CAT}}\label{dataitem:atm_line_cat}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWEXTCALIB{ATM_LINE_CAT}\\[0.3cm]
...
Input for:    & \NEWREC{metis_LM_lss_std} \\
              & \NEWREC{metis_LM_lss_sci} \\
              & \NEWREC{metis_LM_lss_mf_model} \\
              & \NEWREC{metis_LM_lss_mf_calctrans} \\
              & \NEWREC{metis_N_lss_std} \\
              & \NEWREC{metis_N_lss_sci} \\
...
% ##################################################################################### 
\paragraph{\NEWEXTCALIB{AO_PSF_MODEL}}\label{dataitem:ao_psf_model}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWEXTCALIB{AO_PSF_MODEL}\\[0.3cm]
...
% ##################################################################################### 
\paragraph{\NEWEXTCALIB{ATM_PROFILE}}\label{dataitem:atm_profile}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWEXTCALIB{ATM_PROFILE}\\[0.3cm]
...
\paragraph{\NEWEXTCALIB{LASER_TAB}}\label{dataitem:laser_tab}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWEXTCALIB{LASER_TAB}\\[0.3cm]
...
% ##################################################################################### 
%\paragraph{\NEWSTATCALIB{TSS_MODEL_CAT}}\label{dataitem:tss_model_cat}
%TBWritten
% ##################################################################################### 
%\paragraph{\NEWSTATCALIB{TSS_CONT_TAB}}\label{dataitem:tss_cont_tab}
%TBWritten


% ##################################################################################### 
\paragraph{\NEWSTATCALIB{REF_STD_CAT}}\label{dataitem:ref_std_cat}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWSTATCALIB{REF_STD_CAT}\\[0.3cm]
...
% ##################################################################################### 
\paragraph{\NEWSTATCALIB{LM_ADC_SLITLOSS}}\label{dataitem:lm_adc_slitloss}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWSTATCALIB{LM_ADC_SLITLOSS}\\[0.3cm]
...
Source: & recipe \NEWREC{metis_lm_adc_slitloss} (see Section~\ref{sssec:adc_slitlosses} and~\cite{METIS-calibration_plan}) \\
Input for:    & \NEWREC{metis_LM_lss_std} \\
              & \NEWREC{metis_LM_lss_sci} \\
Processing \ac{FITS} Keywords: & provided at \ac{PAE}\\
Purpose: & flux calibration\\
...
% ##################################################################################### 
\paragraph{\NEWSTATCALIB{N_ADC_SLITLOSS}}\label{dataitem:n_adc_slitloss}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWSTATCALIB{N_ADC_SLITLOSS}\\[0.3cm]
...
Source: & recipe \NEWREC{metis_n_adc_slitloss} (see Section~\ref{sssec:adc_slitlosses} and~\cite{METIS-calibration_plan}) \\
...
% ##################################################################################### 
\paragraph{\NEWSTATCALIB{LSF_KERNEL}}\label{dataitem:lsf_kernel}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWSTATCALIB{LSF_KERNEL}\\[0.3cm]
...
% ##################################################################################### 
\paragraph{\NEWSTATCALIB{N_LSS_DIST_SOL}}\label{dataitem:n_lss_dist_sol}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWSTATCALIB{N_LSS_DIST_SOL}\\[0.3cm]
...
% ##################################################################################### 
\paragraph{\NEWSTATCALIB{N_LSS_WAVE_GUESS}}\label{dataitem:n_lss_wave_guess}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWSTATCALIB{N_LSS_WAVE_GUESS}\\[0.3cm]
...
% ##################################################################################### 
\paragraph{\NEWSTATCALIB{LM_SYNTH_TRANS}}\label{dataitem:lm_synth_trans}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWSTATCALIB{LM_SYNTH_TRANS}\\[0.3cm]
...
% ##################################################################################### 
\paragraph{\NEWSTATCALIB{N_SYNTH_TRANS}}\label{dataitem:n_synth_trans}
\begin{recipedef}
\textbf{\ac{FITS} file structure:}\\
Name: & \NEWSTATCALIB{N_SYNTH_TRANS}\\[0.3cm]
Description: & Synthetic transmission curve to be used for telluric correction of flux standard stars\\[0.3cm]
