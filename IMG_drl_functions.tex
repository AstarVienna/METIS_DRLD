...
\subsubsection{Measure LM Band Flux of Standard Star}\label{drl:lm_std_flux}
\begin{recipedef}
Name: & \hyperref[drl:lm_calculate_std_fluxl]{\DRL{lm_calculate_std_flux}} \\
...
\subsubsection{Measure N band Flux of Standard Star}\label{drl:n_std_flux}
\begin{recipedef}
