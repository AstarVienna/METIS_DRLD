...
\subsubsection{Create Master LM Flat} \label{drl:metis_lm_img_flat}
\begin{recipedef}
...
\begin{recipedef}
Name: & \hyperref[drl:metis_update_lm_flat_mask]{\DRL{metis_update_lm_flat_mask}} \\
...
\begin{recipedef}
Name: & \hyperref[drl:metis_update_n_flat_mask]{\DRL{metis_update_n_flat_mask}} \\
...
\begin{recipedef}
Name: & \hyperref[drl:n_calculate_std_flux]{\DRL{n_calculate_std_flux}} \\
...
\begin{recipedef}
Name: & \hyperref[drl:detect_centroid_peak]{\DRL{detect_centroid_peak}} \\
