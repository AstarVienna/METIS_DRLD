...
%   For stacking we can use hdrl_imagelist_combine.
%   For resampling we can use hdrl_resample_imagelist_to_table.
...
\begin{recipedef}
Name: & \hyperref[drl:metis_lm_img_flat]{\DRL{metis_lm_img_flat}} \\
...
\begin{recipedef}
Name: & \hyperref[drl:metis_n_img_flat]{\DRL{metis_n_img_flat}} \\
