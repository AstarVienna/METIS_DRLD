    ...
    \hypertarget{lms-distortion}{%
\section{LMS distortion}\label{lms-distortion}}

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{16}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k+kn}{from} \PY{n+nn}{pylab} \PY{k}{import} \PY{o}{*}
\PY{k+kn}{from} \PY{n+nn}{astropy}\PY{n+nn}{.}\PY{n+nn}{io}\PY{n+nn}{.}\PY{n+nn}{fits} \PY{k}{import} \PY{n+nb}{open} \PY{k}{as} \PY{n}{fo}
...
in 2D spectra
    ...
    \hypertarget{scopesim}{%
\subsection{ScopeSim}\label{scopesim}}
...
into the CRIRES-pipeline.
    ...
    \hypertarget{crires-drs}{%
\subsection{CRIRES DRS}\label{crires-drs}}
...
CRIRES, thus preserving its headers and replacing the data.
    ...
    \hypertarget{order-tracing}{%
\subsection{Order tracing}\label{order-tracing}}
...
has the polynomials for the upper and lower edges of each slice.
    ...
    \hypertarget{slit-tilt}{%
\subsection{Slit tilt}\label{slit-tilt}}
...
columns by integer values according to the trace. Then a peak-finder is
run on each row to find spectral lines, which are then fitted with
Gaussians to determine their line centers. Comparing how the
line-centers change with detector rows, allows us to fit the slit tilt
as a polynomyal P(y). In order to reject outliers and ensure a smooth
change in the tilt, the \emph{coefficients} of the tilt polynomials are
then each fit as P(x). These coefficients are saved in an updated
FITS-table, called \texttt{CIRES\_sky\_tw\_tw.fits}. Using the included
script that evaluates the polynomials and plots them on top of the sky
frame, we can have a look at the result.

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{3}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{o}{\PYZpc{}}\PY{k}{run} show\PYZus{}trace\PYZus{}curv.py CIRES\PYZus{}sky\PYZus{}tw\PYZus{}tw.fits CIRES\PYZus{}sky.fits \PYZsh{} only plots the top two detectors
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{dx}\PY{o}{=}\PY{n}{polyval}\PY{p}{(}\PY{n}{tilts}\PY{p}{[}\PY{l+m+mi}{3}\PY{p}{]}\PY{p}{[}\PY{p}{:}\PY{p}{:}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{1024}\PY{p}{,}\PY{l+m+mi}{2048}\PY{p}{]}\PY{p}{)} \PY{c+c1}{\PYZsh{} reverse order of coeffs in python}
\PY{n}{dx}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{degrees}\PY{p}{(}\PY{n}{arctan}\PY{p}{(}\PY{n}{dx}\PY{p}{)}\PY{p}{)} \PY{c+c1}{\PYZsh{} Tilt angles}
\end{Verbatim}
\end{tcolorbox}
...
\end{tcolorbox}
    ...
    \hypertarget{extracting-into-1d-spectra}{%
\subsection{Extracting into 1D
spectra}\label{extracting-into-1d-spectra}}

\hypertarget{fake-wavelengths}{%
\subsubsection{Fake wavelengths}\label{fake-wavelengths}}
...
\PY{k}{for} \PY{n}{detec} \PY{o+ow}{in} \PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{:}
    ...
    \PY{n}{x}\PY{o}{=}\PY{n}{arange}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{lam}\PY{p}{)}\PY{p}{)}\PY{o}{+}\PY{l+m+mi}{1} 
    \PY{n}{p}\PY{o}{=}\PY{n}{polyfit}\PY{p}{(}\PY{n}{x}\PY{p}{,}\PY{n}{lam}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{[}\PY{p}{:}\PY{p}{:}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}
...
this in not part of the current exercise.
    ...
    \hypertarget{d-spectra}{%
\subsection{2D spectra}\label{d-spectra}}
